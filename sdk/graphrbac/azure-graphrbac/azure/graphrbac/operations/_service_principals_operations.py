...
class ServicePrincipalsOperations(object):
    ...
    def add_owner(
        ...
        :param object_id: The object ID of the service principal to which to
         add the owner.
        :type object_id: str
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    add_owner.metadata = {'url': '/{tenantID}/servicePrincipals/{objectId}/$links/owners'}

    def remove_owner(
            self, object_id, owner_object_id, custom_headers=None, raw=False, **operation_config):
        """Remove a member from owners.

        :param object_id: The object ID of the service principal from which to
         remove the owner.
        :type object_id: str
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    remove_owner.metadata = {'url': '/{tenantID}/servicePrincipals/{objectId}/$links/owners/{ownerObjectId}'}
