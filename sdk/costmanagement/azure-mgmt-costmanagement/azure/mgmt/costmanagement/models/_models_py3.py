...
class ExportExecution(ProxyResource):
    ...
    def __init__(self, *, e_tag: str=None, execution_type=None, status=None, submitted_by: str=None, submitted_time=None, processing_start_time=None, processing_end_time=None, file_name: str=None, run_settings=None, error=None, **kwargs) -> None:
...
class ExportSchedule(Model):
    ...
    def __init__(self, *, status=None, recurrence=None, recurrence_period=None, **kwargs) -> None:
...
class GenerateDetailedCostReportDefinition(Model):
    """The definition of a cost detailed report.

    :param metric: The type of the detailed report. By default ActualCost is
     provided. Possible values include: 'ActualCost', 'AmortizedCost'
    :type metric: str or
     ~azure.mgmt.costmanagement.models.GenerateDetailedCostReportMetricType
    :param time_period: Has time period for pulling data for the cost detailed
    ...
    :type time_period:
     ~azure.mgmt.costmanagement.models.GenerateDetailedCostReportTimePeriod
    :param billing_period: Billing Period in YearMonth(e.g. 202008) format.
     Only for legacy enterprise customers can use this. Can only have one of
    ...
    :param invoice_id: Invoice Id for PayAsYouGo customers and Modern billing
     profile scope. Can only have one of either timePeriod or invoiceId or
     billingPeriod parameters. If none provided current month cost is provided.
    :type invoice_id: str
    :param customer_id: Customer Id for Modern (Invoice Id and billing profile
    ...
    def __init__(self, *, metric=None, time_period=None, billing_period: str=None, invoice_id: str=None, customer_id: str=None, **kwargs) -> None:
...
class GenerateDetailedCostReportErrorResponse(Model):
    """Error response indicates that the service is not able to process the
    incoming request. The reason is provided in the error message.
    Some Error responses:
    * 413 Request Entity Too Large - Request is throttled. The amount of data
    required to fulfill the request exceeds the maximum size permitted of 2Gb.
...
class GenerateDetailedCostReportErrorResponseException(HttpOperationError):
    """Server responsed with exception of type: 'GenerateDetailedCostReportErrorResponse'.
    ...
    def __init__(self, deserialize, response, *args):
        ...
        super(GenerateDetailedCostReportErrorResponseException, self).__init__(deserialize, response, 'GenerateDetailedCostReportErrorResponse', *args)


class GenerateDetailedCostReportOperationResult(Model):
    """The result of the long running operation for cost detailed report.

    :param id: The id of the long running operation.
    :type id: str
    :param name: The name of the long running operation.
    :type name: str
    :param type: The type of the long running operation.
    :type type: str
    :param download_url: The URL to download the generated report.
    :type download_url: str
    :param valid_till: The time at which report URL becomes invalid.
    ...
    def __init__(self, *, id: str=None, name: str=None, type: str=None, download_url: str=None, valid_till=None, **kwargs) -> None:
...
class GenerateDetailedCostReportOperationStatuses(Model):
    ...
    def __init__(self, *, id: str=None, name: str=None, status=None, type: str=None, error=None, download_url: str=None, valid_till=None, **kwargs) -> None:
...
class GenerateDetailedCostReportTimePeriod(Model):
    """The start and end date for pulling data for the cost detailed report.

    All required parameters must be populated in order to send to Azure.

    :param start: Required. The start date to pull data from. example format
     2020-03-15
    :type start: str
    :param end: Required. The end date to pull data to. example format
     2020-03-15
    :type end: str
    """
...
class Status(Model):
    ...
    :param status: The status of the long running operation. Possible values
     include: 'InProgress', 'Completed', 'Failed', 'Queued', 'NoDataFound',
     'ReadyToDownload', 'TimedOut'
