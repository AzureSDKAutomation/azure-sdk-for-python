...
class RecoveryServicesBackupClientOperationsMixin(object):
    ...
    def _move_recovery_point_initial(
        ...
        # Construct body
        body_content = self._serialize.body(parameters, 'MoveRPAcrossTiersRequestResource')
    ...
    def move_recovery_point(
        ...
        :type parameters:
         ~azure.mgmt.recoveryservicesbackup.models.MoveRPAcrossTiersRequestResource
