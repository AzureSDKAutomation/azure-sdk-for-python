...
class DiskPool(TrackedResource):
    ...
    :param location: Required. The geo-location where the resource lives.
    :type location: str
    :ivar provisioning_state: Required. State of the operation on the
    ...
    :ivar status: Required. Operational status of the Disk Pool. Possible
    ...
    def __init__(self, *, location: str, availability_zones, subnet_id: str, tags=None, disks=None, additional_capabilities=None, **kwargs) -> None:
...
class DiskPoolUpdate(Model):
    ...
    def __init__(self, *, disks=None, additional_capabilities=None, tags=None, **kwargs) -> None:
...
class IscsiTarget(ProxyResource):
    ...
    :vartype provisioning_state: str or
     ~microsoft.storagepool.models.ProvisioningStates
    :ivar status: Required. Operational status of the iSCSI Target. Possible
     values include: 'Invalid', 'Unknown', 'Healthy', 'Unhealthy'
    :vartype status: str or ~microsoft.storagepool.models.OperationalStatus
...
class TargetPortalGroup(Model):
    ...
    :ivar endpoints: Required. List of private IPv4 addresses to connect to
     the iSCSI Target.
    :vartype endpoints: list[str]
    :ivar tag: Required. The tag associated with the iSCSI Target Portal
     Group.
    :vartype tag: int
