...
class Encryption(msrest.serialization.Model):
    ...
    :param identity: Encryption Identity properties when storage account is associated with a
     UserAssignedIdentity.
    :type identity: ~azure.mgmt.storage.v2020_08_01_preview.models.EncryptionIdentity
    """
...
class EncryptionIdentity(msrest.serialization.Model):
    """Encryption Identity properties when storage account is associated with a UserAssignedIdentity.

    :param user_assigned_identity: ResourceID of the UserAssignedIdentity to be associated with the
     storage account.
