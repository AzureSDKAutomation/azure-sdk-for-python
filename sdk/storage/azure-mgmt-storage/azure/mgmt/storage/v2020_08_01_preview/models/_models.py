...
class DeletedAccountListResult(msrest.serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.storage.v2020_08_01_preview.models.DeletedAccountProperties]
    ...
    _attribute_map = {
        'value': {'key': 'value', 'type': '[DeletedAccountProperties]'},
...
class DeletedAccountProperties(msrest.serialization.Model):
    ...
    :ivar subscription: The Subscription id of the deleted account.
    :vartype subscription: str
    :ivar resource_group_name: The resource group the resource is located under.
    :vartype resource_group_name: str
    :ivar location: Location of the deleted account.
    :vartype location: str
    :ivar key: Can be used to attempt recovering this deleted account via PutStorageAccount API.
    :vartype key: str
