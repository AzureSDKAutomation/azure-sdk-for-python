...
class DeletedAccountProperties(Model):
    ...
    :ivar resource_group_name: The resource group the resource is located
     under.
    :vartype resource_group_name: str
    :ivar location: Location of the deleted account.
    :vartype location: str
    :ivar key: Can be used to attempt recovering this deleted account via
