...
class LocalUserPaged(Paged):
    """
    A paging container for iterating over a list of :class:`LocalUser <azure.mgmt.storage.v2020_08_01_preview.models.LocalUser>` object
    """

    _attribute_map = {
        'next_link': {'key': 'nextLink', 'type': 'str'},
        'current_page': {'key': 'value', 'type': '[LocalUser]'}
    }

    def __init__(self, *args, **kwargs):

        super(LocalUserPaged, self).__init__(*args, **kwargs)
