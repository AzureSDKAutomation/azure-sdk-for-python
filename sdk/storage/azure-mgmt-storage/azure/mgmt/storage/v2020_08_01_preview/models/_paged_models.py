...
class DeletedAccountPropertiesPaged(Paged):
    """
    A paging container for iterating over a list of :class:`DeletedAccountProperties <azure.mgmt.storage.v2020_08_01_preview.models.DeletedAccountProperties>` object
    """

    _attribute_map = {
        'next_link': {'key': 'nextLink', 'type': 'str'},
        'current_page': {'key': 'value', 'type': '[DeletedAccountProperties]'}
    }

    def __init__(self, *args, **kwargs):

        super(DeletedAccountPropertiesPaged, self).__init__(*args, **kwargs)
