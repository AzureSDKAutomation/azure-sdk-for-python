...
class StorageAccount(TrackedResource):
    ...
    :param is_sftp_enabled: Enables Secure File Transfer Protocol, if set to
     true
    ...
    def __init__(self, *, location: str, tags=None, identity=None, extended_location=None, azure_files_identity_based_authentication=None, enable_https_traffic_only: bool=None, is_sftp_enabled: bool=None, is_hns_enabled: bool=None, large_file_shares_state=None, routing_preference=None, allow_blob_public_access: bool=None, minimum_tls_version=None, **kwargs) -> None:
...
class StorageAccountCreateParameters(Model):
    ...
    def __init__(self, *, sku, kind, location: str, extended_location=None, tags=None, identity=None, custom_domain=None, encryption=None, network_rule_set=None, access_tier=None, azure_files_identity_based_authentication=None, enable_https_traffic_only: bool=None, is_sftp_enabled: bool=None, is_hns_enabled: bool=None, large_file_shares_state=None, routing_preference=None, allow_blob_public_access: bool=None, minimum_tls_version=None, **kwargs) -> None:
