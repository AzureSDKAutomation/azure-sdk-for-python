...
class Encryption(msrest.serialization.Model):
    ...
    :param encryption_identity: Encryption Identity properties when storage account is associated
     with a UserAssignedIdentity.
    :type encryption_identity: ~azure.mgmt.storage.v2020_08_01_preview.models.EncryptionIdentity
    """
...
class EncryptionIdentity(msrest.serialization.Model):
    ...
    :param user_assigned_identity: ResourceID of the UserAssignedIdentity to be associated with
     server-side encryption on the storage account.
    :type user_assigned_identity: str
    :param type: The Encryption Identity type. Possible values include: "ManagedServiceIdentity",
     "StorageService".
    :type type: str or ~azure.mgmt.storage.v2020_08_01_preview.models.EncryptionIdentityType
    """
    ...
    def __init__(
        ...
        *,
        ...
        type: Optional[Union[str, "EncryptionIdentityType"]] = None,
        **kwargs
    ):
...
class Identity(msrest.serialization.Model):
    ...
    :param type: Required. The identity type. Possible values include: "SystemAssigned",
     "UserAssigned".
    :type type: str or ~azure.mgmt.storage.v2020_08_01_preview.models.IdentityType
    :param user_assigned_identities: Dictionary to map userAssignedIdentityID strings to
     userAssignedIdentity properties.
    ...
    def __init__(
        ...
        *,
        ...
        user_assigned_identities: Optional[Dict[str, "UserAssignedIdentityType"]] = None,
        **kwargs
    ):
...
class UserAssignedIdentityType(msrest.serialization.Model):
