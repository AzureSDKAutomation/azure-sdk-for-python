...
class Encryption(Model):
    ...
    :param identity: Encryption Identity properties when storage account is
     associated with a UserAssignedIdentity.
    :type identity:
    ...
    def __init__(self, *, services=None, key_source="Microsoft.Storage", require_infrastructure_encryption: bool=None, key_vault_properties=None, identity=None, **kwargs) -> None:
...
class EncryptionIdentity(Model):
    ...
    :param user_assigned_identity: ResourceID of the UserAssignedIdentity to
     be associated with the storage account.
