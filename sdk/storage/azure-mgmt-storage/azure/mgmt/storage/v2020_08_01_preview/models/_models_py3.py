...
class LocalUser(Resource):
    ...
    :type permission_scopes: list[~azure.mgmt.storage.v2020_08_01_preview.models.PermissionScope]
    ...
    :type ssh_authorized_keys: list[~azure.mgmt.storage.v2020_08_01_preview.models.SshPublicKey]
    :ivar sid: Auto generated by the server for SMB.
    :vartype sid: str
    :ivar shared_key: Auto generated by the server for SMB.
...
class LocalUsers(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.storage.v2020_08_01_preview.models.LocalUser]
    """
...
class PermissionScope(msrest.serialization.Model):
    ...
    :param permissions: The permissions for the local user. Possible values include: Read (r),
...
class StorageAccount(TrackedResource):
    ...
    :param is_local_user_enabled: Enable or disable local user feature of the storage account.
