...
class StorageAccount(TrackedResource):
    ...
    :param is_nfs_v3_enabled: NFS 3.0 protocol support enabled if sets to
     true.
    :type is_nfs_v3_enabled: bool
    """
    ...
    _attribute_map = {
        ...
        'is_nfs_v3_enabled': {'key': 'properties.isNfsV3Enabled', 'type': 'bool'},
    }

    def __init__(self, *, location: str, tags=None, identity=None, extended_location=None, azure_files_identity_based_authentication=None, enable_https_traffic_only: bool=None, is_hns_enabled: bool=None, large_file_shares_state=None, routing_preference=None, allow_blob_public_access: bool=None, minimum_tls_version=None, is_nfs_v3_enabled: bool=None, **kwargs) -> None:
        ...
        self.is_nfs_v3_enabled = is_nfs_v3_enabled
