...
class LocalUser(Resource):
    ...
    :type permission_scopes:
     list[~azure.mgmt.storage.v2020_08_01_preview.models.PermissionScope]
    ...
    :type ssh_authorized_keys:
     list[~azure.mgmt.storage.v2020_08_01_preview.models.SshPublicKey]
    :ivar sid: Auto generated by the server for SMB.
    :vartype sid: str
    :param shared_key:
    :type shared_key: str
    :ivar has_shared_key: Indicates whether shared key exists.
    :vartype has_shared_key: bool
    :ivar has_ssh_key: Indicates whether ssh key exists.
    ...
    _validation = {
        ...
        'type': {'readonly': True},
        'sid': {'readonly': True},
        'has_shared_key': {'readonly': True},
        'has_ssh_key': {'readonly': True},
    }
    ...
    def __init__(self, *, permission_scopes=None, home_directory: str=None, ssh_authorized_keys=None, shared_key: str=None, **kwargs) -> None:
        ...
        self.has_shared_key = None
        self.has_ssh_key = None


class LocalUserKeys(Model):
    ...
    def __init__(self, *, ssh_authorized_keys=None, shared_key: str=None, **kwargs) -> None:
...
class PermissionScope(Model):
    ...
    :param permissions: The permissions for the local user. Possible values
     include: Read (r), Write (w), Delete (d), List (l), and Create (c).
    :type permissions: str
    :param service: The service used by the local user, e.g. blob, file.
    :type service: str
    :param resource_name: The name of resource used by the local user.
    ...
    def __init__(self, *, permissions: str=None, service: str=None, resource_name: str=None, **kwargs) -> None:
...
class SshPublicKey(Model):
    ...
    :type description: str
    :param key: Ssh public key base64 encoded
    :type key: str
    """
    ...
    def __init__(self, *, description: str=None, key: str=None, **kwargs) -> None:
...
class StorageAccount(TrackedResource):
    ...
    :param is_local_user_enabled: Enable or disable local user feature of the
     storage account
