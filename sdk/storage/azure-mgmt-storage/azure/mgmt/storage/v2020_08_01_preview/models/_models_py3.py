...
class Encryption(Model):
    ...
    :param encryption_identity: Encryption Identity properties when storage
     account is associated with a UserAssignedIdentity.
    :type encryption_identity:
     ~azure.mgmt.storage.v2020_08_01_preview.models.EncryptionIdentity
    """
    ...
    def __init__(self, *, services=None, key_source="Microsoft.Storage", require_infrastructure_encryption: bool=None, key_vault_properties=None, encryption_identity=None, **kwargs) -> None:
...
class EncryptionIdentity(Model):
    """Identity to be used for server-side encryption on the storage account.

    :param user_assigned_identity: ResourceID of the UserAssignedIdentity to
     be associated with server-side encryption on the storage account.
    :type user_assigned_identity: str
    :param type: The Encryption Identity type. Possible values include:
     'ManagedServiceIdentity', 'StorageService'
    :type type: str or
     ~azure.mgmt.storage.v2020_08_01_preview.models.EncryptionIdentityType
    """
    ...
    def __init__(self, *, user_assigned_identity: str=None, type=None, **kwargs) -> None:
...
class Identity(Model):
    ...
    :type type: str or
     ~azure.mgmt.storage.v2020_08_01_preview.models.IdentityType
    :param user_assigned_identities: Dictionary to map userAssignedIdentityID
     strings to userAssignedIdentity properties
    :type user_assigned_identities: dict[str,
     ~azure.mgmt.storage.v2020_08_01_preview.models.UserAssignedIdentityType]
    """
    ...
    _attribute_map = {
        ...
        'user_assigned_identities': {'key': 'userAssignedIdentities', 'type': '{UserAssignedIdentityType}'},
    }
...
class UserAssignedIdentityType(Model):
    ...
    :ivar tenant_id: The tenant ID of resource.
    :vartype tenant_id: str
    :ivar client_id: The identity of the client
    ...
    def __init__(self, **kwargs) -> None:
        super(UserAssignedIdentityType, self).__init__(**kwargs)
        self.principal_id = None
        self.tenant_id = None
        self.client_id = None
