...
class StorageManagementClient(MultiApiClientMixin, _SDKClient):
    ...
    def local_users(self):
        """Instance depends on the API version:
           ...
           * 2020-08-01-preview: :class:`LocalUsersOperations<azure.mgmt.storage.v2020_08_01_preview.operations.LocalUsersOperations>`
        """
        api_version = self._get_api_version('local_users')
        if api_version == '2020-08-01-preview':
            from .v2020_08_01_preview.operations import LocalUsersOperations as OperationClass
        else:
