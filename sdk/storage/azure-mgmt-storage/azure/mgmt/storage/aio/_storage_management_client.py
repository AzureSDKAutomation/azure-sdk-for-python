...
class StorageManagementClient(MultiApiClientMixin, _SDKClient):
    ...
    def deleted_accounts(self):
        """Instance depends on the API version:
           ...
           * 2019-06-01: :class:`DeletedAccountsOperations<azure.mgmt.storage.v2019_06_01.aio.operations.DeletedAccountsOperations>`
        ...
        if api_version == '2019-06-01':
            from ..v2019_06_01.aio.operations import DeletedAccountsOperations as OperationClass
        elif api_version == '2020-08-01-preview':
