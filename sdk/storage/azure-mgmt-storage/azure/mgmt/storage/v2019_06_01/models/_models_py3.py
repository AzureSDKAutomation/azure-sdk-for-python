...
class StorageAccount(TrackedResource):
    ...
    :ivar is_attribute_based_access_control_enabled: True if the account supports ABAC, otherwise
     false if the subscription is registered with the AFEC
     Microsoft.Storage/AllowAttributeBasedAccessControl, otherwise null.
    :vartype is_attribute_based_access_control_enabled: bool
    ...
    _validation = {
        ...
        'is_attribute_based_access_control_enabled': {'readonly': True},
    ...
    _attribute_map = {
        ...
        'is_attribute_based_access_control_enabled': {'key': 'properties.isAttributeBasedAccessControlEnabled', 'type': 'bool'},
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.is_attribute_based_access_control_enabled = None
