...
class ServerEndpoint(ProxyResource):
    ...
    :param initial_upload_policy: Policy for how the initial upload sync
     session is performed. Possible values include: 'ServerAuthoritative',
     'Merge'
    :type initial_upload_policy: str or
     ~azure.mgmt.storagesync.models.InitialUploadPolicy
    :ivar server_name: Server name
    :vartype server_name: str
    """
    ...
    def __init__(self, *, server_local_path: str=None, cloud_tiering=None, volume_free_space_percent: int=None, tier_files_older_than_days: int=None, friendly_name: str=None, server_resource_id: str=None, offline_data_transfer=None, offline_data_transfer_share_name: str=None, initial_download_policy=None, local_cache_mode=None, initial_upload_policy=None, **kwargs) -> None:
