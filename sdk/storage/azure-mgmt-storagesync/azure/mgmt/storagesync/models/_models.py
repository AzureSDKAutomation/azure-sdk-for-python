...
class CloudEndpointChangeEnumerationActivity(Model):
    ...
    :ivar operation_state: Change enumeration operation state. Possible values
     include: 'InitialEnumerationInProgress', 'EnumerationInProgress',
     'Delayed'
    :vartype operation_state: str or
     ~azure.mgmt.storagesync.models.CloudEndpointChangeEnumerationActivityState
    :ivar status_code: When non-zero, indicates an issue that is delaying
     change enumeration
    :vartype status_code: int
    :ivar started_timestamp: Timestamp when change enumeration started
    :vartype started_timestamp: datetime
    ...
    :ivar progress_percent: Progress percentage for change enumeration run,
     excluding processing of deletes
    :vartype progress_percent: int
    :ivar minutes_remaining: Estimate of time remaining for the enumeration
     run
    :vartype minutes_remaining: int
    :ivar total_counts_state: Change enumeration total counts state. Possible
     values include: 'Calculating', 'Final'
    :vartype total_counts_state: str or
     ~azure.mgmt.storagesync.models.CloudEndpointChangeEnumerationTotalCountsState
    :ivar deletes_progress_percent: Progress percentage for processing
     deletes. This is done separately from the rest of the enumeration run
...
class CloudEndpointChangeEnumerationStatus(Model):
    ...
    :vartype activity:
     ~azure.mgmt.storagesync.models.CloudEndpointChangeEnumerationActivity
    """
...
class CloudEndpointLastChangeEnumerationStatus(Model):
    """Cloud endpoint change enumeration status object.
    ...
    :vartype completed_timestamp: datetime
    ...
    :ivar next_run_timestamp: Timestamp of when change enumeration is expected
     to run again
    :vartype next_run_timestamp: datetime
    """
