...
class TIDataConnector(DataConnector):
    ...
    :param tenant_id: The tenant id to connect to, and get the data from.
    :type tenant_id: str
    :param tip_lookback_period: The lookback period for the feed to be
     imported.
    :type tip_lookback_period: datetime
    :param data_types: The available data types for the connector.
    :type data_types:
    ...
    def __init__(self, *, etag: str=None, tenant_id: str=None, tip_lookback_period=None, data_types=None, **kwargs) -> None:
