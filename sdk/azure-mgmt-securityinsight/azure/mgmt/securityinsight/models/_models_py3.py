...
class Bookmark(ResourceWithEtag):
    ...
    def __init__(self, *, display_name: str, query: str, etag: str=None, created=None, created_by=None, labels=None, notes: str=None, query_result: str=None, updated=None, updated_by=None, event_time=None, query_start_time=None, query_end_time=None, incident_info=None, **kwargs) -> None:
...
class IncidentInfo(Model):
    ...
    :param severity: The severity of the incident. Possible values include:
    ...
    def __init__(self, *, incident_id: str=None, severity=None, title: str=None, relation_name: str=None, **kwargs) -> None:
