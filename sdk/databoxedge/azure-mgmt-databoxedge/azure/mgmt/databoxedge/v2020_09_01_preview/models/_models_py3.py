...
class DataBoxEdgeDevice(ARMBaseModel):
    ...
    :param kind: The etag for the devices. Possible values include:
     'AzureDataBoxGateway', 'AzureStackEdge', 'AzureStackHub',
     'AzureModularDataCentre'
    :type kind: str or ~azure.mgmt.databoxedge.models.DataBoxEdgeDeviceKind
    ...
    :param resource_move_details: The details of the move operation on this
     resource.
    :type resource_move_details:
     ~azure.mgmt.databoxedge.models.ResourceMoveDetails
    :param edge_profile: The details of Edge Profile for this resource
    :type edge_profile: ~azure.mgmt.databoxedge.models.EdgeProfile
    """
    ...
    def __init__(self, *, location: str, tags=None, sku=None, etag: str=None, identity=None, kind=None, system_data=None, data_box_edge_device_status=None, description: str=None, model_description: str=None, friendly_name: str=None, resource_move_details=None, edge_profile=None, **kwargs) -> None:
        ...
        self.resource_move_details = resource_move_details
...
class Order(ARMBaseModel):
    ...
    def __init__(self, *, contact_information, shipping_address=None, current_status=None, shipment_type=None, **kwargs) -> None:
