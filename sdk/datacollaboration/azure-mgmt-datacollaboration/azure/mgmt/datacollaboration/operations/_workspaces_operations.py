...
class WorkspacesOperations(object):
    ...
    def list_by_subscription(
        ...
        :rtype:
         ~azure.mgmt.datacollaboration.models.WorkspacePaged[~azure.mgmt.datacollaboration.models.Workspace]
        :raises:
        ...
        return deserialized
    list_by_subscription.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.DataCollaboration/workspaces'}
    ...
    def list_by_resource_group(
        ...
        return deserialized
    list_by_resource_group.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces'}
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.datacollaboration.models.Workspace or
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}'}
    ...
    def create_or_update(
            self, resource_group_name, workspace_name, workspace, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.datacollaboration.models.Workspace]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.datacollaboration.models.Workspace]]
        :raises:
         :class:`DataCollaborationErrorException<azure.mgmt.datacollaboration.models.DataCollaborationErrorException>`
        """
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}'}
    ...
    def delete(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}'}
    ...
    def update(
        ...
        :raises:
         :class:`DataCollaborationErrorException<azure.mgmt.datacollaboration.models.DataCollaborationErrorException>`
        """
        workspace_update_parameters = models.WorkspaceUpdateParameters(tags=tags)
        ...
        # Construct body
        body_content = self._serialize.body(workspace_update_parameters, 'WorkspaceUpdateParameters')
        ...
        return deserialized
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}'}
