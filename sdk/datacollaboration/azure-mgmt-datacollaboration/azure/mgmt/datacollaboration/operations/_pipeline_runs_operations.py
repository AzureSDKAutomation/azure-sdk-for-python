...
class PipelineRunsOperations(object):
    ...
    def list_by_pipeline(
        ...
        return deserialized
    list_by_pipeline.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/pipelines/{pipelineName}/pipelineRuns'}

    def get(
            self, resource_group_name, workspace_name, pipeline_name, pipeline_run_name, custom_headers=None, raw=False, **operation_config):
        """Get pipeline run.
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/pipelines/{pipelineName}/pipelineRuns/{pipelineRunName}'}
    ...
    def cancel(
            self, resource_group_name, workspace_name, pipeline_name, pipeline_run_name, custom_headers=None, raw=False, polling=True, **operation_config):
    ...
    cancel.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/pipelines/{pipelineName}/pipelineRuns/{pipelineRunName}/cancel'}
