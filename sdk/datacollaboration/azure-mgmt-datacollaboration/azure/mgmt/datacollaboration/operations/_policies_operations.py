...
class PoliciesOperations(object):
    ...
    def list_by_entitlement(
        ...
        :rtype:
         ~azure.mgmt.datacollaboration.models.PolicyPaged[~azure.mgmt.datacollaboration.models.Policy]
        :raises:
        ...
        if raw:
            header_dict = {}
        deserialized = models.PolicyPaged(internal_paging, self._deserialize.dependencies, header_dict)

        return deserialized
    list_by_entitlement.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/proposals/{proposalName}/entitlements/{entitlementName}/policies'}

    def get(
            self, resource_group_name, workspace_name, proposal_name, entitlement_name, policy_name, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype: ~azure.mgmt.datacollaboration.models.Policy or
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/proposals/{proposalName}/entitlements/{entitlementName}/policies/{policyName}'}

    def create_or_update(
            self, resource_group_name, workspace_name, proposal_name, entitlement_name, policy_name, policy, custom_headers=None, raw=False, **operation_config):
        ...
        return deserialized
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/proposals/{proposalName}/entitlements/{entitlementName}/policies/{policyName}'}
    ...
    def delete(
            self, resource_group_name, workspace_name, proposal_name, entitlement_name, policy_name, custom_headers=None, raw=False, polling=True, **operation_config):
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/proposals/{proposalName}/entitlements/{entitlementName}/policies/{policyName}'}
