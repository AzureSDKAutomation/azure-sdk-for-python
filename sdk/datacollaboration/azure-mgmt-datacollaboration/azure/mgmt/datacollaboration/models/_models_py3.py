...
class DataAssetReference(ProxyDto):
    ...
    def __init__(self, *, data_asset_id: str, **kwargs) -> None:
...
class DiagnosticPolicy(Policy):
    ...
    def __init__(self, *, log_level, description: str=None, **kwargs) -> None:
...
class Entitlement(ProxyDto):
    ...
    def __init__(self, *, resource_id: str, subject_id: str, description: str=None, **kwargs) -> None:
...
class LocationConstraint(Constraint):
    ...
    def __init__(self, *, location: str, description: str=None, **kwargs) -> None:
...
class Participant(Model):
    ...
    :ivar proposal_approval_status: Current approval status. Possible values
     include: 'Pending', 'Approved', 'Active', 'Revoked'
...
class PipelineRun(ProxyDto):
    ...
    :ivar pipeline_run_status: Pipeline run status. Possible values include:
     'Succeeded', 'Failed', 'InProgress', 'Queued', 'Cancelled', 'Canceling'
...
class PipelineStepRun(ProxyDto):
    ...
    :ivar pipeline_step_run_status: Pipeline step run status. Possible values
     include: 'Succeeded', 'Failed', 'InProgress', 'Queued', 'Cancelled',
     'Canceling'
...
class Proposal(ProxyDto):
    ...
    :type invitation_id: str
    :ivar last_updated: Timestamp of the last time the proposal or any of its
    ...
    :vartype participants:
     list[~azure.mgmt.datacollaboration.models.Participant]
    ...
    def __init__(self, *, description: str=None, invitation_id: str=None, terms: str=None, **kwargs) -> None:
...
class ScriptConstraint(Constraint):
    ...
    def __init__(self, *, script_reference_id: str, description: str=None, **kwargs) -> None:
...
class ScriptReference(ProxyDto):
    ...
    :ivar type: Type of the azure resource
    :vartype type: str
    :ivar content: The content of the referenced script. null if Visibility is
    ...
    :ivar sinks: The list of sink parameters in the referenced script. null if
     Visibility is set to HiddenContent.
    :vartype sinks: list[str]
    :ivar sources: The list of source parameters in the referenced script.
     null if Visibility is set to HiddenContent.
    :vartype sources: list[str]
    :ivar visibility: The referenced script visibility modifier. Possible
     values include: 'ShowAll', 'HiddenContent'
    :vartype visibility: str or
     ~azure.mgmt.datacollaboration.models.Visibility
    """
    ...
    def __init__(self, *, revision: int, script_id: str, **kwargs) -> None:
...
class SynapseSparkPipelineStep(PipelineStep):
    ...
    def __init__(self, *, cluster_size: int, script_id: str, script_revision: int, script_sink_bindings, script_source_bindings, dependencies=None, **kwargs) -> None:
