...
class Endpoint(ProxyResource):
    ...
    :param min_child_endpoints_ipv4: The minimum number of endpoints that must
     be available in the child profile in order for the parent profile to be
     considered available. Only applicable to endpoint of type
     'NestedEndpoints'.
    :type min_child_endpoints_ipv4: long
    :param min_child_endpoints_ipv6: The minimum number of endpoints that must
     be available in the child profile in order for the parent profile to be
     considered available. Only applicable to endpoint of type
     'NestedEndpoints'.
    :type min_child_endpoints_ipv6: long
    ...
    _attribute_map = {
        ...
        'min_child_endpoints_ipv4': {'key': 'properties.minChildEndpointsIPv4', 'type': 'long'},
        'min_child_endpoints_ipv6': {'key': 'properties.minChildEndpointsIPv6', 'type': 'long'},
    ...
    def __init__(self, *, id: str=None, name: str=None, type: str=None, target_resource_id: str=None, target: str=None, endpoint_status=None, weight: int=None, priority: int=None, endpoint_location: str=None, endpoint_monitor_status=None, min_child_endpoints: int=None, min_child_endpoints_ipv4: int=None, min_child_endpoints_ipv6: int=None, geo_mapping=None, subnets=None, custom_headers=None, **kwargs) -> None:
        ...
        self.min_child_endpoints_ipv4 = min_child_endpoints_ipv4
        self.min_child_endpoints_ipv6 = min_child_endpoints_ipv6
