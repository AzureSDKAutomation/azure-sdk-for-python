...
class AgentPool(SubResource):
    ...
    :param agent_pool_version_profile: AgentPoolVersionProfile contains the
     agent pool components' version information.
    :type agent_pool_version_profile:
     ~azure.mgmt.containerservice.v2020_03_01.models.AgentPoolVersionProfile
    """
    ...
    def __init__(self, *, vm_size, count: int=1, os_disk_size_gb: int=None, vnet_subnet_id: str=None, max_pods: int=None, os_type="Linux", max_count: int=None, min_count: int=None, enable_auto_scaling: bool=None, agent_pool_type=None, orchestrator_version: str=None, availability_zones=None, enable_node_public_ip: bool=None, scale_set_priority="Regular", scale_set_eviction_policy="Delete", spot_max_price: float=None, tags=None, node_labels=None, node_taints=None, agent_pool_version_profile=None, **kwargs) -> None:
        ...
        self.agent_pool_version_profile = agent_pool_version_profile
...
class AgentPoolVersionProfile(Model):
    """The agent pool's node image version.

    :param node_image_version: The node image version.
    ...
    def __init__(self, *, node_image_version: str=None, **kwargs) -> None:
        super(AgentPoolVersionProfile, self).__init__(**kwargs)
...
class ManagedClusterAgentPoolProfileProperties(Model):
    ...
    _attribute_map = {
        ...
        'agent_pool_version_profile': {'key': 'agentPoolVersionProfile', 'type': 'AgentPoolVersionProfile'},
    }
