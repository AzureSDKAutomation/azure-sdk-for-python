...
class Addon(Resource):
    ...
    def __init__(self, *, license_key: str=None, addon_type=None, **kwargs) -> None:
...
class AddonSrmProperties(Model):
    ...
    def __init__(self, *, license_key: str=None, **kwargs) -> None:
        super(AddonSrmProperties, self).__init__(**kwargs)
        self.license_key = license_key


class AddonUpdate(Model):
