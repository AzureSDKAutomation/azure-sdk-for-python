...
class WorkloadNetworksOperations(object):
    ...
    def list_dns_services(
        ...
        :rtype:
         ~azure.mgmt.avs.models.WorkloadNetworkDnsServicePaged[~azure.mgmt.avs.models.WorkloadNetworkDnsService]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
                # Construct URL
                url = self.list_dns_services.metadata['url']
                path_format_arguments = {
                    'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str', min_length=1),
                    'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
                    'privateCloudName': self._serialize.url("private_cloud_name", private_cloud_name, 'str')
        ...
        if raw:
            header_dict = {}
        deserialized = models.WorkloadNetworkDnsServicePaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get_dns_service(
            self, resource_group_name, private_cloud_name, dns_service_id, custom_headers=None, raw=False, **operation_config):
        ...
        :param private_cloud_name: Name of the private cloud
        :type private_cloud_name: str
        :param dns_service_id: NSX DNS Service identifier. Generally the same
         as the DNS Service's display name
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: WorkloadNetworkDnsService or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.avs.models.WorkloadNetworkDnsService or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
        url = self.get_dns_service.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str', min_length=1),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'privateCloudName': self._serialize.url("private_cloud_name", private_cloud_name, 'str'),
        ...
        deserialized = None
        if response.status_code == 200:
            deserialized = self._deserialize('WorkloadNetworkDnsService', response)
    ...
    def _create_dns_service_initial(
            self, resource_group_name, private_cloud_name, dns_service_id, workload_network_dns_service, custom_headers=None, raw=False, **operation_config):
        # Construct URL
        url = self.create_dns_service.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str', min_length=1),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'privateCloudName': self._serialize.url("private_cloud_name", private_cloud_name, 'str'),
    ...
    def create_dns_service(
            self, resource_group_name, private_cloud_name, dns_service_id, workload_network_dns_service, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :type workload_network_dns_service:
         ~azure.mgmt.avs.models.WorkloadNetworkDnsService
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of LROPoller that returns
         WorkloadNetworkDnsService or
         ClientRawResponse<WorkloadNetworkDnsService> if raw==True
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.avs.models.WorkloadNetworkDnsService]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.avs.models.WorkloadNetworkDnsService]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    create_dns_service.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/dnsServices/{dnsServiceId}'}


    def _update_dns_service_initial(
            self, resource_group_name, private_cloud_name, dns_service_id, workload_network_dns_service, custom_headers=None, raw=False, **operation_config):
        # Construct URL
        url = self.update_dns_service.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str', min_length=1),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'privateCloudName': self._serialize.url("private_cloud_name", private_cloud_name, 'str'),
    ...
    def update_dns_service(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    update_dns_service.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/dnsServices/{dnsServiceId}'}


    def _delete_dns_service_initial(
            self, resource_group_name, dns_service_id, private_cloud_name, custom_headers=None, raw=False, **operation_config):
        # Construct URL
        url = self.delete_dns_service.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str', min_length=1),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'dnsServiceId': self._serialize.url("dns_service_id", dns_service_id, 'str'),
    ...
    def delete_dns_service(
            self, resource_group_name, dns_service_id, private_cloud_name, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    delete_dns_service.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/dnsServices/{dnsServiceId}'}
    ...
    def list_dns_zones(
        ...
        :rtype:
         ~azure.mgmt.avs.models.WorkloadNetworkDnsZonePaged[~azure.mgmt.avs.models.WorkloadNetworkDnsZone]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
                # Construct URL
                url = self.list_dns_zones.metadata['url']
                path_format_arguments = {
                    'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str', min_length=1),
                    'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
                    'privateCloudName': self._serialize.url("private_cloud_name", private_cloud_name, 'str')
        ...
        if raw:
            header_dict = {}
        deserialized = models.WorkloadNetworkDnsZonePaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get_dns_zone(
            self, resource_group_name, private_cloud_name, dns_zone_id, custom_headers=None, raw=False, **operation_config):
        ...
        :param private_cloud_name: Name of the private cloud
        :type private_cloud_name: str
        :param dns_zone_id: NSX DNS Zone identifier. Generally the same as the
         DNS Zone's display name
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: WorkloadNetworkDnsZone or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.avs.models.WorkloadNetworkDnsZone or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
        url = self.get_dns_zone.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str', min_length=1),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'privateCloudName': self._serialize.url("private_cloud_name", private_cloud_name, 'str'),
        ...
        deserialized = None
        if response.status_code == 200:
            deserialized = self._deserialize('WorkloadNetworkDnsZone', response)
    ...
    def _create_dns_zone_initial(
            self, resource_group_name, private_cloud_name, dns_zone_id, workload_network_dns_zone, custom_headers=None, raw=False, **operation_config):
        # Construct URL
        url = self.create_dns_zone.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str', min_length=1),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'privateCloudName': self._serialize.url("private_cloud_name", private_cloud_name, 'str'),
    ...
    def create_dns_zone(
            self, resource_group_name, private_cloud_name, dns_zone_id, workload_network_dns_zone, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :type workload_network_dns_zone:
         ~azure.mgmt.avs.models.WorkloadNetworkDnsZone
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of LROPoller that returns WorkloadNetworkDnsZone
         or ClientRawResponse<WorkloadNetworkDnsZone> if raw==True
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.avs.models.WorkloadNetworkDnsZone]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.avs.models.WorkloadNetworkDnsZone]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    create_dns_zone.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/dnsZones/{dnsZoneId}'}


    def _update_dns_zone_initial(
            self, resource_group_name, private_cloud_name, dns_zone_id, workload_network_dns_zone, custom_headers=None, raw=False, **operation_config):
        # Construct URL
        url = self.update_dns_zone.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str', min_length=1),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'privateCloudName': self._serialize.url("private_cloud_name", private_cloud_name, 'str'),
    ...
    def update_dns_zone(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    update_dns_zone.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/dnsZones/{dnsZoneId}'}


    def _delete_dns_zone_initial(
            self, resource_group_name, dns_zone_id, private_cloud_name, custom_headers=None, raw=False, **operation_config):
        # Construct URL
        url = self.delete_dns_zone.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str', min_length=1),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'dnsZoneId': self._serialize.url("dns_zone_id", dns_zone_id, 'str'),
    ...
    def delete_dns_zone(
            self, resource_group_name, dns_zone_id, private_cloud_name, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    delete_dns_zone.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/dnsZones/{dnsZoneId}'}
