...
class DedicatedHostGroup(Resource):
    ...
    :param support_automatic_placement: Specifies whether virtual machines or
     ...
     is defaulted to 'false' when not provided. <br><br>Minimum api-version:
     2020-06-01.
...
class HardwareProfile(Model):
     ...
     **VirtualMachineSizeTypes** string constants will be removed from the
     subsequent REST API specification. Use [List all available virtual machine
     sizes in a region](
     ...
     'Standard_D4_v3', 'Standard_D8_v3', 'Standard_D16_v3', 'Standard_D32_v3',
     ...
     'Standard_GS5', 'Standard_GS4-8', 'Standard_GS4-4', 'Standard_GS5-16',
     'Standard_GS5-8', 'Standard_H8', 'Standard_H16', 'Standard_H8m',
     'Standard_H16m', 'Standard_H16r', 'Standard_H16mr', 'Standard_L4s',
     'Standard_L8s', 'Standard_L16s', 'Standard_L32s', 'Standard_M64s',
...
class LogAnalyticsInputBase(Model):
    ...
    :param group_by_client_application_id: Group query result by Client
     Application ID.
    ...
    def __init__(self, *, blob_container_sas_uri: str, from_time, to_time, group_by_throttle_policy: bool=None, group_by_operation_name: bool=None, group_by_resource_name: bool=None, group_by_client_application_id: bool=None, group_by_user_agent: bool=None, **kwargs) -> None:
...
class RequestRateByIntervalInput(LogAnalyticsInputBase):
    ...
    def __init__(self, *, blob_container_sas_uri: str, from_time, to_time, interval_length, group_by_throttle_policy: bool=None, group_by_operation_name: bool=None, group_by_resource_name: bool=None, group_by_client_application_id: bool=None, group_by_user_agent: bool=None, **kwargs) -> None:
...
class VirtualMachineScaleSetNetworkConfiguration(SubResource):
    ...
    :param enable_fpga: Specifies whether the network interface is FPGA
     networking-enabled.
    ...
    def __init__(self, *, name: str, ip_configurations, id: str=None, primary: bool=None, enable_accelerated_networking: bool=None, enable_fpga: bool=None, network_security_group=None, dns_settings=None, enable_ip_forwarding: bool=None, **kwargs) -> None:
...
class VirtualMachineScaleSetUpdateNetworkConfiguration(SubResource):
    ...
    def __init__(self, *, id: str=None, name: str=None, primary: bool=None, enable_accelerated_networking: bool=None, enable_fpga: bool=None, network_security_group=None, dns_settings=None, ip_configurations=None, enable_ip_forwarding: bool=None, **kwargs) -> None:
