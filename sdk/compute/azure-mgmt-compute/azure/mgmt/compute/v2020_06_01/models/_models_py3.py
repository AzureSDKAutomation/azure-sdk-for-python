...
class VirtualMachineImage(VirtualMachineImageResource):
    ...
    :param features:
    :type features:
     list[~azure.mgmt.compute.v2020_06_01.models.VirtualMachineImageFeature]
    """
    ...
    def __init__(self, *, name: str, location: str, id: str=None, tags=None, plan=None, os_disk_image=None, data_disk_images=None, automatic_os_upgrade_properties=None, hyper_vgeneration=None, disallowed=None, features=None, **kwargs) -> None:
...
class VirtualMachineImageFeature(Model):
