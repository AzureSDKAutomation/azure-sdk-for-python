...
class DataDisk(Model):
    ...
    :param detach_option: Specifies the detach behavior to be used while
     detaching a disk or which is already in the process of detachment from the
     virtual machine. Supported values: **ForceDetach**. <br><br> detachOption:
    ...
    :type detach_option: str or
     ~azure.mgmt.compute.v2020_06_01.models.DiskDetachOptionTypes
    ...
    def __init__(self, *, lun: int, create_option, name: str=None, vhd=None, image=None, caching=None, write_accelerator_enabled: bool=None, disk_size_gb: int=None, managed_disk=None, to_be_detached: bool=None, detach_option=None, **kwargs) -> None:
