...
class AppConfigurationKeyValueDeletedEventData(Model):
    ...
    :type etag: str
    :param sync_token: The sync token representing the server state after the
     event.
    :type sync_token: str
    """
    ...
    def __init__(self, *, key: str=None, label: str=None, etag: str=None, sync_token: str=None, **kwargs) -> None:
...
class ServiceBusActiveMessagesAvailablePeriodicNotificationsEventData(Model):
    """Schema of the Data property of an EventGridEvent for a
...
class ServiceBusDeadletterMessagesAvailablePeriodicNotificationsEventData(Model):
    """Schema of the Data property of an EventGridEvent for a
