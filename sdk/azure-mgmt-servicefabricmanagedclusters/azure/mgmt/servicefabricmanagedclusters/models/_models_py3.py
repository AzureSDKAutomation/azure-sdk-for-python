...
class ApplicationResource(ProxyResource):
    ...
    def __init__(self, *, location: str=None, tags=None, system_data=None, identity=None, type_name: str=None, type_version: str=None, parameters=None, upgrade_policy=None, managed_identities=None, **kwargs) -> None:
