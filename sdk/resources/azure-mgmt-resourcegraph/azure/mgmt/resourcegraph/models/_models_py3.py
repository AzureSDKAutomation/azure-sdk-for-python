...
class ResourceChangeData(Model):
    ...
    def __init__(self, *, change_id: str, before_snapshot, after_snapshot, resource_id: str=None, change_type=None, property_changes=None, **kwargs) -> None:
...
class ResourceSnapshotData(Model):
    ...
    def __init__(self, *, timestamp, snapshot_id: str=None, content=None, **kwargs) -> None:
...
class ResourcesHistoryRequest(Model):
    ...
    :param options:
    :type options:
     ~azure.mgmt.resourcegraph.models.ResourcesHistoryRequestOptions
    ...
    def __init__(self, *, subscriptions=None, query: str=None, options=None, management_group_id: str=None, **kwargs) -> None:
...
class ResourcesHistoryRequestOptions(Model):
    ...
    :type result_format: str or ~azure.mgmt.resourcegraph.models.enum
    """
    ...
    def __init__(self, *, interval=None, top: int=None, skip: int=None, skip_token: str=None, result_format=None, **kwargs) -> None:
