...
from .operations_async import TagsOperationOperations
...
class ResourceManagementClient(object):
    ...
    :ivar tags_operation: TagsOperationOperations operations
    :vartype tags_operation: azure.mgmt.resource.resources.v2020_06_01.aio.operations_async.TagsOperationOperations
