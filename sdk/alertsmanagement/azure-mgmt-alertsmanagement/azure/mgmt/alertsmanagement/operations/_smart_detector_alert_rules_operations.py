...
class SmartDetectorAlertRulesOperations(object):
    ...
    def list(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                path_format_arguments = {
                    'subscriptionId-test-test': self._serialize.url("self.config.subscription_id_test_test", self.config.subscription_id_test_test, 'str', min_length=1)
                }
        ...
        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/providers/test/microsoft.alertsManagement/smartDetectorAlertRules'}
