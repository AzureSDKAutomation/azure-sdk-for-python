...
class PartnerTransfersOperations(object):
    ...
    def get(
        ...
        :return: PartnerTransferDetails or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.billing.models.PartnerTransferDetails or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('PartnerTransferDetails', response)
    ...
    def initiate(
            self, billing_account_name, customer_name, transfer_name, recipient_email_id=None, reseller_id=None, custom_headers=None, raw=False, **operation_config):
        ...
        return deserialized
    initiate.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/customers/{customerName}/transfers/{transferName}'}
    ...
    def cancel(
        ...
        return deserialized
    cancel.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/customers/{customerName}/transfers/{transferName}/cancel'}
    ...
    def list(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: An iterator like instance of PartnerTransferDetails
        :rtype:
         ~azure.mgmt.billing.models.PartnerTransferDetailsPaged[~azure.mgmt.billing.models.PartnerTransferDetails]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.billing.models.ErrorResponseException>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.PartnerTransferDetailsPaged(internal_paging, self._deserialize.dependencies, header_dict)
