...
class TransfersOperations(object):
    ...
    def initiate(
            self, billing_account_name, billing_profile_name, invoice_section_name, transfer_name, recipient_email_id=None, reseller_id=None, custom_headers=None, raw=False, **operation_config):
        ...
        return deserialized
    initiate.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/invoiceSections/{invoiceSectionName}/transfers/{transferName}'}
    ...
    def cancel(
        ...
        return deserialized
    cancel.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/invoiceSections/{invoiceSectionName}/transfers/{transferName}/cancel'}
