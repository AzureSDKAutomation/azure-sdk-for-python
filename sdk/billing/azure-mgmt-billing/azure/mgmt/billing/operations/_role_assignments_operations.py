...
class RoleAssignmentsOperations(object):
    ...
    def put(
            self, billing_account_name, billing_role_assignment_name, parameters, custom_headers=None, raw=False, **operation_config):
        ...
        return deserialized
    put.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingRoleAssignments/{billingRoleAssignmentName}'}
