...
class BillingRoleAssignmentsOperations(object):
    ...
    def get_by_department(
            self, billing_account_name, department_name, billing_role_assignment_name, custom_headers=None, raw=False, **operation_config):
        ...
        return deserialized
    get_by_department.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/departments/{departmentName}/billingRoleAssignments/{billingRoleAssignmentName}'}

    def delete_by_department(
            self, billing_account_name, department_name, billing_role_assignment_name, custom_headers=None, raw=False, **operation_config):
        """Deletes a role assignment for the caller on a department. The operation
        is supported only for billing accounts with agreement type Enterprise
        Agreement.
        ...
        return deserialized
    delete_by_department.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/departments/{departmentName}/billingRoleAssignments/{billingRoleAssignmentName}'}

    def get_by_enrollment_account(
            self, billing_account_name, enrollment_account_name, billing_role_assignment_name, custom_headers=None, raw=False, **operation_config):
        ...
        """
        # Construct URL
        url = self.get_by_enrollment_account.metadata['url']
        path_format_arguments = {
            'billingAccountName': self._serialize.url("billing_account_name", billing_account_name, 'str'),
        ...
        return deserialized
    get_by_enrollment_account.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/enrollmentAccounts/{enrollmentAccountName}/billingRoleAssignments/{billingRoleAssignmentName}'}
    ...
    def delete_by_enrollment_account(
        ...
        return deserialized
    delete_by_enrollment_account.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/enrollmentAccounts/{enrollmentAccountName}/billingRoleAssignments/{billingRoleAssignmentName}'}
    ...
    def list_by_enrollment_account(
        ...
        return deserialized
    list_by_enrollment_account.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/enrollmentAccounts/{enrollmentAccountName}/billingRoleAssignments'}
    ...
    def list_by_department(
        ...
        return deserialized
    list_by_department.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/departments/{departmentName}/billingRoleAssignments'}
