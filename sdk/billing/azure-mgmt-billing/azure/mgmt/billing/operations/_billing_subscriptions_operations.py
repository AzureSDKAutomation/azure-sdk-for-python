...
class BillingSubscriptionsOperations(object):
    ...
    def _change_invoice_section_initial(
            self, billing_account_name, destination_invoice_section_id, custom_headers=None, raw=False, **operation_config):
        parameters = models.TransferBillingSubscriptionRequestProperties(destination_invoice_section_id=destination_invoice_section_id)

        # Construct URL
        url = self.change_invoice_section.metadata['url']
        path_format_arguments = {
            'billingAccountName': self._serialize.url("billing_account_name", billing_account_name, 'str'),
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str')
        }
    ...
    def change_invoice_section(
            self, billing_account_name, destination_invoice_section_id, custom_headers=None, raw=False, polling=True, **operation_config):
        """Moves a subscription's charges to a new invoice section. This operation
        ...
        :raises:
         :class:`ErrorResponseException<azure.mgmt.billing.models.ErrorResponseException>`
        """
        raw_result = self._change_invoice_section_initial(
            billing_account_name=billing_account_name,
            destination_invoice_section_id=destination_invoice_section_id,
            custom_headers=custom_headers,
            raw=True,
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    change_invoice_section.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingSubscriptions/{subscriptionId}/changeInvoiceSection'}
