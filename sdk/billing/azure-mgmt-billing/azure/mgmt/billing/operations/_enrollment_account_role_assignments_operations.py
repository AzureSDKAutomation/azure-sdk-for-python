...
class EnrollmentAccountRoleAssignmentsOperations(object):
    ...
    def put(
            self, billing_account_name, enrollment_account_name, billing_role_assignment_name, parameters, custom_headers=None, raw=False, **operation_config):
        ...
        # Construct body
        body_content = self._serialize.body(parameters, 'BillingRoleAssignment')
        ...
        return deserialized
    put.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/enrollmentAccounts/{enrollmentAccountName}/billingRoleAssignments/{billingRoleAssignmentName}'}
