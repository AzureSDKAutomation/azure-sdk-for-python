...
class RecipientTransfersOperations(object):
    ...
    def accept(
        ...
        return deserialized
    accept.metadata = {'url': '/providers/Microsoft.Billing/transfers/{transferName}/accept'}
    ...
    def validate(
        ...
        return deserialized
    validate.metadata = {'url': '/providers/Microsoft.Billing/transfers/{transferName}/validate'}
    ...
    def decline(
        ...
        return deserialized
    decline.metadata = {'url': '/providers/Microsoft.Billing/transfers/{transferName}/decline'}
