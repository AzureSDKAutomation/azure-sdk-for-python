...
class BillingSubscriptionInvoicesOperations(object):
    ...
    def get_by_id(
            self, billing_subscription_name, invoice_name, custom_headers=None, raw=False, **operation_config):
        ...
        return deserialized
    get_by_id.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/default/billingSubscriptions/{billingSubscriptionName}/invoices/{invoiceName}'}
    ...
    def download(
            self, billing_subscription_name, invoice_name, custom_headers=None, raw=False, polling=True, **operation_config):
    ...
    download.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/default/billingSubscriptions/{billingSubscriptionName}/invoices/{invoiceName}/download'}
