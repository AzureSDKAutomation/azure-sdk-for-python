...
from .operations import BillingAccountInvoicesOperations
from .operations import EaInvoicesOperations
from .operations import PriceSheetOperations
from .operations import BillingSubscriptionInvoicesOperations
...
class BillingManagementClient(SDKClient):
    ...
    :ivar billing_account_invoices: BillingAccountInvoices operations
    :vartype billing_account_invoices: azure.mgmt.billing.operations.BillingAccountInvoicesOperations
    :ivar ea_invoices: EaInvoices operations
    :vartype ea_invoices: azure.mgmt.billing.operations.EaInvoicesOperations
    :ivar price_sheet: PriceSheet operations
    :vartype price_sheet: azure.mgmt.billing.operations.PriceSheetOperations
    :ivar billing_subscription_invoices: BillingSubscriptionInvoices operations
    :vartype billing_subscription_invoices: azure.mgmt.billing.operations.BillingSubscriptionInvoicesOperations
    ...
    def __init__(
        ...
        self.invoices = InvoicesOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.billing_account_invoices = BillingAccountInvoicesOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.ea_invoices = EaInvoicesOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.price_sheet = PriceSheetOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.billing_subscription_invoices = BillingSubscriptionInvoicesOperations(
            self._client, self.config, self._serialize, self._deserialize)
