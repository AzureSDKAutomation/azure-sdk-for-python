...
from .operations import EnrollmentDepartmentRoleAssignmentsOperations
from .operations import EnrollmentAccountRoleAssignmentsOperations
...
class BillingManagementClient(SDKClient):
    ...
    :vartype role_assignments: azure.mgmt.billing.operations.RoleAssignmentsOperations
    :ivar enrollment_department_role_assignments: EnrollmentDepartmentRoleAssignments operations
    :vartype enrollment_department_role_assignments: azure.mgmt.billing.operations.EnrollmentDepartmentRoleAssignmentsOperations
    :ivar enrollment_account_role_assignments: EnrollmentAccountRoleAssignments operations
    :vartype enrollment_account_role_assignments: azure.mgmt.billing.operations.EnrollmentAccountRoleAssignmentsOperations
    ...
    def __init__(
        ...
        self.role_assignments = RoleAssignmentsOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.enrollment_department_role_assignments = EnrollmentDepartmentRoleAssignmentsOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.enrollment_account_role_assignments = EnrollmentAccountRoleAssignmentsOperations(
            self._client, self.config, self._serialize, self._deserialize)
