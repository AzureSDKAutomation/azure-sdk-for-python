...
class PartnerTransferDetailsPaged(Paged):
    """
    A paging container for iterating over a list of :class:`PartnerTransferDetails <azure.mgmt.billing.models.PartnerTransferDetails>` object
    """

    _attribute_map = {
        'next_link': {'key': 'nextLink', 'type': 'str'},
        'current_page': {'key': 'value', 'type': '[PartnerTransferDetails]'}
    }

    def __init__(self, *args, **kwargs):

        super(PartnerTransferDetailsPaged, self).__init__(*args, **kwargs)
