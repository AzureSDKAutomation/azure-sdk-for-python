...
class DissociatePaymentInstrumentEligibilityResult(Model):
    """Result of the dissociate payment instrument eligibility validation.

    Variables are only populated by the server, and will be ignored when
    sending a request.

    :ivar is_eligible: Specifies whether the subscription is eligible to be
     transferred.
    :vartype is_eligible: bool
    :ivar error_details: The list of dissociate payment instrument eligibility
     errors.
    :vartype error_details:
     list[~azure.mgmt.billing.models.DissociatePaymentInstrumentErrorDetails]
    """

    _validation = {
        'is_eligible': {'readonly': True},
        'error_details': {'readonly': True},
    }

    _attribute_map = {
        'is_eligible': {'key': 'isEligible', 'type': 'bool'},
        'error_details': {'key': 'errorDetails', 'type': '[DissociatePaymentInstrumentErrorDetails]'},
    }

    def __init__(self, **kwargs):
        super(DissociatePaymentInstrumentEligibilityResult, self).__init__(**kwargs)
        self.is_eligible = None
        self.error_details = None


class DissociatePaymentInstrumentErrorDetails(Model):
    """Error details of the dissociate payment instrument eligibility validation.

    :param code: Error code for the dissociate payment instrument eligibility
     validation. Possible values include: 'AzureSubscriptions',
     'RecurringCharges', 'ReservedInstances', 'OutstandingCharges',
     'PendingCharges'
    :type code: str or
     ~azure.mgmt.billing.models.DissociatePaymentInstrumentEligibilityErrorCode
    :param message: Error message for the dissociate payment instrument
    ...
    def __init__(self, **kwargs):
        super(DissociatePaymentInstrumentErrorDetails, self).__init__(**kwargs)
