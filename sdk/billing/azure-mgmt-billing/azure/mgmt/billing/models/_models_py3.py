...
class BillingAccount(Resource):
    ...
    :ivar is_transitioned: Specifies if the billing account has transitioned
     from agreement type Microsoft Online Service Program to agreement type
     Microsoft Customer Agreement.
    :vartype is_transitioned: bool
    """
    ...
    _attribute_map = {
        ...
        'is_transitioned': {'key': 'properties.isTransitioned', 'type': 'bool'},
    }
...
class BillingProfile(Resource):
    ...
    :ivar has_read_access: Indicates whether user has read access to the
     billing profile.
    :vartype has_read_access: bool
    :ivar is_transitioned: Specifies if the billing profile was created during
     transition of the billing account from agreement type Microsoft Online
     Service Program to agreement type Microsoft Customer Agreement.
    :vartype is_transitioned: bool
