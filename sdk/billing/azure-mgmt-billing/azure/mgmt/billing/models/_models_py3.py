...
class PartnerTransferDetails(Resource):
    ...
    def __init__(self, **kwargs) -> None:
        super(PartnerTransferDetails, self).__init__(**kwargs)
...
class RecipientTransferDetails(Resource):
    """Details of the transfer.
...
class TransferDetails(Resource):
    """Details of the transfer.
