...
class IotSensorsModel(Resource):
    ...
    :ivar type: Resource type
    :vartype type: str
    :param zone: Display name of the IoT zone
    :type zone: str
    """
    ...
    def __init__(self, *, zone: str=None, **kwargs) -> None:
...
class IotSitesModel(Resource):
    ...
    :type display_name: str
    :param tags: Required. Tags of the IoT site
    :type tags: dict[str, str]
    """
    ...
    def __init__(self, *, display_name: str, tags, **kwargs) -> None:
