...
class AdditionalWorkspacesProperties(Model):
    ...
    def __init__(self, *, workspace: str=None, type="Sentinel", data_types=None, **kwargs) -> None:
...
class InsightsModel(Resource):
    ...
    :ivar insight_description: Describes the insight.
    :vartype insight_description: str
    :ivar insight_properties: A bag of objects which provides the insights
     information
    :vartype insight_properties: object
    """
    ...
    _validation = {
        ...
        'insight_description': {'readonly': True},
        'insight_properties': {'readonly': True},
    }
    ...
    _attribute_map = {
        ...
        'insight_description': {'key': 'properties.insightDescription', 'type': 'str'},
        'insight_properties': {'key': 'properties.insightProperties', 'type': 'object'},
    }

    def __init__(self, **kwargs) -> None:
        super(InsightsModel, self).__init__(**kwargs)
        self.associated_resource = None
        self.insight_description = None
        self.insight_properties = None
...
class IoTSecuritySolutionModel(Model):
    ...
    def __init__(self, *, display_name: str, iot_hubs, tags=None, location: str=None, workspace: str=None, status="Enabled", export=None, disabled_data_sources=None, user_defined_resources=None, recommendations_configuration=None, unmasked_ip_logging_status="Disabled", additional_workspaces=None, **kwargs) -> None:
