...
class AzureRedHatOpenShiftClient(SDKClient):
    ...
    :vartype operations: azure.mgmt.redhatopenshift.v2021-01-31-preview.operations.Operations
    :ivar open_shift_clusters: OpenShiftClusters operations
    :vartype open_shift_clusters: azure.mgmt.redhatopenshift.v2021-01-31-preview.operations.OpenShiftClustersOperations
