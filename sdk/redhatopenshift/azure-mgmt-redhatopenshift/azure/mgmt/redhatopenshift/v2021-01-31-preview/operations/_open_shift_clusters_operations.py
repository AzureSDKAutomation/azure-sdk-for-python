...
class OpenShiftClustersOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.redhatopenshift.v2021-01-31-preview.models.OpenShiftClusterPaged[~azure.mgmt.redhatopenshift.v2021-01-31-preview.models.OpenShiftCluster]
    ...
    def get(
        ...
        :rtype:
         ~azure.mgmt.redhatopenshift.v2021-01-31-preview.models.OpenShiftCluster
    ...
    def create_or_update(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.redhatopenshift.v2021-01-31-preview.models.OpenShiftCluster]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.redhatopenshift.v2021-01-31-preview.models.OpenShiftCluster]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def update(
        ...
        :param parameters: The OpenShift cluster resource.
        :type parameters:
         ~azure.mgmt.redhatopenshift.v2021-01-31-preview.models.OpenShiftClusterUpdate
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
    ...
    def list_admin_kubeconfig(
        ...
        :return: OpenShiftClusterAdminKubeconfig or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.redhatopenshift.v2021-01-31-preview.models.OpenShiftClusterAdminKubeconfig
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def list_credentials(
        ...
        :rtype:
         ~azure.mgmt.redhatopenshift.v2021-01-31-preview.models.OpenShiftClusterCredentials
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
