...
class CheckAvailabilityResult(Resource):
    ...
    def __init__(self, *, location: str=None, tags=None, is_availiable: bool=None, **kwargs) -> None:
        super(CheckAvailabilityResult, self).__init__(location=location, tags=tags, **kwargs)
        self.is_availiable = is_availiable
...
class DebugSendResponse(Resource):
    ...
    def __init__(self, *, location: str=None, tags=None, success: float=None, failure: float=None, results=None, **kwargs) -> None:
        super(DebugSendResponse, self).__init__(location=location, tags=tags, **kwargs)
...
class NamespaceResource(Resource):
    ...
    def __init__(self, *, location: str=None, tags=None, namespace_resource_name: str=None, provisioning_state: str=None, region: str=None, status: str=None, created_at=None, updated_at=None, service_bus_endpoint: str=None, subscription_id: str=None, scale_unit: str=None, enabled: bool=None, critical: bool=None, data_center: str=None, namespace_type=None, sku=None, **kwargs) -> None:
...
class NamespaceCreateOrUpdateParameters(NamespaceResource):
    ...
    def __init__(self, *, location: str=None, tags=None, namespace_resource_name: str=None, provisioning_state: str=None, region: str=None, status: str=None, created_at=None, updated_at=None, service_bus_endpoint: str=None, subscription_id: str=None, scale_unit: str=None, enabled: bool=None, critical: bool=None, data_center: str=None, namespace_type=None, sku=None, **kwargs) -> None:
        super(NamespaceCreateOrUpdateParameters, self).__init__(location=location, tags=tags, namespace_resource_name=namespace_resource_name, provisioning_state=provisioning_state, region=region, status=status, created_at=created_at, updated_at=updated_at, service_bus_endpoint=service_bus_endpoint, subscription_id=subscription_id, scale_unit=scale_unit, enabled=enabled, critical=critical, data_center=data_center, namespace_type=namespace_type, sku=sku, **kwargs)
...
class NotificationHubCreateOrUpdateParameters(Resource):
    ...
    def __init__(self, *, location: str=None, tags=None, notification_hub_create_or_update_parameters_name: str=None, registration_ttl: str=None, authorization_rules=None, apns_credential=None, wns_credential=None, gcm_credential=None, mpns_credential=None, adm_credential=None, baidu_credential=None, **kwargs) -> None:
        super(NotificationHubCreateOrUpdateParameters, self).__init__(location=location, tags=tags, **kwargs)
...
class NotificationHubPatchParameters(Resource):
    ...
    def __init__(self, *, location: str=None, tags=None, notification_hub_patch_parameters_name: str=None, registration_ttl: str=None, authorization_rules=None, apns_credential=None, wns_credential=None, gcm_credential=None, mpns_credential=None, adm_credential=None, baidu_credential=None, **kwargs) -> None:
        super(NotificationHubPatchParameters, self).__init__(location=location, tags=tags, **kwargs)
...
class NotificationHubResource(Resource):
    ...
    def __init__(self, *, location: str=None, tags=None, notification_hub_resource_name: str=None, registration_ttl: str=None, authorization_rules=None, apns_credential=None, wns_credential=None, gcm_credential=None, mpns_credential=None, adm_credential=None, baidu_credential=None, **kwargs) -> None:
        super(NotificationHubResource, self).__init__(location=location, tags=tags, **kwargs)
...
class PnsCredentialsResource(Resource):
    ...
    def __init__(self, *, location: str=None, tags=None, apns_credential=None, wns_credential=None, gcm_credential=None, mpns_credential=None, adm_credential=None, baidu_credential=None, **kwargs) -> None:
        super(PnsCredentialsResource, self).__init__(location=location, tags=tags, **kwargs)
        self.apns_credential = apns_credential
        self.wns_credential = wns_credential
        self.gcm_credential = gcm_credential
        self.mpns_credential = mpns_credential
...
class SharedAccessAuthorizationRuleResource(Resource):
    ...
    def __init__(self, *, location: str=None, tags=None, rights=None, **kwargs) -> None:
        super(SharedAccessAuthorizationRuleResource, self).__init__(location=location, tags=tags, **kwargs)
        self.rights = rights
        self.primary_key = None
        self.secondary_key = None
        self.key_name = None
