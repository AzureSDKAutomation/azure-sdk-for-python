...
class IotDpsPropertiesDescription(Model):
    ...
    :param version: Iot Dps Version. Possible values include: 'V1', 'V2'
    :type version: str or
     ~azure.mgmt.iothubprovisioningservices.models.IotDpsVersion
    """
    ...
    def __init__(self, *, state=None, encryption=None, public_network_access=None, ip_filter_rules=None, private_endpoint_connections=None, provisioning_state: str=None, iot_hubs=None, allocation_policy=None, authorization_policies=None, version=None, **kwargs) -> None:
