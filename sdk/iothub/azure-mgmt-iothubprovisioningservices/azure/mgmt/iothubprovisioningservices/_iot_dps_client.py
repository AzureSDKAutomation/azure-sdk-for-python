...
from .operations import DpsCertificateAuthorityOperations
...
class IotDpsClient(SDKClient):
    ...
    :ivar dps_certificate_authority: DpsCertificateAuthority operations
    :vartype dps_certificate_authority: azure.mgmt.iothubprovisioningservices.operations.DpsCertificateAuthorityOperations
    ...
    def __init__(
        ...
        self.dps_certificate = DpsCertificateOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.dps_certificate_authority = DpsCertificateAuthorityOperations(
            self._client, self.config, self._serialize, self._deserialize)
