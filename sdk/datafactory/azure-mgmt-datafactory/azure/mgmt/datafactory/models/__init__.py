...
try:
    ...
    from ._models import CredentialReference
    from ._models import CredentialResource
    ...
    from ._models import ServicePrincipalCredential
...
from ._paged_models import CredentialResourcePaged
