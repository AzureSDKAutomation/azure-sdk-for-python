...
class Monitor(Model):
    ...
    :param id: Required. Arm ID. Arm ID of this monitor.
    :type id: str
    :param name: Required. Url-encoded monitor name. Url-encoded monitor name.
    :type name: str
    :param type: Required. Resource type. Type of ARM resource.
    :type type: str
    ...
    def __init__(self, *, id: str, name: str, type: str, monitor_name: str=None, monitor_type: str=None, monitored_object: str=None, parent_monitor_name: str=None, previous_monitor_state=None, current_monitor_state=None, evaluation_timestamp: str=None, current_state_first_observed_timestamp: str=None, last_reported_timestamp: str=None, evidence=None, monitor_configuration=None, **kwargs) -> None:
...
class MonitorStateChange(Model):
    ...
    :param id: Required. Arm ID. Arm ID of this monitor.
    :type id: str
    :param name: Required. Name of resource. Timestamp of state change (in
     unix).
    :type name: str
    :param type: Required. Resource type. Type of ARM resource.
    :type type: str
    ...
    def __init__(self, *, id: str, name: str, type: str, monitor_name: str=None, monitor_type: str=None, monitored_object: str=None, evaluation_timestamp: str=None, current_state_first_observed_timestamp: str=None, previous_monitor_state=None, current_monitor_state=None, evidence=None, monitor_configuration=None, **kwargs) -> None:
