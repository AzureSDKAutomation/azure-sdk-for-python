...
class AutoSuggestClientOperationsMixin(object):
    ...
    def auto_suggest(
        ...
        :type safe_search: str or
         ~azure.bing.search.autosuggest.models.SafeSearch
        ...
        :type response_format: list[str or
         ~azure.bing.search.autosuggest.models.ResponseFormat]
        ...
        :rtype: ~azure.bing.search.autosuggest.models.Suggestions or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.bing.search.autosuggest.models.ErrorResponseException>`
        """
