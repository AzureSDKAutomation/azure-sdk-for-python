...
class AutoSuggestClientOperationsMixin(object):
    ...
    def auto_suggest(
        ...
        :type safe_search: str or ~azure.bing.autosuggest.models.SafeSearch
        ...
        :type response_format: list[str or
         ~azure.bing.autosuggest.models.ResponseFormat]
        ...
        :rtype: ~azure.bing.autosuggest.models.Suggestions or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.bing.autosuggest.models.ErrorResponseException>`
        """
