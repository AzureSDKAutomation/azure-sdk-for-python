...
class SourceControlConfiguration(ProxyResource):
    ...
    def __init__(self, *, repository_url: str=None, operator_namespace: str="default", operator_instance_name: str=None, operator_type=None, operator_params: str=None, operator_scope="cluster", enable_helm_operator: bool=None, helm_operator_properties=None, **kwargs) -> None:
...
class SourceControlConfigurationForCreate(ProxyResource):
    ...
    def __init__(self, *, repository_url: str=None, operator_namespace: str="default", operator_instance_name: str=None, operator_type=None, operator_params: str=None, configuration_protected_settings=None, operator_scope="cluster", enable_helm_operator: bool=None, helm_operator_properties=None, **kwargs) -> None:
