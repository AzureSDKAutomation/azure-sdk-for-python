...
class SessionHostHealthCheckFailureDetails(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.last_health_check_in_utc = kwargs.get('last_health_check_in_utc', None)
...
class SessionHostHealthCheckReport(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.health_check_name = kwargs.get('health_check_name', None)
        self.health_check_result = kwargs.get('health_check_result', None)
        self.additional_failure_details = kwargs.get('additional_failure_details', None)
