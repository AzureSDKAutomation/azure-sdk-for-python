...
class SessionHost(Resource):
    ...
    :ivar session_host_health_check_result: List of
     SessionHostHealthCheckReports
    :vartype session_host_health_check_result:
    ...
    _validation = {
        ...
        'session_host_health_check_result': {'readonly': True},
    }
    ...
    _attribute_map = {
        ...
        'session_host_health_check_result': {'key': 'properties.sessionHostHealthCheckResult', 'type': '[SessionHostHealthCheckReport]'},
    }
    ...
    def __init__(self, *, last_heart_beat=None, sessions: int=None, agent_version: str=None, allow_new_session: bool=None, assigned_user: str=None, status=None, os_version: str=None, sx_sstack_version: str=None, update_state=None, update_error_message: str=None, **kwargs) -> None:
        ...
        self.session_host_health_check_result = None


class SessionHostHealthCheckFailureDetails(Model):
    """Contains details on the failure.

    :param message: Failure message: hints on what is wrong and how to
     recover.
    :type message: str
    :param error_code: Error code corresponding for the failure.
    :type error_code: int
    :param last_health_check_in_utc: The timestamp of the last update.
    :type last_health_check_in_utc: datetime
    """

    _attribute_map = {
        'message': {'key': 'message', 'type': 'str'},
        'error_code': {'key': 'errorCode', 'type': 'int'},
        'last_health_check_in_utc': {'key': 'lastHealthCheckInUTC', 'type': 'iso-8601'},
    }

    def __init__(self, *, message: str=None, error_code: int=None, last_health_check_in_utc=None, **kwargs) -> None:
        super(SessionHostHealthCheckFailureDetails, self).__init__(**kwargs)
        self.message = message
        self.error_code = error_code
        self.last_health_check_in_utc = last_health_check_in_utc


class SessionHostHealthCheckReport(Model):
    """The report for session host information.

    :param health_check_name: Represents the name of the health check
     operation performed.
    :type health_check_name: str
    :param health_check_result: Represents the Health state of the health
     check we performed.
    :type health_check_result: str
    :param additional_failure_details:
    :type additional_failure_details:
    ...
    def __init__(self, *, health_check_name: str=None, health_check_result: str=None, additional_failure_details=None, **kwargs) -> None:
        super(SessionHostHealthCheckReport, self).__init__(**kwargs)
        self.health_check_name = health_check_name
        self.health_check_result = health_check_result
        self.additional_failure_details = additional_failure_details
