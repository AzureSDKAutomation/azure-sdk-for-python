...
class ApplicationGroupsOperations(object):
    ...
    :ivar api_version: The API version to use for this operation. Constant value: "2021-01-14-preview".
    """
    ...
    def __init__(self, client, config, serializer, deserializer):
        ...
        self.api_version = "2021-01-14-preview"
    ...
    def get(
        ...
        :return: ApplicationGroup or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.desktopvirtualization.models.ApplicationGroup or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ApplicationGroup', response)
    ...
    def create_or_update(
            self, resource_group_name, application_group_name, application_group, custom_headers=None, raw=False, **operation_config):
        ...
        :param application_group_name: The name of the application group
        :type application_group_name: str
        :param application_group: Object containing ApplicationGroup
         definitions.
        :type application_group:
         ~azure.mgmt.desktopvirtualization.models.ApplicationGroup
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def update(
            self, resource_group_name, application_group_name, application_group=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param application_group: Object containing ApplicationGroup
         definitions.
        :type application_group:
         ~azure.mgmt.desktopvirtualization.models.ApplicationGroupPatch
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
