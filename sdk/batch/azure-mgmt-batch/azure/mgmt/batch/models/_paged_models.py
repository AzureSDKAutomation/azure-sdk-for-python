...
class SupportedSkuPaged(Paged):
    """
    A paging container for iterating over a list of :class:`SupportedSku <azure.mgmt.batch.models.SupportedSku>` object
    """

    _attribute_map = {
        'next_link': {'key': 'nextLink', 'type': 'str'},
        'current_page': {'key': 'value', 'type': '[SupportedSku]'}
    }

    def __init__(self, *args, **kwargs):

        super(SupportedSkuPaged, self).__init__(*args, **kwargs)
