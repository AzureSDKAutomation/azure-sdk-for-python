...
class MicrosoftDatadogClient(SDKClient):
    ...
    :vartype marketplace_agreements: datadog.operations.MarketplaceAgreementsOperations
    :ivar api_keys: ApiKeys operations
    :vartype api_keys: datadog.operations.ApiKeysOperations
    :ivar hosts: Hosts operations
    :vartype hosts: datadog.operations.HostsOperations
    :ivar linked_resources: LinkedResources operations
    :vartype linked_resources: datadog.operations.LinkedResourcesOperations
    :ivar monitored_resources: MonitoredResources operations
    :vartype monitored_resources: datadog.operations.MonitoredResourcesOperations
    :ivar operations: Operations operations
    :vartype operations: datadog.operations.Operations
    :ivar monitors: Monitors operations
    :vartype monitors: datadog.operations.MonitorsOperations
    :ivar refresh_set_password: RefreshSetPassword operations
    :vartype refresh_set_password: datadog.operations.RefreshSetPasswordOperations
    :ivar tag_rules: TagRules operations
    :vartype tag_rules: datadog.operations.TagRulesOperations
    :ivar single_sign_on_configurations: SingleSignOnConfigurations operations
    :vartype single_sign_on_configurations: datadog.operations.SingleSignOnConfigurationsOperations
