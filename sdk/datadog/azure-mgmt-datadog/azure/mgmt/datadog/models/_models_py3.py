...
class DatadogAgreementResource(Model):
    ...
    :type properties: ~datadog.models.DatadogAgreementProperties
    """
...
class DatadogHost(Model):
    ...
    :type apps: list[str]
    :param meta:
    :type meta: ~datadog.models.DatadogHostMetadata
    """
...
class DatadogHostMetadata(Model):
    ...
    :type install_method: ~datadog.models.DatadogInstallMethod
    :param logs_agent:
    :type logs_agent: ~datadog.models.DatadogLogsAgent
    """
...
class DatadogMonitorResource(Model):
    ...
    :vartype type: str
    :param sku:
    :type sku: ~datadog.models.ResourceSku
    :param properties:
    :type properties: ~datadog.models.MonitorProperties
    :param identity:
    :type identity: ~datadog.models.IdentityProperties
    :param tags:
...
class DatadogMonitorResourceUpdateParameters(Model):
    ...
    :param properties:
    :type properties: ~datadog.models.MonitorUpdateProperties
...
class DatadogSingleSignOnProperties(Model):
    ...
    :param single_sign_on_state: Possible values include: 'Initial', 'Enable',
     'Disable', 'Existing'
    :type single_sign_on_state: str or ~datadog.models.SingleSignOnStates
    :param enterprise_app_id: The Id of the Enterprise App used for Single
     sign-on.
    :type enterprise_app_id: str
    :ivar single_sign_on_url: The login URL specific to this Datadog
     Organization.
    ...
    def __init__(self, *, single_sign_on_state=None, enterprise_app_id: str=None, **kwargs) -> None:
...
class DatadogSingleSignOnResource(Model):
    ...
    :vartype type: str
    :param properties:
    :type properties: ~datadog.models.DatadogSingleSignOnProperties
    """
...
class ErrorResponseBody(Model):
    ...
    :type target: str
    :param details:
    :type details: list[~datadog.models.ErrorResponseBody]
    """
...
class FilteringTag(Model):
    ...
    :type action: str or ~datadog.models.TagAction
    """
...
class IdentityProperties(Model):
    ...
    :type type: str or ~datadog.models.ManagedIdentityTypes
    """
...
class LogRules(Model):
    ...
    :param filtering_tags: List of filtering tags to be used for capturing
     ...
     the associated tags.
    :type filtering_tags: list[~datadog.models.FilteringTag]
    """
...
class MonitoringTagRules(Model):
    ...
    :vartype type: str
    :param properties:
    :type properties: ~datadog.models.MonitoringTagRulesProperties
    """
...
class MonitoringTagRulesProperties(Model):
    ...
    :param log_rules:
    :type log_rules: ~datadog.models.LogRules
    :param metric_rules:
    :type metric_rules: ~datadog.models.MetricRules
    """
...
class OperationResult(Model):
    ...
    :type name: str
    :param display:
    :type display: ~datadog.models.OperationDisplay
...
class ResourceProviderDefaultErrorResponse(Model):
    ...
    :param error:
    :type error: ~datadog.models.ErrorResponseBody
    """
