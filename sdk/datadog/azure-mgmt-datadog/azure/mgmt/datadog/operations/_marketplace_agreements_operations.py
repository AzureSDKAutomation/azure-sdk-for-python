...
class MarketplaceAgreementsOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~datadog.models.DatadogAgreementResourcePaged[~datadog.models.DatadogAgreementResource]
        :raises:
    ...
    def create(
        ...
        :param body:
        :type body: ~datadog.models.DatadogAgreementResource
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~datadog.models.DatadogAgreementResource or
