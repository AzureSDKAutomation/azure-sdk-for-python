...
class TagRulesOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~datadog.models.MonitoringTagRulesPaged[~datadog.models.MonitoringTagRules]
        :raises:
    ...
    def create_or_update(
            self, resource_group_name, monitor_name, rule_set_name, body=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param body:
        :type body: ~datadog.models.MonitoringTagRules
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~datadog.models.MonitoringTagRules or
