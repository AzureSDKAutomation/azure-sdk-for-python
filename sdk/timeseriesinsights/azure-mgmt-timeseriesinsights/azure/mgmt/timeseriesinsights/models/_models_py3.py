...
class Gen1EnvironmentCreationProperties(Model):
    ...
    def __init__(self, *, data_retention_time, storage_limit_exceeded_behavior=None, partition_key_properties=None, **kwargs) -> None:
