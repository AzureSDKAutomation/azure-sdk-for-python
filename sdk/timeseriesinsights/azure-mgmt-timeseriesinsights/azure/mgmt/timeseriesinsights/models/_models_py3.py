...
class EnvironmentUpdateParameters(Model):
    ...
    You probably want to use the sub-classes and not this class directly. Known
    sub-classes are: Gen1EnvironmentUpdateParameters,
...
class EventSourceUpdateParameters(Model):
    ...
    You probably want to use the sub-classes and not this class directly. Known
    sub-classes are: EventHubEventSourceUpdateParameters,
...
class Gen1EnvironmentResource(EnvironmentResource):
    ...
    def __init__(self, *, location: str, sku, data_retention_time, tags=None, storage_limit_exceeded_behavior=None, partition_key_properties=None, status=None, **kwargs) -> None:
...
class Gen2EnvironmentResource(EnvironmentResource):
    ...
    def __init__(self, *, location: str, sku, time_series_id_properties, storage_configuration, tags=None, provisioning_state=None, status=None, warm_store_configuration=None, **kwargs) -> None:
