...
class CheckNameResult(Model):
    ...
    :param reason: Message providing the reason why the given name is invalid.
     Possible values include: 'NameIsAvailable', 'NameConflict', 'InvalidName'
...
class EventGrid(DigitalTwinsEndpointResourceProperties):
    ...
    def __init__(self, *, topic_endpoint: str, access_key1: str, tags=None, access_key2: str=None, **kwargs) -> None:
...
class EventHub(DigitalTwinsEndpointResourceProperties):
    ...
    def __init__(self, *, connection_string_primary_key: str, tags=None, connection_string_secondary_key: str=None, **kwargs) -> None:
...
class ServiceBus(DigitalTwinsEndpointResourceProperties):
    ...
    def __init__(self, *, primary_connection_string: str, tags=None, secondary_connection_string: str=None, **kwargs) -> None:
