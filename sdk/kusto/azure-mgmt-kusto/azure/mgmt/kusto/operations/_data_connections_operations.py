...
class DataConnectionsOperations(object):
    ...
    def _data_connection_validation_async_initial(
            self, resource_group_name, cluster_name, database_name, data_connection_name=None, properties=None, custom_headers=None, raw=False, **operation_config):
        parameters = models.DataConnectionValidation(data_connection_name=data_connection_name, properties=properties)

        # Construct URL
        url = self.data_connection_validation_async.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'clusterName': self._serialize.url("cluster_name", cluster_name, 'str'),
            'databaseName': self._serialize.url("database_name", database_name, 'str'),
    ...
    def data_connection_validation_async(
        ...
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        raw_result = self._data_connection_validation_async_initial(
    ...
    data_connection_validation_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/databases/{databaseName}/dataConnectionValidationAsync'}
