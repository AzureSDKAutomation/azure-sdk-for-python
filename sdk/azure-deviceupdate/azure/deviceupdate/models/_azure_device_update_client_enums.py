...
class DeploymentType(str, Enum):
    ...
    complete = "Complete"  #: A complete deployment including download, install, and apply commands.
    download = "Download"  #: A download-only deployment that does not include any install or apply commands.
    install = "Install"  #: An install-only rollout that does not include any download commands, only install and complete.
