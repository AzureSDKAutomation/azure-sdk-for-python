...
class ApplicationInsightsManagementClient(MultiApiClientMixin, SDKClient):
    ...
    def models(cls, api_version=DEFAULT_API_VERSION):
        """Module depends on the API version:
           ...
           * 2020-06-02-preview: :mod:`v2020_06_02-preview.models<azure.mgmt.applicationinsights.v2020_06_02-preview.models>`
        """
        if api_version == '2015-05-01':
            ...
            from .v2020_06_02-preview import models
            return models
    ...
    def live_token(self):
        """Instance depends on the API version:
           ...
           * 2020-06-02-preview: :class:`LiveTokenOperations<azure.mgmt.applicationinsights.v2020_06_02-preview.operations.LiveTokenOperations>`
        """
        api_version = self._get_api_version('live_token')
        if api_version == '2020-06-02-preview':
            from .v2020_06_02-preview.operations import LiveTokenOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self.config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
    ...
    def operations(self):
        """Instance depends on the API version:
           ...
           * 2020-06-02-preview: :class:`Operations<azure.mgmt.applicationinsights.v2020_06_02-preview.operations.Operations>`
        """
        api_version = self._get_api_version('operations')
        if api_version == '2015-05-01':
            from .v2015_05_01.operations import Operations as OperationClass
        elif api_version == '2020-06-02-preview':
            from .v2020_06_02-preview.operations import Operations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self.config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
