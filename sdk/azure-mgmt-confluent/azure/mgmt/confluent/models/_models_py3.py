...
class AgreementTerms(Resource):
    ...
    _attribute_map = {
        ...
        'accepted': {'key': 'properties.accepted', 'type': 'str'},
    }

    def __init__(self, *, publisher: str=None, product: str=None, plan: str=None, license_text_link: str=None, privacy_policy_link: str=None, retrieve_datetime=None, signature: str=None, accepted: str=None, **kwargs) -> None:
