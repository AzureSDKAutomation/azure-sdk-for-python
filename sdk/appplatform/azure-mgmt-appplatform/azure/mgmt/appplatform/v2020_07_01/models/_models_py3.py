...
class MonitoringSettingProperties(Model):
    ...
    :param monitoring_type: Type of the monitoring. Possible values include:
     'AppInsights'
    :type monitoring_type: str or
     ~azure.mgmt.appplatform.v2020_07_01.models.MonitoringType
    :param app_insights_agent_versions: Indicates the versions of application
     insight agent
    :type app_insights_agent_versions:
     ~azure.mgmt.appplatform.v2020_07_01.models.ApplicationInsightsAgentVersions
    """
    ...
    def __init__(self, *, error=None, trace_enabled: bool=None, app_insights_instrumentation_key: str=None, app_insights_sampling_rate: float=None, monitoring_type=None, app_insights_agent_versions=None, **kwargs) -> None:
