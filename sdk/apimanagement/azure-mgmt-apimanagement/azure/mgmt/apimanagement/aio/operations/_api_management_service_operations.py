...
class ApiManagementServiceOperations:
    ...
    async def check_name_availability(
        ...
        **kwargs
        ...
        _parameters = _models.ApiManagementServiceCheckNameAvailabilityParameters(name=name)
        api_version = "2020-06-01-preview"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def _apply_network_configuration_updates_initial(
        ...
        **kwargs
        ...
        _parameters = _models.ApiManagementServiceApplyNetworkConfigurationParameters(location=location)
        api_version = "2020-06-01-preview"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
