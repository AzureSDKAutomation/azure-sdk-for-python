...
class DependenciesLevel(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
    """Gets or sets a value indicating whether to fetch direct or descendant unresolved dependencies
    """
