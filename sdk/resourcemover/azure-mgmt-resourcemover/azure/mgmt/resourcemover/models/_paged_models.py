...
class UnresolvedDependencyPaged(Paged):
    """
    A paging container for iterating over a list of :class:`UnresolvedDependency <azure.mgmt.resourcemover.models.UnresolvedDependency>` object
    """

    _attribute_map = {
        'next_link': {'key': 'nextLink', 'type': 'str'},
        'current_page': {'key': 'value', 'type': '[UnresolvedDependency]'}
    }

    def __init__(self, *args, **kwargs):

        super(UnresolvedDependencyPaged, self).__init__(*args, **kwargs)
