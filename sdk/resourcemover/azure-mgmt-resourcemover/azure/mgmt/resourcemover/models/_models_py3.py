...
class ResourceSettings(Model):
    ...
    KeyVaultResourceSettings, DiskEncryptionSetResourceSettings
...
class KeyVaultResourceSettings(ResourceSettings):
    ...
    def __init__(self, *, target_resource_name: str, **kwargs) -> None:
        ...
        self.resource_type = 'Microsoft.KeyVault/vaults'
...
class MoveCollection(Model):
    ...
    :param system_data:
    :type system_data: ~azure.mgmt.resourcemover.models.SystemData
    :param properties:
    :type properties:
    ...
    def __init__(self, *, tags=None, location: str=None, identity=None, system_data=None, properties=None, **kwargs) -> None:
...
class MoveCollectionProperties(Model):
    ...
    :vartype errors:
     ~azure.mgmt.resourcemover.models.MoveCollectionPropertiesErrors
    """
...
class MoveResourceProperties(Model):
    ...
    :ivar is_resolve_required: Gets a value indicating whether the resolve
     action is required over the move collection.
...
class NicIpConfigurationResourceSettings(Model):
    ...
    :param load_balancer_nat_rules: Gets or sets the references of the load
     balancer NAT rules.
    :type load_balancer_nat_rules:
     list[~azure.mgmt.resourcemover.models.LoadBalancerNatRuleReference]
    :param public_ip:
    :type public_ip: ~azure.mgmt.resourcemover.models.PublicIpReference
    """
    ...
    def __init__(self, *, name: str=None, private_ip_address: str=None, private_ip_allocation_method: str=None, subnet=None, primary: bool=None, load_balancer_backend_address_pools=None, load_balancer_nat_rules=None, public_ip=None, **kwargs) -> None:
...
class PublicIPAddressResourceSettings(ResourceSettings):
    ...
    def __init__(self, *, target_resource_name: str, domain_name_label: str=None, fqdn: str=None, public_ip_allocation_method: str=None, sku: str=None, zones: str=None, **kwargs) -> None:
...
class RequiredForResourcesCollection(Model):
    """Required for resources collection.

    :param source_ids: Gets or sets the list of source Ids for which the input
    ...
    def __init__(self, *, source_ids=None, **kwargs) -> None:
...
class SubnetResourceSettings(Model):
    ...
    :type network_security_group:
     ~azure.mgmt.resourcemover.models.NsgReference
    """
    ...
    def __init__(self, *, name: str=None, address_prefix: str=None, network_security_group=None, **kwargs) -> None:
...
class SystemData(Model):
    ...
    :type created_by_type: str or
     ~azure.mgmt.resourcemover.models.CreatedByType
...
class UnresolvedDependenciesFilter(Model):
    """Unresolved dependencies contract.

    :param properties:
    :type properties:
     ~azure.mgmt.resourcemover.models.UnresolvedDependenciesFilterProperties
    """
...
class UnresolvedDependenciesFilterProperties(Model):
