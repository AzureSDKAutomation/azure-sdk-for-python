...
class UnresolvedDependenciesRequest(msrest.serialization.Model):
    """Defines the request body for fetching unresolved dependencies.

    :param dependencies_level: Gets or sets a value indicating whether to fetch direct or
     descendant unresolved dependencies. Possible values include: "Direct", "Descendant".
    :type dependencies_level: str or ~resource_mover_service_api.models.DependenciesLevel
    """

    _attribute_map = {
        'dependencies_level': {'key': 'dependenciesLevel', 'type': 'str'},
    }

    def __init__(
        self,
        *,
        dependencies_level: Optional[Union[str, "DependenciesLevel"]] = None,
        **kwargs
    ):
        super(UnresolvedDependenciesRequest, self).__init__(**kwargs)
        self.dependencies_level = dependencies_level
