...
class MoveCollectionsOperations:
    ...
    async def _unresolved_dependencies_initial(
        self,
        resource_group_name: str,
        move_collection_name: str,
        body: Optional["_models.UnresolvedDependenciesRequest"] = None,
        **kwargs
    ) -> Optional["_models.OperationStatus"]:
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.OperationStatus"]]
        error_map = {
        ...
        # Construct URL
        url = self._unresolved_dependencies_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'moveCollectionName': self._serialize.url("move_collection_name", move_collection_name, 'str'),
        ...
        return deserialized
    _unresolved_dependencies_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/moveCollections/{moveCollectionName}/unresolvedDependencies'}  # type: ignore

    async def begin_unresolved_dependencies(
        self,
        resource_group_name: str,
        move_collection_name: str,
        body: Optional["_models.UnresolvedDependenciesRequest"] = None,
        **kwargs
        ...
        :type move_collection_name: str
        :param body:
        :type body: ~resource_mover_service_api.models.UnresolvedDependenciesRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._unresolved_dependencies_initial(
                resource_group_name=resource_group_name,
                move_collection_name=move_collection_name,
                body=body,
                cls=lambda x,y,z: x,
        ...
        if cont_token:
            ...
            return AsyncLROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_unresolved_dependencies.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/moveCollections/{moveCollectionName}/unresolvedDependencies'}  # type: ignore
