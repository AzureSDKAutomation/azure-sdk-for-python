...
class OperationResultsOperations(object):
    ...
    def _get_initial(
            self, operation_result_id, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    def get(
            self, operation_result_id, custom_headers=None, raw=False, polling=True, **operation_config):
        """Get OperationResult.

        Get operationResult.

        :param operation_result_id: OperationResult identifier
    ...
    get.metadata = {'url': '/providers/Microsoft.Capacity/operationResults/{operationResultId}'}
