...
class ChangeDirectoryRequest(Model):
    """ChangeDirectoryRequest.

    :param destination_tenant_id: Tenant id GUID that reservation order is to
     be transferred to
    ...
    def __init__(self, *, destination_tenant_id: str=None, **kwargs) -> None:
        super(ChangeDirectoryRequest, self).__init__(**kwargs)
        self.destination_tenant_id = destination_tenant_id


class ChangeDirectoryResponse(Model):
    """Change directory response.

    :param reservation_order:
    :type reservation_order:
     ~azure.mgmt.reservations.models.ChangeDirectoryResult
    :param reservations:
    :type reservations:
     list[~azure.mgmt.reservations.models.ChangeDirectoryResult]
    """
    ...
    def __init__(self, *, reservation_order=None, reservations=None, **kwargs) -> None:
        super(ChangeDirectoryResponse, self).__init__(**kwargs)
        self.reservation_order = reservation_order
        self.reservations = reservations


class ChangeDirectoryResult(Model):
    ...
    :type name: str
    :param is_succeeded: True if change directory operation succeeded on this
    ...
    def __init__(self, *, id: str=None, name: str=None, is_succeeded: bool=None, error: str=None, **kwargs) -> None:
