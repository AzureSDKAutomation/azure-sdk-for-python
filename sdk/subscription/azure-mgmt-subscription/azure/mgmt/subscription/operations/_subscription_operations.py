...
class SubscriptionOperations(object):
    ...
    def _put_subscription_initial(
            self, subscription_id, properties=None, custom_headers=None, raw=False, **operation_config):
        body = models.PutSubscriptionRequest(properties=properties)

        # Construct URL
        url = self.put_subscription.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str')
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        # Construct body
        body_content = self._serialize.body(body, 'PutSubscriptionRequest')
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('PutSubscriptionResponse', response)
            header_dict = {
                'Location': 'str',
                'Retry-After': 'int',
            }
    ...
    def put_subscription(
        ...
        """The operation to create a new subscription or update the display name
        ...
        :param polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of LROPoller that returns PutSubscriptionResponse
         or ClientRawResponse<PutSubscriptionResponse> if raw==True
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.subscription.models.PutSubscriptionResponse]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.subscription.models.PutSubscriptionResponse]]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.subscription.models.ErrorResponseException>`
        """
        raw_result = self._put_subscription_initial(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    put_subscription.metadata = {'url': '/providers/Microsoft.Subscription/subscriptions/{subscriptionId}'}
    ...
    def get_subscription(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: PutSubscriptionResponse or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.subscription.models.PutSubscriptionResponse or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.mgmt.subscription.models.ErrorResponseException>`
        """
        ...
        return deserialized
    get_subscription.metadata = {'url': '/providers/Microsoft.Subscription/subscriptions/{subscriptionId}'}
