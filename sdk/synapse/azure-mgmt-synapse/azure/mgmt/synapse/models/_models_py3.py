...
class SqlPool(TrackedResource):
    ...
    :type creation_date: datetime
    :param storage_account_type: The storage account type used to store data
     and backups for this sql pool. The supported options are GRS
     (Geo-Redundant Storage) and LRS (Locally Redundant Storage). Possible
     values include: 'GRS', 'LRS'
