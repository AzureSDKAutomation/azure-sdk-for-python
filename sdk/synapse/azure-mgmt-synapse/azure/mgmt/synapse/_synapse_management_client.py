...
class SynapseManagementClient(SDKClient):
    ...
    :vartype maintenance_windows: azure.mgmt.synapse.operations.MaintenanceWindowsOperations
    :ivar maintenance_window_options: MaintenanceWindowOptions operations
    :vartype maintenance_window_options: azure.mgmt.synapse.operations.MaintenanceWindowOptionsOperations
