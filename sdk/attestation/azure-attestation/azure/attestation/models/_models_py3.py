...
class AttestationPolicyRequest(Model):
    """AttestationPolicyRequest.

    :param attestation_policy: Base64Url encoded policy text to set.
    ...
    def __init__(self, *, attestation_policy: str=None, **kwargs) -> None:
        super(AttestationPolicyRequest, self).__init__(**kwargs)
