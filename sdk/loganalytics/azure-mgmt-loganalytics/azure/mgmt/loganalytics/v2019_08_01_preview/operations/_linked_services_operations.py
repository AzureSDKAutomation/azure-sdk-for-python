...
class LinkedServicesOperations(object):
    ...
    def create_or_update(
            self, resource_group_name, workspace_name, linked_service_name, resource_id=None, write_access_resource_id=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param resource_id: The resource id of the resource that will be
         linked to the workspace. This should be used for linking resources
         which require read access
        :type resource_id: str
        :param write_access_resource_id: The resource id of the resource that
         will be linked to the workspace. This should be used for linking
         resources which require write access
        ...
        :rtype:
         ~azure.mgmt.loganalytics.v2019_08_01_preview.models.LinkedService or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        parameters = models.LinkedService(resource_id=resource_id, write_access_resource_id=write_access_resource_id)
    ...
    def list_by_workspace(
        ...
        :rtype:
         ~azure.mgmt.loganalytics.v2019_08_01_preview.models.LinkedServicePaged[~azure.mgmt.loganalytics.v2019_08_01_preview.models.LinkedService]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
