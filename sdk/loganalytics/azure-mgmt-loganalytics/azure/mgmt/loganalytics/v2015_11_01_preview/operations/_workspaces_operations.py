...
class WorkspacesOperations(object):
    ...
    def list_intelligence_packs(
        ...
        :rtype:
         list[~azure.mgmt.loganalytics.v2015_11_01_preview.models.IntelligencePack]
    ...
    def get_shared_keys(
        ...
        :rtype: ~azure.mgmt.loganalytics.v2015_11_01_preview.models.SharedKeys
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def list_usages(
        ...
        :rtype:
         ~azure.mgmt.loganalytics.v2015_11_01_preview.models.UsageMetricPaged[~azure.mgmt.loganalytics.v2015_11_01_preview.models.UsageMetric]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_management_groups(
        ...
        :rtype:
         ~azure.mgmt.loganalytics.v2015_11_01_preview.models.ManagementGroupPaged[~azure.mgmt.loganalytics.v2015_11_01_preview.models.ManagementGroup]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.mgmt.loganalytics.v2015_11_01_preview.models.WorkspacePaged[~azure.mgmt.loganalytics.v2015_11_01_preview.models.Workspace]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
    ...
    def create_or_update(
        ...
        :param parameters: The parameters required to create or update a
         workspace.
        :type parameters:
         ~azure.mgmt.loganalytics.v2015_11_01_preview.models.Workspace
        :param dict custom_headers: headers that will be added to the request
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.loganalytics.v2015_11_01_preview.models.Workspace]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.loganalytics.v2015_11_01_preview.models.Workspace]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.loganalytics.v2015_11_01_preview.models.Workspace
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
