...
class JobsOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.dataprotection.models.AzureBackupJobResourcePaged[~azure.mgmt.dataprotection.models.AzureBackupJobResource]
        ...
        if raw:
            header_dict = {}
        deserialized = models.AzureBackupJobResourcePaged(internal_paging, self._deserialize.dependencies, header_dict)
