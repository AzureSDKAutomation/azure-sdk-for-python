...
class RecoveryPointsOperations(object):
    ...
    :ivar api_version: Client Api Version. Constant value: "2020-01-01-alpha".
    """
    ...
    def get_list(
        ...
        :rtype:
         ~azure.mgmt.dataprotection.models.AzureBackupRecoveryPointResourcePaged[~azure.mgmt.dataprotection.models.AzureBackupRecoveryPointResource]
        ...
        if raw:
            header_dict = {}
        deserialized = models.AzureBackupRecoveryPointResourcePaged(internal_paging, self._deserialize.dependencies, header_dict)

        return deserialized
    get_list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/backupVaults/{vaultName}/backupInstances/{backupInstanceName}/recoveryPoints'}
