...
from .operations import ResourceOperationGatekeepersOperations
from . import models
...
class DataProtectionClient(DataProtectionClientOperationsMixin, SDKClient):
    ...
    :ivar resource_operation_gatekeepers: ResourceOperationGatekeepers operations
    :vartype resource_operation_gatekeepers: azure.mgmt.dataprotection.operations.ResourceOperationGatekeepersOperations
    ...
    def __init__(
        ...
        self.export_jobs_operation_result = ExportJobsOperationResultOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.resource_operation_gatekeepers = ResourceOperationGatekeepersOperations(
            self._client, self.config, self._serialize, self._deserialize)
