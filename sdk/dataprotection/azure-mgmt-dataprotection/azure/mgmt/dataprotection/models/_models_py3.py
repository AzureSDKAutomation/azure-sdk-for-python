...
class AzureBackupJob(Model):
    ...
    :ivar duration: Total run time of the job.
    :vartype duration: timedelta
    :ivar end_time: EndTime of the job(in UTC)
    :vartype end_time: datetime
    :ivar error_details: A List, detatiling the errors related to the job
    ...
    :param source_resource_group: Required. Name of the Datasource's Resource
     Group
...
class BackupPolicy(BaseBackupPolicy):
    ...
    :param policy_rules: Required. Policy rule dictionary that contains rules
     for each backptype i.e Full/Incremental/Logs etc
...
class DppTrackedResource(Model):
    ...
    def __init__(self, *, e_tag: str=None, identity=None, location: str=None, tags=None, **kwargs) -> None:
...
class BackupVaultResource(DppTrackedResource):
    ...
    def __init__(self, *, e_tag: str=None, identity=None, location: str=None, tags=None, storage_settings=None, **kwargs) -> None:
...
class DataStoreInfoBase(Model):
    ...
    :param data_store_type: Required. type of datastore; SnapShot/Hot/Archive.
...
class DppIdentityDetails(Model):
    ...
    :ivar identity_url: Identity Url
...
class InnerError(Model):
    ...
    :param additional_info: Any Key value pairs that can be provided to the
     cleint for additional  verbose information.
...
class JobExtendedInfo(Model):
    ...
    :ivar data_transfered_in_bytes: Number of bytes transfered
    :vartype data_transfered_in_bytes: float
    ...
    _validation = {
        ...
        'data_transfered_in_bytes': {'readonly': True},
    ...
    _attribute_map = {
        ...
        'data_transfered_in_bytes': {'key': 'dataTransferedInBytes', 'type': 'float'},
    ...
    def __init__(self, *, additional_details=None, **kwargs) -> None:
        ...
        self.data_transfered_in_bytes = None
...
class JobSubTask(Model):
    ...
    :param additional_details: Sub Tasks's additional details
    :type additional_details: dict[str, str]
...
class PolicyInfo(Model):
    ...
    def __init__(self, *, policy_id: str, **kwargs) -> None:
...
class ResourceOperationGateKeeperResource(DppTrackedResource):
    ...
    :vartype provisioning_state: str or
     ~azure.mgmt.dataprotection.models.ProvisioningState
    :ivar operations: {readonly} List of operations that can be protected by
     the ResourceOperationGateKeeper
    :vartype operations: list[str]
    :ivar last_lock_update_time: LastTime ResourceOperationGateKeeper is
     updated
    :vartype last_lock_update_time: datetime
    """
    ...
    _validation = {
        ...
        'last_lock_update_time': {'readonly': True},
    }
    ...
    _attribute_map = {
        ...
        'type': {'key': 'type', 'type': 'str'},
        'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'},
        'operations': {'key': 'properties.operations', 'type': '[str]'},
        'last_lock_update_time': {'key': 'properties.lastLockUpdateTime', 'type': 'iso-8601'},
    }

    def __init__(self, *, e_tag: str=None, identity=None, location: str=None, tags=None, **kwargs) -> None:
        super(ResourceOperationGateKeeperResource, self).__init__(e_tag=e_tag, identity=identity, location=location, tags=tags, **kwargs)
        self.provisioning_state = None
        self.operations = None
        self.last_lock_update_time = None
...
class ScheduleBasedBackupCriteria(BackupCriteria):
    ...
    :param weeks_of_the_month: It should be Fisrt/Second/Third/Fourth/Last
...
class UserFacingError(Model):
    ...
    :param message:
    :type message: str
    :param recommended_action: RecommendedAction � Localised.
