...
class Operations(object):
    ...
    def list(
        ...
        :return: OperationResultList or ClientRawResponse if raw=true
        :rtype: ~migrate.models.OperationResultList or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('OperationResultList', response)
