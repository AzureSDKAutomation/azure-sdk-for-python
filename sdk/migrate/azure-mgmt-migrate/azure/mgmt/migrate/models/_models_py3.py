...
class AssessedNetworkAdapter(Model):
    ...
    def __init__(self, *, net_gigabytes_transmitted_per_month: float=None, **kwargs) -> None:
...
class Assessment(Model):
    ...
    def __init__(self, *, azure_location, azure_offer_code, azure_pricing_tier, azure_storage_redundancy, scaling_factor: float, percentile, time_range, stage, currency, azure_hybrid_use_benefit, discount_percentage: float, sizing_criterion, e_tag: str=None, **kwargs) -> None:
...
class Group(Model):
    ...
    def __init__(self, *, machines, e_tag: str=None, **kwargs) -> None:
...
class Project(Model):
    ...
    def __init__(self, *, e_tag: str=None, location: str=None, tags=None, customer_workspace_id: str=None, customer_workspace_location: str=None, provisioning_state=None, **kwargs) -> None:
