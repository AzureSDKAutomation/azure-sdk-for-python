...
class HybridCertificate(ProxyResource):
    """Hybrid certificate imported from box to enable connection between box and
    ...
    def __init__(self, **kwargs):
        super(HybridCertificate, self).__init__(**kwargs)
