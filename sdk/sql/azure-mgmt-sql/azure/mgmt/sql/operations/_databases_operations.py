...
class DatabasesOperations(object):
    ...
    def _export_initial(
        ...
        # Construct body
        body_content = self._serialize.body(parameters, 'ImportExportDatabaseDefinition')
    ...
    def export(
        ...
        :type parameters:
         ~azure.mgmt.sql.models.ImportExportDatabaseDefinition
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
    ...
    def create_import_operation(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    create_import_operation.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/import'}
