...
class AccountsOperations(object):
    ...
    def update(
            self, resource_group_name, account_name, properties=None, tags=None, custom_headers=None, raw=False, **operation_config):
        ...
        :raises:
         :class:`ErrorResponseModelException<azure.mgmt.purview.models.ErrorResponseModelException>`
        """
        account_update_parameters = models.AccountUpdateParameters(properties=properties, tags=tags)
