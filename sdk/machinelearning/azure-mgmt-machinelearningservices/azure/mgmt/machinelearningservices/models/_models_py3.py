...
class AmlComputeProperties(Model):
    ...
    def __init__(self, *, os_type="Linux", vm_size: str=None, vm_priority=None, scale_settings=None, user_account_credentials=None, subnet=None, remote_login_port_public_access="NotSpecified", **kwargs) -> None:
...
class Identity(Model):
    ...
    :param type: Required. The identity type. Possible values include:
     'SystemAssigned', 'SystemAssigned,UserAssigned', 'UserAssigned', 'None'
    :type type: str or
