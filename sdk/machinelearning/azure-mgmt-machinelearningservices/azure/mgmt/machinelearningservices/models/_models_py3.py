...
class JobBaseInteractionEndpoints(Model):
    ...
    :type local: object
    :param local_request:
    :type local_request: object
    """

    _attribute_map = {
        'tracking': {'key': 'Tracking', 'type': 'object'},
        'studio': {'key': 'Studio', 'type': 'object'},
        'grafana': {'key': 'Grafana', 'type': 'object'},
        'tensorboard': {'key': 'Tensorboard', 'type': 'object'},
        'local': {'key': 'Local', 'type': 'object'},
        'local_request': {'key': 'LocalRequest', 'type': 'object'},
    }

    def __init__(self, *, tracking=None, studio=None, grafana=None, tensorboard=None, local=None, local_request=None, **kwargs) -> None:
...
class SweepJob(ComputeJobBase):
    ...
    :type trial_component:
     ~azure.mgmt.machinelearningservices.models.TrialComponent
    """
    ...
    def __init__(self, *, compute_binding, parameter_sampling_configuration, evaluation_configuration, description: str=None, tags=None, properties=None, experiment_name: str=None, output=None, status=None, termination_configuration=None, trial_component=None, **kwargs) -> None:
