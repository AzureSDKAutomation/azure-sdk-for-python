...
class AmlComputeProperties(Model):
    ...
    def __init__(self, *, os_type=None, vm_size: str=None, vm_priority=None, virtual_machine_image=None, isolated_network: bool=None, scale_settings=None, user_account_credentials=None, subnet=None, remote_login_port_public_access="NotSpecified", **kwargs) -> None:
