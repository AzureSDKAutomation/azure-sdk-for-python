...
class BatchDeploymentTrackedResourcePaged(Paged):
    """
    A paging container for iterating over a list of :class:`BatchDeploymentTrackedResource <azure.mgmt.machinelearningservices.models.BatchDeploymentTrackedResource>` object
    """

    _attribute_map = {
        'next_link': {'key': 'nextLink', 'type': 'str'},
        'current_page': {'key': 'value', 'type': '[BatchDeploymentTrackedResource]'}
    }

    def __init__(self, *args, **kwargs):

        super(BatchDeploymentTrackedResourcePaged, self).__init__(*args, **kwargs)
class BatchEndpointTrackedResourcePaged(Paged):
    """
    A paging container for iterating over a list of :class:`BatchEndpointTrackedResource <azure.mgmt.machinelearningservices.models.BatchEndpointTrackedResource>` object
    """

    _attribute_map = {
        'next_link': {'key': 'nextLink', 'type': 'str'},
        'current_page': {'key': 'value', 'type': '[BatchEndpointTrackedResource]'}
    }

    def __init__(self, *args, **kwargs):

        super(BatchEndpointTrackedResourcePaged, self).__init__(*args, **kwargs)
...
class OnlineDeploymentPropertiesTrackedResourcePaged(Paged):
    """
    A paging container for iterating over a list of :class:`OnlineDeploymentPropertiesTrackedResource <azure.mgmt.machinelearningservices.models.OnlineDeploymentPropertiesTrackedResource>` object
    """

    _attribute_map = {
        'next_link': {'key': 'nextLink', 'type': 'str'},
        'current_page': {'key': 'value', 'type': '[OnlineDeploymentPropertiesTrackedResource]'}
    }

    def __init__(self, *args, **kwargs):

        super(OnlineDeploymentPropertiesTrackedResourcePaged, self).__init__(*args, **kwargs)
class OnlineEndpointPropertiesTrackedResourcePaged(Paged):
    """
    A paging container for iterating over a list of :class:`OnlineEndpointPropertiesTrackedResource <azure.mgmt.machinelearningservices.models.OnlineEndpointPropertiesTrackedResource>` object
    """

    _attribute_map = {
        'next_link': {'key': 'nextLink', 'type': 'str'},
        'current_page': {'key': 'value', 'type': '[OnlineEndpointPropertiesTrackedResource]'}
    }

    def __init__(self, *args, **kwargs):

        super(OnlineEndpointPropertiesTrackedResourcePaged, self).__init__(*args, **kwargs)
