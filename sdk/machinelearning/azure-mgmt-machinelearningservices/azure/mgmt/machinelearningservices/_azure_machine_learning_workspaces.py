...
class AzureMachineLearningWorkspaces(AzureMachineLearningWorkspacesOperationsMixin, SDKClient):
    ...
    :ivar batch_deployments: BatchDeployments operations
    :vartype batch_deployments: azure.mgmt.machinelearningservices.operations.BatchDeploymentsOperations
    :ivar batch_endpoints: BatchEndpoints operations
    :vartype batch_endpoints: azure.mgmt.machinelearningservices.operations.BatchEndpointsOperations
    ...
    :ivar online_deployments: OnlineDeployments operations
    :vartype online_deployments: azure.mgmt.machinelearningservices.operations.OnlineDeploymentsOperations
    :ivar online_endpoints: OnlineEndpoints operations
