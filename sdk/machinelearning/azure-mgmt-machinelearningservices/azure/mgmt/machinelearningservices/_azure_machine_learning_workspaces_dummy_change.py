...
from .operations import AzureMachineLearningWorkspacesDummyChangeOperationsMixin
...
class AzureMachineLearningWorkspacesDummyChange(AzureMachineLearningWorkspacesDummyChangeOperationsMixin, SDKClient):
    """These APIs allow end users to operate on Azure Machine Learning Workspace resources.

    :ivar config: Configuration for client.
    :vartype config: AzureMachineLearningWorkspacesDummyChangeConfiguration
    ...
    def __init__(
        ...
        self.config = AzureMachineLearningWorkspacesDummyChangeConfiguration(credentials, subscription_id, base_url)
        super(AzureMachineLearningWorkspacesDummyChange, self).__init__(self.config.credentials, self.config)
