...
from .operations import IntegrationAccountUsageConfigurationsOperations
...
class LogicManagementClient(SDKClient):
    ...
    :ivar integration_account_usage_configurations: IntegrationAccountUsageConfigurations operations
    :vartype integration_account_usage_configurations: azure.mgmt.logic.operations.IntegrationAccountUsageConfigurationsOperations
    ...
    def __init__(
        ...
        self.integration_account_sessions = IntegrationAccountSessionsOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.integration_account_usage_configurations = IntegrationAccountUsageConfigurationsOperations(
            self._client, self.config, self._serialize, self._deserialize)
