...
class IntegrationAccountUsageConfiguration(Resource):
    ...
    def __init__(self, **kwargs):
        super(IntegrationAccountUsageConfiguration, self).__init__(**kwargs)
        self.disable_override = kwargs.get('disable_override', None)
        self.throttles = kwargs.get('throttles', None)
        self.created_time = None
        self.changed_time = None
        self.metadata = kwargs.get('metadata', None)
...
class UsageConfigurationThrottle(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.trigger_statuses = kwargs.get('trigger_statuses', None)
        self.action_statuses = kwargs.get('action_statuses', None)
