...
class IntegrationAccountUsageConfiguration(Resource):
    ...
    :param tags: The resource tags.
    :type tags: dict[str, str]
    :param disable_override: Whether to disable runtime override of the usage
     configuration.
    :type disable_override: bool
    :param throttles: The usage configuration throttles.
    :type throttles: dict[str,
     ~azure.mgmt.logic.models.UsageConfigurationThrottle]
    :ivar created_time: The created time.
    :vartype created_time: datetime
    :ivar changed_time: The changed time.
    :vartype changed_time: datetime
    ...
    _attribute_map = {
        ...
        'location': {'key': 'location', 'type': 'str'},
        'tags': {'key': 'tags', 'type': '{str}'},
        'disable_override': {'key': 'properties.disableOverride', 'type': 'bool'},
        'throttles': {'key': 'properties.throttles', 'type': '{UsageConfigurationThrottle}'},
        'created_time': {'key': 'properties.createdTime', 'type': 'iso-8601'},
        'changed_time': {'key': 'properties.changedTime', 'type': 'iso-8601'},
        'metadata': {'key': 'properties.metadata', 'type': 'object'},
    }

    def __init__(self, *, location: str=None, tags=None, disable_override: bool=None, throttles=None, metadata=None, **kwargs) -> None:
        super(IntegrationAccountUsageConfiguration, self).__init__(location=location, tags=tags, **kwargs)
        self.disable_override = disable_override
...
class UsageConfigurationThrottle(Model):
    """The usage configuration throttle.

    :param threshold: The number of operations to throttle at.
    :type threshold: float
    :param period: The usage configuration throttle period
    :type period: ~azure.mgmt.logic.models.UsageConfigurationThrottlePeriod
    :param trigger_statuses: The trigger statuses to throttle
    :type trigger_statuses: list[str or
     ~azure.mgmt.logic.models.WorkflowStatus]
    :param action_statuses: The action statuses to throttle
    :type action_statuses: list[str or
     ~azure.mgmt.logic.models.WorkflowStatus]
    """

    _attribute_map = {
        'threshold': {'key': 'threshold', 'type': 'float'},
        'period': {'key': 'period', 'type': 'UsageConfigurationThrottlePeriod'},
        'trigger_statuses': {'key': 'triggerStatuses', 'type': '[str]'},
        'action_statuses': {'key': 'actionStatuses', 'type': '[str]'},
    }

    def __init__(self, *, threshold: float=None, period=None, trigger_statuses=None, action_statuses=None, **kwargs) -> None:
        super(UsageConfigurationThrottle, self).__init__(**kwargs)
        self.threshold = threshold
        self.period = period
        self.trigger_statuses = trigger_statuses
        self.action_statuses = action_statuses


class UsageConfigurationThrottlePeriod(Model):
    """The usage configuration throttle period.

    :param interval: The throttle period interval.
    :type interval: float
    :param frequency: The throttle frequency. Possible values include:
     'NotSpecified', 'Second', 'Minute', 'Hour', 'Day', 'Week', 'Month', 'Year'
    :type frequency: str or ~azure.mgmt.logic.models.RecurrenceFrequency
    """

    _attribute_map = {
        'interval': {'key': 'interval', 'type': 'float'},
        'frequency': {'key': 'frequency', 'type': 'str'},
    }

    def __init__(self, *, interval: float=None, frequency=None, **kwargs) -> None:
        super(UsageConfigurationThrottlePeriod, self).__init__(**kwargs)
