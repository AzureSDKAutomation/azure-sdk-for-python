...
class DetectRequest(Model):
    ...
    def __init__(self, *, series, granularity=None, custom_interval: int=None, period: int=None, max_anomaly_ratio: float=None, sensitivity: int=None, impute_strategy=None, **kwargs) -> None:
...
class ImputeStrategy(Model):
    ...
    def __init__(self, *, impute_mode, impute_value: float=None, **kwargs) -> None:
