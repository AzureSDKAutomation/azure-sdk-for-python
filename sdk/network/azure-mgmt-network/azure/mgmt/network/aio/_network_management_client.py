...
class NetworkManagementClient(NetworkManagementClientOperationsMixin, MultiApiClientMixin, _SDKClient):
    ...
    def express_route_port_authorizations(self):
        """Instance depends on the API version:
           ...
           * 2020-07-01: :class:`ExpressRoutePortAuthorizationsOperations<azure.mgmt.network.v2020_07_01.aio.operations.ExpressRoutePortAuthorizationsOperations>`
        """
        api_version = self._get_api_version('express_route_port_authorizations')
        if api_version == '2020-07-01':
            from ..v2020_07_01.aio.operations import ExpressRoutePortAuthorizationsOperations as OperationClass
        else:
    ...
    @property
    def service_tags_detail(self):
        """Instance depends on the API version:

           * 2020-07-01: :class:`ServiceTagsDetailOperations<azure.mgmt.network.v2020_07_01.aio.operations.ServiceTagsDetailOperations>`
        """
        api_version = self._get_api_version('service_tags_detail')
        if api_version == '2020-07-01':
            from ..v2020_07_01.aio.operations import ServiceTagsDetailOperations as OperationClass
        else:
            raise ValueError("API version {} does not have operation group 'service_tags_detail'".format(api_version))
        return OperationClass(self._client, self._config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
