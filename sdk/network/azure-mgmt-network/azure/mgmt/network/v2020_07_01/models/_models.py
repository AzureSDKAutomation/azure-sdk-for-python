...
class ServiceTagsDetail(msrest.serialization.Model):
    ...
    :vartype cloud: str
    :ivar tagname: The name of service tag.
    :vartype tagname: str
    :ivar tagid: The ID of service tag.
    :vartype tagid: str
    :ivar properties: Properties of the service tag information.
    :vartype properties:
     ~azure.mgmt.network.v2020_07_01.models.ServiceTagInformationPropertiesFormat
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ServiceTagsDetail, self).__init__(**kwargs)
        self.name = None
        self.id = None
        self.type = None
        self.change_number = None
...
class ServiceTagsDetailResult(msrest.serialization.Model):
    """Response for the ListServiceTags Paginated API service call.

    :param value: A list of ServiceTags detail in pages.
    :type value: list[~azure.mgmt.network.v2020_07_01.models.ServiceTagsDetail]
    :param next_link: The URL to get the next set of results.
    :type next_link: str
    """

    _attribute_map = {
        'value': {'key': 'value', 'type': '[ServiceTagsDetail]'},
        'next_link': {'key': 'nextLink', 'type': 'str'},
    }
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ServiceTagsDetailResult, self).__init__(**kwargs)
        self.value = kwargs.get('value', None)
        self.next_link = kwargs.get('next_link', None)
...
class VirtualNetworkGatewayConnection(Resource):
    ...
    :param connection_mode: The connection mode for this connection.
...
class VirtualNetworkPeering(SubResource):
    ...
    :type remote_virtual_network_address_space: ~azure.mgmt.network.v2020_07_01.models.AddressSpace
    ...
    :param peering_sync_level: The peering sync status of the virtual network peering. Possible
     values include: "FullySynced", "RemoteUnsynced", "LocalUnsynced", "LocalAndRemoteUnsynced".
    :type peering_sync_level: str or
     ~azure.mgmt.network.v2020_07_01.models.VirtualNetworkPeeringLevel
    :param sync_remote_address_space: Provided when user wants to sync the peering with address
     space on the remote virtual network after the address space is updated.
