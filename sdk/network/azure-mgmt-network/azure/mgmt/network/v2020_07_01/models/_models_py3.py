...
class VirtualNetworkGateway(Resource):
    ...
    :ivar extended_location: The extended location of type local virtual
     network gateway.
    ...
    _validation = {
        ...
        'extended_location': {'readonly': True},
        'etag': {'readonly': True},
    }
    ...
    def __init__(self, *, id: str=None, location: str=None, tags=None, ip_configurations=None, gateway_type=None, vpn_type=None, vpn_gateway_generation=None, enable_bgp: bool=None, enable_private_ip_address: bool=None, active_active: bool=None, gateway_default_site=None, sku=None, vpn_client_configuration=None, bgp_settings=None, custom_routes=None, enable_dns_forwarding: bool=None, virtual_network_extended_location_resource_id: str=None, **kwargs) -> None:
