...
from .operations import ServiceTagsDetailOperations
...
class NetworkManagementClient(NetworkManagementClientOperationsMixin):
    ...
    :vartype express_route_port_authorizations: azure.mgmt.network.v2020_07_01.aio.operations.ExpressRoutePortAuthorizationsOperations
    ...
    :ivar service_tags_detail: ServiceTagsDetailOperations operations
    :vartype service_tags_detail: azure.mgmt.network.v2020_07_01.aio.operations.ServiceTagsDetailOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.service_tags = ServiceTagsOperations(
            self._client, self._config, self._serialize, self._deserialize)
        self.service_tags_detail = ServiceTagsDetailOperations(
            self._client, self._config, self._serialize, self._deserialize)
