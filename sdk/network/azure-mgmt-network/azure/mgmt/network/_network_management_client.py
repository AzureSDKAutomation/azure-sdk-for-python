...
class NetworkManagementClient(NetworkManagementClientOperationsMixin, MultiApiClientMixin, _SDKClient):
    ...
    def service_tags_detail(self):
        """Instance depends on the API version:
           ...
           * 2020-07-01: :class:`ServiceTagsDetailOperations<azure.mgmt.network.v2020_07_01.operations.ServiceTagsDetailOperations>`
        """
        api_version = self._get_api_version('service_tags_detail')
        if api_version == '2020-07-01':
            from .v2020_07_01.operations import ServiceTagsDetailOperations as OperationClass
        else:
