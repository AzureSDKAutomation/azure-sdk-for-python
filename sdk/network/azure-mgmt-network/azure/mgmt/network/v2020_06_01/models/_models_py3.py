...
class ExpressRouteConnection(SubResource):
    ...
    :param bypass_express_route_gateway: Enable FastPath to vWan Firewall hub.
    :type bypass_express_route_gateway: bool
    ...
    _attribute_map = {
        ...
        'bypass_express_route_gateway': {'key': 'properties.bypassExpressRouteGateway', 'type': 'bool'},
        'routing_configuration': {'key': 'properties.routingConfiguration', 'type': 'RoutingConfiguration'},
        'name': {'key': 'name', 'type': 'str'},
    }

    def __init__(self, *, express_route_circuit_peering, name: str, id: str=None, authorization_key: str=None, routing_weight: int=None, enable_internet_security: bool=None, bypass_express_route_gateway: bool=None, routing_configuration=None, **kwargs) -> None:
        ...
        self.bypass_express_route_gateway = bypass_express_route_gateway
