...
class ApplicationGateway(Resource):
    ...
    :type trusted_client_certificates:
     list[~azure.mgmt.network.v2020_05_01.models.ApplicationGatewayTrustedClientCertificate]
    ...
    :param ssl_profiles: SSL profiles of the application gateway resource. For
     ...
     limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
    :type ssl_profiles:
     list[~azure.mgmt.network.v2020_05_01.models.ApplicationGatewaySslProfile]
...
class ApplicationGatewayHttpListener(SubResource):
    ...
    :type ssl_profile: ~azure.mgmt.network.v2020_05_01.models.SubResource
...
class ApplicationGatewaySslProfile(SubResource):
    ...
    :type client_auth_configuration:
     ~azure.mgmt.network.v2020_05_01.models.ApplicationGatewayClientAuthConfiguration
    :ivar provisioning_state: The provisioning state of the HTTP listener
     resource. Possible values include: 'Succeeded', 'Updating', 'Deleting',
     'Failed'
    :vartype provisioning_state: str or
...
class ConnectionMonitorEndpoint(Model):
    ...
    :param type: The endpoint type. Possible values include: 'AzureVM',
     ...
     'MMAWorkspaceNetwork'
    :type type: str or ~azure.mgmt.network.v2020_05_01.models.EndpointType
    ...
    :type scope:
     ~azure.mgmt.network.v2020_05_01.models.ConnectionMonitorEndpointScope
    ...
    :type coverage_level: str or
     ~azure.mgmt.network.v2020_05_01.models.CoverageLevel
    """
...
class ConnectionMonitorEndpointScope(Model):
    ...
    :param include: List of items which needs to be included to the endpoint
     scope.
    :type include:
     list[~azure.mgmt.network.v2020_05_01.models.ConnectionMonitorEndpointScopeItem]
...
class ConnectionMonitorTcpConfiguration(Model):
    ...
    :type destination_port_behavior: str or
     ~azure.mgmt.network.v2020_05_01.models.DestinationPortBehavior
    """
...
class CustomIpPrefix(Resource):
    ...
    :type commissioned_state: str or
     ~azure.mgmt.network.v2020_05_01.models.CommissionedState
...
class DscpConfiguration(Resource):
    ...
    :type source_ip_ranges:
     list[~azure.mgmt.network.v2020_05_01.models.QosIpRange]
    ...
    :type source_port_ranges:
     list[~azure.mgmt.network.v2020_05_01.models.QosPortRange]
    ...
    :type protocol: str or ~azure.mgmt.network.v2020_05_01.models.ProtocolType
...
class ExpressRouteLinkMacSecConfig(Model):
    ...
    :type sci_state: str or
     ~azure.mgmt.network.v2020_05_01.models.ExpressRouteLinkMacSecSciState
    """
...
class O365PolicyProperties(Model):
    ...
    :type break_out_categories:
     ~azure.mgmt.network.v2020_05_01.models.O365BreakOutCategoryPolicies
    """
...
class PublicIPPrefix(Resource):
    ...
    :param custom_ip_prefix: The customIpPrefix that this prefix is associated
     with.
    :type custom_ip_prefix: ~azure.mgmt.network.v2020_05_01.models.SubResource
...
class VpnGateway(Resource):
    ...
    :vartype ip_configurations:
     list[~azure.mgmt.network.v2020_05_01.models.VpnGatewayIpConfiguration]
    :ivar etag: A unique read-only string that changes whenever the resource
     is updated.
    :vartype etag: str
    """
...
class VpnSite(Resource):
    ...
    :type o365_policy:
     ~azure.mgmt.network.v2020_05_01.models.O365PolicyProperties
    :ivar etag: A unique read-only string that changes whenever the resource
     is updated.
    :vartype etag: str
    """
