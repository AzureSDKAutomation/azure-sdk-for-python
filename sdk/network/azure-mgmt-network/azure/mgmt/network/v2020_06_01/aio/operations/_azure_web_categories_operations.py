...
class AzureWebCategoriesOperations:
    """AzureWebCategoriesOperations async operations.
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2020_06_01.models.AzureWebCategory
    ...
    def list_all(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_06_01.models.AzureWebCategoryListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list_all.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Network/azureWebCategories'}  # type: ignore
