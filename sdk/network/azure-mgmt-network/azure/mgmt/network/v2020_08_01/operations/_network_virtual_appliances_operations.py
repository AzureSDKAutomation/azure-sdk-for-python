...
class NetworkVirtualAppliancesOperations(object):
    ...
    def create_or_update(
        ...
        :param parameters: Parameters supplied to the create or update Network
         Virtual Appliance.
        :type parameters:
         ~azure.mgmt.network.v2020_08_01.models.NetworkVirtualAppliance
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2020_08_01.models.NetworkVirtualAppliance]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2020_08_01.models.NetworkVirtualAppliance]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.mgmt.network.v2020_08_01.models.NetworkVirtualAppliancePaged[~azure.mgmt.network.v2020_08_01.models.NetworkVirtualAppliance]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
