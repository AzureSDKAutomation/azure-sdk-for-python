...
class ServiceTagsOperations(object):
    ...
    def list(
        self,
        location,  # type: str
        noaddressprefixes=None,  # type: Optional[bool]
        tagname=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        ...
        :type location: str
        :param noaddressprefixes: Set to true if addressPrefixes are not required in the response.
        :type noaddressprefixes: bool
        :param tagname: Specify single tagname such that response contains data for this tag only.
        :type tagname: str
        ...
        if noaddressprefixes is not None:
            query_parameters['noaddressprefixes'] = self._serialize.query("noaddressprefixes", noaddressprefixes, 'bool')
        if tagname is not None:
            query_parameters['tagname'] = self._serialize.query("tagname", tagname, 'str')
