...
class NetworkManagementClient(NetworkManagementClientOperationsMixin, SDKClient):
    ...
    :ivar nat_rules: NatRules operations
    ...
    :vartype p2s_vpn_gateways: azure.mgmt.network.v2020_08_01.operations.P2sVpnGatewaysOperations
    ...
    :vartype virtual_hub_route_table_v2s: azure.mgmt.network.v2020_08_01.operations.VirtualHubRouteTableV2sOperations
