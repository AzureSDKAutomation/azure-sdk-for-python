...
class ExpressRouteCrossConnection(Resource):
    ...
    def __init__(self, *, id: str=None, location: str=None, tags=None, primary_azure_port: str=None, secondary_azure_port: str=None, express_route_circuit=None, service_provider_provisioning_state=None, service_provider_notes: str=None, peerings=None, **kwargs) -> None:
