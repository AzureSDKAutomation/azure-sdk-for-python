...
class ManagedRuleDefinition(Model):
    ...
    :ivar default_action: Describes the default action to be applied when the
     managed rule matches. Possible values include: 'Block', 'Log', 'Redirect',
     'SetScore'
    :vartype default_action: str or
     ~azure.mgmt.frontdoor.models.ManagedRuleActionType
...
class ManagedRuleOverride(Model):
    ...
    :param action: Describes the override action to be applied when rule
     matches. Possible values include: 'Block', 'Log', 'Redirect', 'SetScore'
    :type action: str or ~azure.mgmt.frontdoor.models.ManagedRuleActionType
...
class ManagedRuleSetDefinition(Resource):
    ...
    :param rule_set_version_state: State of the rule set version. Possible
     values include: 'Recommended', 'Supported', 'Deprecated'
    :type rule_set_version_state: str or
     ~azure.mgmt.frontdoor.models.RuleSetVersionStateType
    :ivar rule_set_default_action: Possible values include: 'Block', 'Log',
     'Redirect'
    :vartype rule_set_default_action: str or
     ~azure.mgmt.frontdoor.models.ManagedRuleSetActionType
    :ivar rule_set_features:
    :vartype rule_set_features: list[str or
     ~azure.mgmt.frontdoor.models.RuleSetFeatureType]
    ...
    _validation = {
        ...
        'rule_set_default_action': {'readonly': True},
        'rule_set_features': {'readonly': True},
    ...
    _attribute_map = {
        ...
        'rule_set_version_state': {'key': 'properties.ruleSetVersionState', 'type': 'str'},
        'rule_set_default_action': {'key': 'properties.ruleSetDefaultAction', 'type': 'str'},
        'rule_set_features': {'key': 'properties.ruleSetFeatures', 'type': '[str]'},
        'rule_groups': {'key': 'properties.ruleGroups', 'type': '[ManagedRuleGroupDefinition]'},
    }

    def __init__(self, *, location: str=None, tags=None, rule_set_version_state=None, **kwargs) -> None:
        ...
        self.rule_set_version_state = rule_set_version_state
        self.rule_set_default_action = None
        self.rule_set_features = None
...
class WebApplicationFirewallPolicy(Resource):
    ...
    :ivar security_policy_links: Describes CDN Security Policies associated
     with this Web Application Firewall policy.
