...
class WebApplicationFirewallPolicy(Resource):
    ...
    :param tags: Resource tags.
    :type tags: dict[str, str]
    :param sku: The pricing tier for web application firewall policy.
    ...
    def __init__(self, *, location: str=None, tags=None, sku=None, policy_settings=None, custom_rules=None, managed_rules=None, etag: str=None, **kwargs) -> None:
