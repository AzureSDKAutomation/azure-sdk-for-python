...
class EventFilter(msrest.serialization.Model):
    ...
    :param included_event_types: The event types that will be sent to Event Grid.
...
class EventGridFilter(msrest.serialization.Model):
    ...
    :ivar type: The type of the resource.
    :vartype type: str
    :ivar provisioning_state: The provisioning state of the event grid filter. Possible values
     include: "Creating", "Updating", "Deleting", "Succeeded", "Failed", "Canceled".
    :vartype provisioning_state: str or
     ~app_configuration_management_client.models.ProvisioningState
    :ivar filter: Properties describing the filtering behavior of the event grid filter.
    :vartype filter: ~app_configuration_management_client.models.EventFilter
    :ivar subscriber_identity_info: Information describing the event subscriber.
    :vartype subscriber_identity_info:
     ~app_configuration_management_client.models.SubscriberIdentityInfo
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(EventGridFilter, self).__init__(**kwargs)
        self.id = None
        self.name = None
        self.type = None
        self.provisioning_state = None
...
class EventGridFilterListResult(msrest.serialization.Model):
    """The result of a request to list event grid filters.

    :param value: The collection value.
    :type value: list[~app_configuration_management_client.models.EventGridFilter]
    :param next_link: The URI that can be used to request the next set of paged results.
    :type next_link: str
    """
    ...
    def __init__(
        self,
        *,
        value: Optional[List["EventGridFilter"]] = None,
        next_link: Optional[str] = None,
        **kwargs
    ):
        super(EventGridFilterListResult, self).__init__(**kwargs)
        self.value = value
        self.next_link = next_link
...
class SubscriberIdentityInfo(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SubscriberIdentityInfo, self).__init__(**kwargs)
