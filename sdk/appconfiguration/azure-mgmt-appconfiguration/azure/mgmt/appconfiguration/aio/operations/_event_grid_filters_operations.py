...
class EventGridFiltersOperations:
    """EventGridFiltersOperations async operations.
    ...
    def list_by_configuration_store(
        ...
        **kwargs
    ) -> AsyncIterable["models.EventGridFilterListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~app_configuration_management_client.models.EventGridFilterListResult]
    ...
    async def get(
        ...
        resource_group_name: str,
        config_store_name: str,
        event_grid_filter_name: str,
        **kwargs
    ) -> "models.EventGridFilter":
