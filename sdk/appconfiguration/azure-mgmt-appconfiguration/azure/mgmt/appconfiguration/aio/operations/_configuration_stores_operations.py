    ...
    def list_keys(
        ...
        **kwargs
        ...
        :param skip_token: A skip token is used to continue retrieving items after an operation returns
         ...
         subsequent calls.
        :type skip_token: str
        :param filter: The filter to apply on the access keys. For example, you can use
         "$filter=readOnly eq true" to retrieve only read-only access keys. Properties that support
         filtering include 'name' and 'readOnly'.
        :type filter: str
        :keyword callable cls: A custom type or function that will be passed the direct response
