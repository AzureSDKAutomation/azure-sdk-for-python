...
class KeyVaultManagementClient(MultiApiClientMixin, _SDKClient):
    ...
    def secrets(self):
        """Instance depends on the API version:
           ...
           * 2019-09-01: :class:`SecretsOperations<azure.mgmt.keyvault.v2019_09_01.aio.operations.SecretsOperations>`
        """
        api_version = self._get_api_version('secrets')
        if api_version == '2019-09-01':
            from ..v2019_09_01.aio.operations import SecretsOperations as OperationClass
        else:
