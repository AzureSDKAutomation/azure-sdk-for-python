...
class KeyVaultManagementClient(MultiApiClientMixin, _SDKClient):
    ...
    DEFAULT_API_VERSION = '2020-04-01-preview'
    ...
    def models(cls, api_version=DEFAULT_API_VERSION):
        """Module depends on the API version:
           ...
           * 2020-04-01-preview: :mod:`v2020_04_01.models<azure.mgmt.keyvault.v2020_04_01.models>`
        """
    ...
    def managed_hsms(self):
        """Instance depends on the API version:
           ...
           * 2020-04-01-preview: :class:`ManagedHsmsOperations<azure.mgmt.keyvault.v2020_04_01.aio.operations_async.ManagedHsmsOperations>`
        """
        api_version = self._get_api_version('managed_hsms')
        if api_version == '2020-04-01-preview':
            from ..v2020_04_01.aio.operations_async import ManagedHsmsOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
    ...
    def operations(self):
        """Instance depends on the API version:
           ...
           * 2020-04-01-preview: :class:`Operations<azure.mgmt.keyvault.v2020_04_01.aio.operations_async.Operations>`
        """
    ...
    def private_endpoint_connections(self):
        """Instance depends on the API version:
           ...
           * 2020-04-01-preview: :class:`PrivateEndpointConnectionsOperations<azure.mgmt.keyvault.v2020_04_01.aio.operations_async.PrivateEndpointConnectionsOperations>`
        """
        ...
        if api_version == '2018-02-14':
            ...
            from ..v2020_04_01.aio.operations_async import PrivateEndpointConnectionsOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self._config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
    ...
    def private_link_resources(self):
        """Instance depends on the API version:
           ...
           * 2020-04-01-preview: :class:`PrivateLinkResourcesOperations<azure.mgmt.keyvault.v2020_04_01.aio.operations_async.PrivateLinkResourcesOperations>`
        """
        ...
        if api_version == '2018-02-14':
            ...
            from ..v2020_04_01.aio.operations_async import PrivateLinkResourcesOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self._config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
    ...
    def secrets(self):
        """Instance depends on the API version:
           ...
           * 2020-04-01-preview: :class:`SecretsOperations<azure.mgmt.keyvault.v2020_04_01.aio.operations_async.SecretsOperations>`
        """
        api_version = self._get_api_version('secrets')
        if api_version == '2020-04-01-preview':
            from ..v2020_04_01.aio.operations_async import SecretsOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self._config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
    ...
    def vaults(self):
        """Instance depends on the API version:
           ...
           * 2020-04-01-preview: :class:`VaultsOperations<azure.mgmt.keyvault.v2020_04_01.aio.operations_async.VaultsOperations>`
        """
        ...
        if api_version == '2016-10-01':
            ...
            from ..v2020_04_01.aio.operations_async import VaultsOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self._config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
