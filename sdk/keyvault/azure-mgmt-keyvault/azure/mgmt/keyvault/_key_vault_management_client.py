...
class KeyVaultManagementClient(MultiApiClientMixin, _SDKClient):
    ...
    def managed_hsms(self):
        """Instance depends on the API version:
           ...
           * 2020-04-01-preview: :class:`ManagedHsmsOperations<azure.mgmt.keyvault.v2020_04_01.operations.ManagedHsmsOperations>`
        """
    ...
    def operations(self):
        """Instance depends on the API version:
           ...
           * 2020-04-01-preview: :class:`Operations<azure.mgmt.keyvault.v2020_04_01.operations.Operations>`
        """
    ...
    def private_endpoint_connections(self):
        """Instance depends on the API version:
           ...
           * 2020-04-01-preview: :class:`PrivateEndpointConnectionsOperations<azure.mgmt.keyvault.v2020_04_01.operations.PrivateEndpointConnectionsOperations>`
        """
    ...
    def private_link_resources(self):
        """Instance depends on the API version:
           ...
           * 2020-04-01-preview: :class:`PrivateLinkResourcesOperations<azure.mgmt.keyvault.v2020_04_01.operations.PrivateLinkResourcesOperations>`
        """
    ...
    def secrets(self):
        """Instance depends on the API version:
           ...
           * 2020-04-01-preview: :class:`SecretsOperations<azure.mgmt.keyvault.v2020_04_01.operations.SecretsOperations>`
        """
        api_version = self._get_api_version('secrets')
        if api_version == '2020-04-01-preview':
            from .v2020_04_01.operations import SecretsOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self._config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
    ...
    def vaults(self):
        """Instance depends on the API version:
           ...
           * 2020-04-01-preview: :class:`VaultsOperations<azure.mgmt.keyvault.v2020_04_01.operations.VaultsOperations>`
        """
