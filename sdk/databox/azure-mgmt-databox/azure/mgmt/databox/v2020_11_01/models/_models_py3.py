...
class JobDetails(Model):
    ...
    :param key_encryption_key: Details about which key encryption type is
     being used.
    ...
    def __init__(self, *, contact_details, shipping_address=None, data_import_details=None, data_export_details=None, preferences=None, key_encryption_key=None, expected_data_size_in_terabytes: int=None, **kwargs) -> None:
...
class DataBoxDiskJobDetails(JobDetails):
    ...
    def __init__(self, *, contact_details, shipping_address=None, data_import_details=None, data_export_details=None, preferences=None, key_encryption_key=None, expected_data_size_in_terabytes: int=None, preferred_disks=None, passkey: str=None, **kwargs) -> None:
        super(DataBoxDiskJobDetails, self).__init__(contact_details=contact_details, shipping_address=shipping_address, data_import_details=data_import_details, data_export_details=data_export_details, preferences=preferences, key_encryption_key=key_encryption_key, expected_data_size_in_terabytes=expected_data_size_in_terabytes, **kwargs)
...
class DataBoxHeavyJobDetails(JobDetails):
    ...
    def __init__(self, *, contact_details, shipping_address=None, data_import_details=None, data_export_details=None, preferences=None, key_encryption_key=None, expected_data_size_in_terabytes: int=None, device_password: str=None, **kwargs) -> None:
