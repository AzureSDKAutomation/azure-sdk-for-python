...
class JobDetails(Model):
    ...
    def __init__(self, *, contact_details, shipping_address=None, data_import_details=None, data_export_details=None, preferences=None, key_encryption_key=None, expected_data_size_in_tera_bytes: int=None, **kwargs) -> None:
...
class DataBoxDiskJobDetails(JobDetails):
    ...
    def __init__(self, *, contact_details, shipping_address=None, data_import_details=None, data_export_details=None, preferences=None, key_encryption_key=None, expected_data_size_in_tera_bytes: int=None, preferred_disks=None, passkey: str=None, **kwargs) -> None:
...
class DataBoxHeavyJobDetails(JobDetails):
    ...
    def __init__(self, *, contact_details, shipping_address=None, data_import_details=None, data_export_details=None, preferences=None, key_encryption_key=None, expected_data_size_in_tera_bytes: int=None, device_password: str=None, **kwargs) -> None:
...
class DiskScheduleAvailabilityRequest(ScheduleAvailabilityRequest):
    ...
    def __init__(self, *, storage_location: str, expected_data_size_in_tera_bytes: int, country: str=None, **kwargs) -> None:
