...
class SentenceAssessment(Model):
    ...
    :param confidence_scores: Required. Assessment sentiment confidence scores
     in the sentence.
    :type confidence_scores:
     ~azure.cognitiveservices.language.textanalytics.models.TargetConfidenceScoreLabel
...
class SentenceSentiment(Model):
    ...
    :type targets:
     list[~azure.cognitiveservices.language.textanalytics.models.SentenceTarget]
    :param assessments: The array of assessments for the sentence.
    :type assessments:
     list[~azure.cognitiveservices.language.textanalytics.models.SentenceAssessment]
    """
...
class SentenceTarget(Model):
    ...
    :type relations:
     list[~azure.cognitiveservices.language.textanalytics.models.TargetRelation]
    """
...
class TargetRelation(Model):
    ...
    :type relation_type: str or
     ~azure.cognitiveservices.language.textanalytics.models.TargetRelationType
