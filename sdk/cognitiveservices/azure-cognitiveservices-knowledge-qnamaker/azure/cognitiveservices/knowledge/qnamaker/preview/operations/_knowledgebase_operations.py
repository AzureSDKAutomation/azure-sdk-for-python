...
class KnowledgebaseOperations(object):
    ...
    def generate_answer(
        ...
        :type generate_answer_payload:
         ~azure.cognitiveservices.knowledge.qnamaker.preview.models.Query
        ...
        # Construct body
        body_content = self._serialize.body(generate_answer_payload, 'Query')
    ...
    def train(
        ...
        :raises:
         :class:`ErrorResponseException<azure.cognitiveservices.knowledge.qnamaker.preview.models.ErrorResponseException>`
        """
        train_payload = models.FeedbackRecords(feedback_records=feedback_records)
        ...
        # Construct body
        body_content = self._serialize.body(train_payload, 'FeedbackRecords')
