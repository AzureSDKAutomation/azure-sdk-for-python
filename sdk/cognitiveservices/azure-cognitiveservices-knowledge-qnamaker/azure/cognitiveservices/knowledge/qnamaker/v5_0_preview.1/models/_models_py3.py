...
class ContextDTO(Model):
    ...
    :type prompts:
     list[~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.PromptDTO]
    """
...
class CreateKbDTO(Model):
    ...
    :type qna_list:
     list[~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.QnADTO]
    :param urls: List of URLs to be used for extracting Q-A.
    :type urls: list[str]
    :param files: List of files from which to Extract Q-A.
    :type files:
     list[~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.FileDTO]
...
class EndpointSettingsDTO(Model):
    ...
    :type active_learning:
     ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.EndpointSettingsDTOActiveLearning
    """
...
class Error(Model):
    ...
    :param code: Required. One of a server-defined set of error codes.
     ...
     'ExtractionFailure'
    :type code: str or
     ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.ErrorCodeType
    ...
    :param details: An array of details about specific errors that led to this
     reported error.
    :type details:
     list[~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.Error]
    :param inner_error: An object containing more specific information than
     the current object about the error.
    :type inner_error:
     ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.InnerErrorModel
    """
...
class ErrorResponse(Model):
    ...
    :type error:
     ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.ErrorResponseError
    """
...
class FeedbackRecordsDTO(Model):
    ...
    :type feedback_records:
     list[~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.FeedbackRecordDTO]
    """
...
class KnowledgebasesDTO(Model):
    ...
    :type knowledgebases:
     list[~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.KnowledgebaseDTO]
    """
...
class Operation(Model):
    ...
    :type operation_state: str or
     ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.OperationStateType
    ...
    :type error_response:
     ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.ErrorResponse
    """
...
class PromptDTO(Model):
    ...
    :param qna: QnADTO - Either QnaId or QnADTO needs to be present in a
     PromptDTO object
    :type qna:
     ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.PromptDTOQna
...
class QnADTO(Model):
    ...
    :type metadata:
     list[~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.MetadataDTO]
    :param context: Context of a QnA
    :type context:
     ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.QnADTOContext
...
class QnASearchResult(Model):
    ...
    :type context:
     ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.QnASearchResultContext
    :param answer_span: Answer span object of QnA with respect to user's
     question.
    :type answer_span:
     ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.QnASearchResultAnswerSpan
    """
...
class QnASearchResultList(Model):
    ...
    :type answers:
     list[~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.QnASearchResult]
    """
...
class QueryDTO(Model):
    ...
    :type context:
     ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.QueryDTOContext
    ...
    :type strict_filters_compound_operation_type: str or
     ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.StrictFiltersCompoundOperationType
    :param answer_span_request: To configure Answer span prediction feature.
    :type answer_span_request:
     ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.QueryDTOAnswerSpanRequest
    """
...
class UpdateKbContentsDTO(Model):
    ...
    :param qna_list: List of Q-A (UpdateQnaDTO) to be added to the
     knowledgebase.
    :type qna_list:
     list[~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.UpdateQnaDTO]
...
class UpdateKbOperationDTO(Model):
    ...
    :type add:
     ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.UpdateKbOperationDTOAdd
    :param delete: An instance of DeleteKbContentsDTO for delete Operation
    :type delete:
     ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.UpdateKbOperationDTODelete
    :param update: An instance of UpdateKbContentsDTO for Update Operation
    :type update:
     ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.UpdateKbOperationDTOUpdate
    :param enable_hierarchical_extraction: Enable hierarchical extraction of
...
class UpdateQnaDTO(Model):
    ...
    :type questions:
     ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.UpdateQnaDTOQuestions
    :param metadata: List of metadata associated with the answer to be updated
    :type metadata:
     ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.UpdateQnaDTOMetadata
    :param context: Context associated with Qna to be updated.
    :type context:
     ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.UpdateQnaDTOContext
    """
...
class WordAlterationsDTO(Model):
    ...
    :type word_alterations:
     list[~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.AlterationsDTO]
    """
