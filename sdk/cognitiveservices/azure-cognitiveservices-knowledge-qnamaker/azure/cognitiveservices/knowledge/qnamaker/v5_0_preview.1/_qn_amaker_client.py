...
class QnAMakerClient(SDKClient):
    ...
    :vartype endpoint_settings: azure.cognitiveservices.knowledge.qnamaker.v5_0.operations.EndpointSettingsOperations
    :ivar endpoint_keys: EndpointKeys operations
    :vartype endpoint_keys: azure.cognitiveservices.knowledge.qnamaker.v5_0.operations.EndpointKeysOperations
    :ivar alterations: Alterations operations
    :vartype alterations: azure.cognitiveservices.knowledge.qnamaker.v5_0.operations.AlterationsOperations
    :ivar knowledgebase: Knowledgebase operations
    :vartype knowledgebase: azure.cognitiveservices.knowledge.qnamaker.v5_0.operations.KnowledgebaseOperations
    :ivar operations: Operations operations
    :vartype operations: azure.cognitiveservices.knowledge.qnamaker.v5_0.operations.Operations
