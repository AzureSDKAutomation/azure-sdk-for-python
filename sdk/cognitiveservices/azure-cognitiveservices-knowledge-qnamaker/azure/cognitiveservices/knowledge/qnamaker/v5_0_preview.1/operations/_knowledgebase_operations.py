...
class KnowledgebaseOperations(object):
    ...
    def list_all(
        ...
        :rtype:
         ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.KnowledgebasesDTO
         or ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.cognitiveservices.knowledge.qnamaker.v5_0.models.ErrorResponseException>`
        """
        # Construct URL
    ...
    def get_details(
        ...
        :rtype:
         ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.KnowledgebaseDTO
         or ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.cognitiveservices.knowledge.qnamaker.v5_0.models.ErrorResponseException>`
        """
    ...
    def update(
        ...
        :type update_kb:
         ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.UpdateKbOperationDTO
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype:
         ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.Operation or
    ...
    def create(
        ...
        :type create_kb_payload:
         ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.CreateKbDTO
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def download(
        ...
        :type environment: str or
         ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.EnvironmentType
        ...
        :rtype:
         ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.QnADocumentsDTO
         or ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.cognitiveservices.knowledge.qnamaker.v5_0.models.ErrorResponseException>`
        """
    ...
    def generate_answer(
        ...
        :type generate_answer_payload:
         ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.QueryDTO
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype:
         ~azure.cognitiveservices.knowledge.qnamaker.v5_0.models.QnASearchResultList
         or ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.cognitiveservices.knowledge.qnamaker.v5_0.models.ErrorResponseException>`
        """
