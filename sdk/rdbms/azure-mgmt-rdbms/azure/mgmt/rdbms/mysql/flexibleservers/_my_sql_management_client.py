...
class MySQLManagementClient(SDKClient):
    ...
    :vartype server_keys: azure.mgmt.rdbms.mysql.flexibleservers.operations.ServerKeysOperations
    ...
    :vartype location_based_capabilities: azure.mgmt.rdbms.mysql.flexibleservers.operations.LocationBasedCapabilitiesOperations
    :ivar check_virtual_network_subnet_usage: CheckVirtualNetworkSubnetUsage operations
    :vartype check_virtual_network_subnet_usage: azure.mgmt.rdbms.mysql.flexibleservers.operations.CheckVirtualNetworkSubnetUsageOperations
