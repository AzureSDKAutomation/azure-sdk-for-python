...
class CapabilityProperties(Model):
    ...
    :vartype supported_flexible_server_editions:
     list[~azure.mgmt.rdbms.mysql.flexibleservers.models.ServerEditionCapability]
    """
...
class CloudError(Model):
    ...
    :type error: ~azure.mgmt.rdbms.mysql.flexibleservers.models.ErrorResponse
    """
...
class Configuration(ProxyResource):
    ...
    :vartype is_read_only: str or
     ~azure.mgmt.rdbms.mysql.flexibleservers.models.IsReadOnly
    ...
    :vartype is_config_pending_restart: str or
     ~azure.mgmt.rdbms.mysql.flexibleservers.models.IsConfigPendingRestart
    :ivar is_dynamic_config: If is the configuration dynamic. Possible values
     include: 'True', 'False'
    :vartype is_dynamic_config: str or
     ~azure.mgmt.rdbms.mysql.flexibleservers.models.IsDynamicConfig
    """
...
class ErrorResponse(Model):
    ...
    :vartype details:
     list[~azure.mgmt.rdbms.mysql.flexibleservers.models.ErrorResponse]
    :ivar additional_info: The error additional info.
    :vartype additional_info:
     list[~azure.mgmt.rdbms.mysql.flexibleservers.models.ErrorAdditionalInfo]
    """
...
class Identity(Model):
    ...
    :type type: str or
     ~azure.mgmt.rdbms.mysql.flexibleservers.models.ResourceIdentityType
    """
...
class Operation(Model):
    ...
    :ivar display: The localized display information for this particular
     operation or action.
    :vartype display:
     ~azure.mgmt.rdbms.mysql.flexibleservers.models.OperationDisplay
    :ivar origin: The intended executor of the operation. Possible values
     include: 'NotSpecified', 'user', 'system'
    :vartype origin: str or
     ~azure.mgmt.rdbms.mysql.flexibleservers.models.OperationOrigin
...
class OperationListResult(Model):
    ...
    :type value:
     list[~azure.mgmt.rdbms.mysql.flexibleservers.models.Operation]
    """
...
class ResourceModelWithAllowedPropertySet(Model):
    ...
    :param identity:
    :type identity:
     ~azure.mgmt.rdbms.mysql.flexibleservers.models.ResourceModelWithAllowedPropertySetIdentity
    :param sku:
    :type sku:
     ~azure.mgmt.rdbms.mysql.flexibleservers.models.ResourceModelWithAllowedPropertySetSku
    :param plan:
    :type plan:
     ~azure.mgmt.rdbms.mysql.flexibleservers.models.ResourceModelWithAllowedPropertySetPlan
    """
...
class Sku(Model):
    ...
    :param tier: Required. The tier of the particular SKU, e.g.
     ...
     'MemoryOptimized'
    :type tier: str or ~azure.mgmt.rdbms.mysql.flexibleservers.models.SkuTier
    """
...
class Server(TrackedResource):
    ...
    :type identity: ~azure.mgmt.rdbms.mysql.flexibleservers.models.Identity
    :param sku: The SKU (pricing tier) of the server.
    :type sku: ~azure.mgmt.rdbms.mysql.flexibleservers.models.Sku
    ...
    :type version: str or
     ~azure.mgmt.rdbms.mysql.flexibleservers.models.ServerVersion
    :param ssl_enforcement: Enable ssl enforcement or not when connect to
     server. Possible values include: 'Enabled', 'Disabled'
    :type ssl_enforcement: str or
     ~azure.mgmt.rdbms.mysql.flexibleservers.models.SslEnforcementEnum
    ...
    :type infrastructure_encryption: str or
     ~azure.mgmt.rdbms.mysql.flexibleservers.models.InfrastructureEncryptionEnum
    :ivar state: The state of a server. Possible values include: 'Ready',
     'Dropping', 'Disabled', 'Starting', 'Stopping', 'Stopped', 'Updating'
    :vartype state: str or
     ~azure.mgmt.rdbms.mysql.flexibleservers.models.ServerState
    ...
    :vartype ha_state: str or
     ~azure.mgmt.rdbms.mysql.flexibleservers.models.ServerHAState
    :param ha_enabled: Enable HA or not for a server. Possible values include:
     'Enabled', 'Disabled'
    :type ha_enabled: str or
     ~azure.mgmt.rdbms.mysql.flexibleservers.models.HaEnabledEnum
    ...
    :type storage_profile:
     ~azure.mgmt.rdbms.mysql.flexibleservers.models.StorageProfile
    :param replication_role: The replication role.
    :type replication_role: str
    :ivar primary_server_id: The primary server id of a replica server.
    :vartype primary_server_id: str
    ...
    :type public_network_access: str or
     ~azure.mgmt.rdbms.mysql.flexibleservers.models.PublicNetworkAccessEnum
    ...
    :param source_server_id: The source MySQL server name to restore from.
    ...
    :ivar stand_by_availability_zone: availability Zone information of the
     server.
    :vartype stand_by_availability_zone: str
    ...
    :type delegated_subnet_arguments:
     ~azure.mgmt.rdbms.mysql.flexibleservers.models.DelegatedSubnetArguments
    ...
    :type create_mode: str or
     ~azure.mgmt.rdbms.mysql.flexibleservers.models.CreateMode
    ...
    _validation = {
        ...
        'primary_server_id': {'readonly': True},
        'replica_capacity': {'minimum': 0},
        'stand_by_availability_zone': {'readonly': True},
    ...
    _attribute_map = {
        ...
        'stand_by_availability_zone': {'key': 'properties.standByAvailabilityZone', 'type': 'str'},
    ...
    def __init__(self, *, location: str, tags=None, identity=None, sku=None, administrator_login: str=None, administrator_login_password: str=None, version=None, ssl_enforcement=None, infrastructure_encryption=None, ha_enabled=None, earliest_restore_date=None, storage_profile=None, replication_role: str=None, replica_capacity: int=None, public_network_access=None, maintenance_window=None, source_server_id: str=None, restore_point_in_time=None, availability_zone: str=None, delegated_subnet_arguments=None, create_mode=None, server_tags=None, **kwargs) -> None:
        ...
        self.stand_by_availability_zone = None
...
class ServerEditionCapability(Model):
    ...
    :vartype supported_storage_editions:
     list[~azure.mgmt.rdbms.mysql.flexibleservers.models.StorageEditionCapability]
    :ivar supported_server_versions:
    :vartype supported_server_versions:
     list[~azure.mgmt.rdbms.mysql.flexibleservers.models.ServerVersionCapability]
    """
...
class ServerForUpdate(Model):
    ...
    def __init__(self, *, sku=None, storage_profile=None, administrator_login_password: str=None, ssl_enforcement=None, delegated_subnet_arguments=None, ha_enabled=None, public_network_access=None, maintenance_window=None, replication_role: str=None, tags=None, **kwargs) -> None:
...
class ServerVersionCapability(Model):
    ...
    :vartype supported_vcores:
     list[~azure.mgmt.rdbms.mysql.flexibleservers.models.VcoreCapability]
    """
...
class StorageEditionCapability(Model):
    ...
    :vartype supported_storage_mb:
     list[~azure.mgmt.rdbms.mysql.flexibleservers.models.StorageMBCapability]
    """
...
class StorageProfile(Model):
    ...
    :type storage_autogrow: str or
     ~azure.mgmt.rdbms.mysql.flexibleservers.models.StorageAutogrow
    """
...
class VirtualNetworkSubnetUsageResult(Model):
    ...
    :vartype delegated_subnets_usage:
     list[~azure.mgmt.rdbms.mysql.flexibleservers.models.DelegatedSubnetUsage]
    """
