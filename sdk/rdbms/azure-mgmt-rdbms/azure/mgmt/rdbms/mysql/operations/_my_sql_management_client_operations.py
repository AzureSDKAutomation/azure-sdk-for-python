...
class MySQLManagementClientOperationsMixin(object):
    ...
    def reset_query_performance_insight_data(
        ...
        :return: QueryPerformanceInsightResetDataResult or ClientRawResponse
         if raw=true
        :rtype:
         ~azure.mgmt.rdbms.mysql.models.QueryPerformanceInsightResetDataResult
        ...
        return deserialized
    reset_query_performance_insight_data.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/resetQueryPerformanceInsightData'}
