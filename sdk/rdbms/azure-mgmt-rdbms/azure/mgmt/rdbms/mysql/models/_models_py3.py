...
class ServerUpdateParameters(Model):
    ...
    def __init__(self, *, identity=None, sku=None, storage_profile=None, administrator_login_password: str=None, version=None, ssl_enforcement=None, minimal_tls_version=None, replication_role: str=None, tags=None, **kwargs) -> None:
