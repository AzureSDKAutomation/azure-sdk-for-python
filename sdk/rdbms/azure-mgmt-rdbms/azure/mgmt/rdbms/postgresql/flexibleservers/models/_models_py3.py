...
class CapabilityProperties(Model):
    ...
    :vartype supported_flexible_server_editions:
     list[~azure.mgmt.rdbms.postgresql.flexibleservers.models.ServerEditionCapability]
    """
...
class Server(TrackedResource):
    ...
    :type maintenance_window:
     ~azure.mgmt.rdbms.postgresql.flexibleservers.models.MaintenanceWindow
    :param ha_enabled: stand by count value can be either enabled or disabled.
     Possible values include: 'Enabled', 'Disabled'
    :type ha_enabled: str or
     ~azure.mgmt.rdbms.postgresql.flexibleservers.models.HAEnabledEnum
    ...
    :type delegated_subnet_arguments:
     ~azure.mgmt.rdbms.postgresql.flexibleservers.models.ServerPropertiesDelegatedSubnetArguments
...
class ServerEditionCapability(Model):
    ...
    :vartype supported_storage_editions:
     list[~azure.mgmt.rdbms.postgresql.flexibleservers.models.StorageEditionCapability]
    :ivar supported_server_versions:
    :vartype supported_server_versions:
     list[~azure.mgmt.rdbms.postgresql.flexibleservers.models.ServerVersionCapability]
    """
...
class ServerForUpdate(Model):
    ...
    def __init__(self, *, location: str=None, sku=None, administrator_login_password: str=None, storage_profile=None, ha_enabled=None, maintenance_window=None, tags=None, **kwargs) -> None:
...
class ServerVersionCapability(Model):
    ...
    :vartype supported_vcores:
     list[~azure.mgmt.rdbms.postgresql.flexibleservers.models.VcoreCapability]
    """
...
class StorageEditionCapability(Model):
    ...
    :vartype supported_storage_mb:
     list[~azure.mgmt.rdbms.postgresql.flexibleservers.models.StorageMBCapability]
    """
...
class VirtualNetworkSubnetUsageResult(Model):
    ...
    :vartype delegated_subnets_usage:
     list[~azure.mgmt.rdbms.postgresql.flexibleservers.models.DelegatedSubnetUsage]
    """
