...
class PostgreSQLManagementClient(SDKClient):
    ...
    :vartype servers: azure.mgmt.rdbms.postgresql.flexibleservers.operations.ServersOperations
    ...
    :vartype configurations: azure.mgmt.rdbms.postgresql.flexibleservers.operations.ConfigurationsOperations
    :ivar server_keys: ServerKeys operations
    :vartype server_keys: azure.mgmt.rdbms.postgresql.flexibleservers.operations.ServerKeysOperations
    :ivar check_name_availability: CheckNameAvailability operations
    :vartype check_name_availability: azure.mgmt.rdbms.postgresql.flexibleservers.operations.CheckNameAvailabilityOperations
    :ivar location_based_capabilities: LocationBasedCapabilities operations
    :vartype location_based_capabilities: azure.mgmt.rdbms.postgresql.flexibleservers.operations.LocationBasedCapabilitiesOperations
    :ivar virtual_network_subnet_usage: VirtualNetworkSubnetUsage operations
    :vartype virtual_network_subnet_usage: azure.mgmt.rdbms.postgresql.flexibleservers.operations.VirtualNetworkSubnetUsageOperations
