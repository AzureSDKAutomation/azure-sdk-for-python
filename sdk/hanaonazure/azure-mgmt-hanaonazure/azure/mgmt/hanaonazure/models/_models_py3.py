...
class ErrorDetail(Model):
    ...
    :vartype details: list[~azure.mgmt.hanaonazure.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info:
     list[~azure.mgmt.hanaonazure.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(Model):
    ...
    :type error: ~azure.mgmt.hanaonazure.models.ErrorDetail
    """
