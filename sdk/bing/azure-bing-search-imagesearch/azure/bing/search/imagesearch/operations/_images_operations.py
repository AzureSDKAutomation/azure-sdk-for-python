...
class ImagesOperations(object):
    ...
    def search(
        ...
        :param aspect: Filter images by the following aspect ratios. All: Do
         ...
         'Square', 'Wide', 'Tall'
        :type aspect: str or ~azure.bing.search.imagesearch.models.ImageAspect
        :param color: Filter images by the following color options. ColorOnly:
         ...
         'Yellow'
        :type color: str or ~azure.bing.search.imagesearch.models.ImageColor
        ...
        :type freshness: str or
         ~azure.bing.search.imagesearch.models.Freshness
        ...
        :type image_content: str or
         ~azure.bing.search.imagesearch.models.ImageContent
        ...
        :type image_type: str or
         ~azure.bing.search.imagesearch.models.ImageType
        ...
        :type license: str or
         ~azure.bing.search.imagesearch.models.ImageLicense
        ...
        :type safe_search: str or
         ~azure.bing.search.imagesearch.models.SafeSearch
        :param size: Filter images by the following sizes. All: Do not filter
         ...
         'Wallpaper'
        :type size: str or ~azure.bing.search.imagesearch.models.ImageSize
        ...
        :rtype: ~azure.bing.search.imagesearch.models.Images or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.bing.search.imagesearch.models.ErrorResponseException>`
        """
        # Construct URL
    ...
    def details(
        ...
        :type crop_type: str or
         ~azure.bing.search.imagesearch.models.ImageCropType
        :param country_code: A 2-character country code of the country where
         the results come from. For a list of possible values, see [Market
         Codes](https://docs.microsoft.com/en-us/bing/bing-image-search/overview).
         If you set this parameter, you must also specify the
        ...
        :type modules: list[str or
         ~azure.bing.search.imagesearch.models.ImageInsightModule]
        :param market: The market where the results come from. Typically, mkt
         is the country where the user is making the request from. However, it
         could be a different country if the user is not located in a country
         where Bing delivers results. The market must be in the form <language
        ...
        :rtype: ~azure.bing.search.imagesearch.models.ImageInsights or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.bing.search.imagesearch.models.ErrorResponseException>`
        """
    ...
    def trending(
        ...
        :rtype: ~azure.bing.search.imagesearch.models.TrendingImages or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.bing.search.imagesearch.models.ErrorResponseException>`
        """
