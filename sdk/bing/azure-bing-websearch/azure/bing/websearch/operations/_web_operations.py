...
class WebOperations(object):
    ...
    def search(
        ...
        :param freshness: Filter search results by the following age values:
         ...
         'Month'
        :type freshness: str or ~azure.bing.websearch.models.Freshness
        ...
        :type promote: list[str or ~azure.bing.websearch.models.AnswerType]
        ...
        :type response_filter: list[str or
         ~azure.bing.websearch.models.AnswerType]
        :param safe_search: A filter used to filter adult content. Off: Return
         ...
         'Moderate', 'Strict'
        :type safe_search: str or ~azure.bing.websearch.models.SafeSearch
        ...
        :type text_format: str or ~azure.bing.websearch.models.TextFormat
        ...
        :rtype: ~azure.bing.websearch.models.SearchResponse or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.bing.websearch.models.ErrorResponseException>`
        """
        # Construct URL
