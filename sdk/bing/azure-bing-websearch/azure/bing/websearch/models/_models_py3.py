...
class Answer(Response):
    ...
    :vartype follow_up_queries: list[~azure.bing.websearch.models.Query]
    """
...
class Thing(Response):
    ...
    :vartype url: str
    :ivar image:
    :vartype image: ~azure.bing.websearch.models.ImageObject
...
class CreativeWork(Thing):
    ...
    :vartype provider: list[~azure.bing.websearch.models.Thing]
    :ivar text:
    :vartype text: str
    """
...
class Error(Model):
    ...
    :param code: Required. The error code that identifies the category of
     ...
     Default value: "None" .
    :type code: str or ~azure.bing.websearch.models.ErrorCode
    ...
    :vartype sub_code: str or ~azure.bing.websearch.models.ErrorSubCode
...
class ErrorResponse(Response):
    ...
    :param errors: Required. A list of errors that describe the reasons why
     the request failed.
    :type errors: list[~azure.bing.websearch.models.Error]
    """
...
class ImageObject(MediaObject):
    ...
    :vartype thumbnail: ~azure.bing.websearch.models.ImageObject
    """
...
class SearchResultsAnswer(Answer):
    ...
    :vartype follow_up_queries: list[~azure.bing.websearch.models.Query]
    :ivar query_context:
    :vartype query_context: ~azure.bing.websearch.models.QueryContext
...
class Images(SearchResultsAnswer):
    ...
    :type value: list[~azure.bing.websearch.models.ImageObject]
    :ivar query_expansions:
    :vartype query_expansions: list[~azure.bing.websearch.models.Query]
    :ivar similar_terms:
    :vartype similar_terms: list[~azure.bing.websearch.models.Query]
    :ivar related_searches:
    :vartype related_searches: list[~azure.bing.websearch.models.Query]
    """
...
class News(SearchResultsAnswer):
    ...
    :type value: list[~azure.bing.websearch.models.NewsArticle]
    :ivar location:
...
class Places(SearchResultsAnswer):
    ...
    :param value: Required. A list of local entities, such as restaurants or
     hotels.
    :type value: list[~azure.bing.websearch.models.Thing]
    """
...
class RankingRankingGroup(Model):
    ...
    :param items: Required. A list of search result items to display in the
     group.
    :type items: list[~azure.bing.websearch.models.RankingRankingItem]
    """
...
class RankingRankingItem(Model):
    ...
    :type answer_type: str or ~azure.bing.websearch.models.AnswerType
    ...
    :ivar value: The ID that identifies either an answer to display or an item
     ...
     of the answer.
    :vartype value: ~azure.bing.websearch.models.Identifiable
    :ivar html_index:
...
class RankingRankingResponse(Model):
    ...
    :vartype pole: ~azure.bing.websearch.models.RankingRankingGroup
    :ivar mainline: The search results to display in the mainline.
    :vartype mainline: ~azure.bing.websearch.models.RankingRankingGroup
    :ivar sidebar: The search results to display in the sidebar.
    :vartype sidebar: ~azure.bing.websearch.models.RankingRankingGroup
    """
...
class RelatedSearchesRelatedSearchAnswer(SearchResultsAnswer):
    ...
    :param value: Required. A list of related queries that were made by
     others.
    :type value: list[~azure.bing.websearch.models.Query]
    """
...
class TimeZone(SearchResultsAnswer):
    ...
    :type primary_city_time:
     ~azure.bing.websearch.models.TimeZoneTimeZoneInformation
    :ivar other_city_times: A list of dates and times of nearby time zones.
    :vartype other_city_times:
     list[~azure.bing.websearch.models.TimeZoneTimeZoneInformation]
    """
...
class Videos(SearchResultsAnswer):
    ...
    :param value: Required. A list of video objects that are relevant to the
     query.
    :type value: list[~azure.bing.websearch.models.VideoObject]
    :ivar next_offset:
    :vartype next_offset: int
    :ivar query_expansions:
    :vartype query_expansions: list[~azure.bing.websearch.models.Query]
...
class WebPage(CreativeWork):
    ...
    :vartype deep_links: list[~azure.bing.websearch.models.WebPage]
    ...
    :ivar search_tags: A list of search tags that the webpage owner specified
     ...
     the tag's value.
    :vartype search_tags: list[~azure.bing.websearch.models.WebMetaTag]
    :ivar primary_image_of_page:
    :vartype primary_image_of_page: ~azure.bing.websearch.models.ImageObject
    """
...
class WebWebAnswer(SearchResultsAnswer):
    ...
    :type value: list[~azure.bing.websearch.models.WebPage]
...
class WebWebGrouping(Model):
    ...
    :type web_pages: list[~azure.bing.websearch.models.WebPage]
