...
class EntitiesOperations(object):
    ...
    def search(
        ...
        :type response_filter: list[str or
         ~azure.bing.entitysearch.models.AnswerType]
        ...
        :type response_format: list[str or
         ~azure.bing.entitysearch.models.ResponseFormat]
        :param safe_search: A filter used to filter adult content. Off: Return
         ...
         'Moderate', 'Strict'
        :type safe_search: str or ~azure.bing.entitysearch.models.SafeSearch
        ...
        :rtype: ~azure.bing.entitysearch.models.SearchResponse or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.bing.entitysearch.models.ErrorResponseException>`
        """
        # Construct URL
