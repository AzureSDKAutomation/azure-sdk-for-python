...
class Thing(Response):
    ...
    :vartype image: ~azure.bing.visualsearch.models.ImageObject
...
class CreativeWork(Thing):
    ...
    :vartype provider: list[~azure.bing.visualsearch.models.Thing]
...
class Action(CreativeWork):
    ...
    :vartype result: list[~azure.bing.visualsearch.models.Thing]
...
class Offer(Thing):
    ...
    :vartype seller: ~azure.bing.visualsearch.models.Organization
    ...
    :ivar price_currency: The monetary currency. For example, USD. Possible
     ...
     'YER', 'ZAR', 'ZMW'
    :vartype price_currency: str or ~azure.bing.visualsearch.models.Currency
    ...
    :vartype availability: str or
     ~azure.bing.visualsearch.models.ItemAvailability
    :ivar aggregate_rating: An aggregated rating that indicates how well the
     product has been rated by others.
    :vartype aggregate_rating: ~azure.bing.visualsearch.models.AggregateRating
...
class AggregateOffer(Offer):
    ...
    :ivar offers: A list of offers from merchants that have offerings related
     to the image.
    :vartype offers: list[~azure.bing.visualsearch.models.Offer]
    """
...
class Error(Model):
    ...
    :param code: Required. The error code that identifies the category of
     ...
     Default value: "None" .
    :type code: str or ~azure.bing.visualsearch.models.ErrorCode
    ...
    :vartype sub_code: str or ~azure.bing.visualsearch.models.ErrorSubCode
...
class ErrorResponse(Response):
    ...
    :param errors: Required. A list of errors that describe the reasons why
     the request failed.
    :type errors: list[~azure.bing.visualsearch.models.Error]
    """
...
class ImageInfo(Model):
    ...
    :type crop_area: ~azure.bing.visualsearch.models.CropArea
    """
...
class ImageKnowledge(Response):
    ...
    :vartype tags: list[~azure.bing.visualsearch.models.ImageTag]
...
class ImageModuleAction(ImageAction):
    ...
    :vartype data: ~azure.bing.visualsearch.models.ImagesModule
    """
...
class ImageObject(MediaObject):
    ...
    :vartype thumbnail: ~azure.bing.visualsearch.models.ImageObject
    ...
    :vartype insights_metadata:
     ~azure.bing.visualsearch.models.ImagesImageMetadata
...
class ImageRecipesAction(ImageAction):
    ...
    :vartype data: ~azure.bing.visualsearch.models.RecipesModule
    """
...
class ImageRelatedSearchesAction(ImageAction):
    ...
    :vartype data: ~azure.bing.visualsearch.models.RelatedSearchesModule
    """
...
class ImageShoppingSourcesAction(ImageAction):
    ...
    :vartype data: ~azure.bing.visualsearch.models.AggregateOffer
    """
...
class ImagesImageMetadata(Model):
    ...
    :vartype aggregate_offer: ~azure.bing.visualsearch.models.AggregateOffer
    """
...
class ImagesModule(Model):
    ...
    :vartype value: list[~azure.bing.visualsearch.models.ImageObject]
    """
...
class ImageTag(Thing):
    ...
    :vartype bounding_box: ~azure.bing.visualsearch.models.ImageTagRegion
    ...
    :vartype actions: list[~azure.bing.visualsearch.models.ImageAction]
    """
...
class ImageTagRegion(Model):
    ...
    :type query_rectangle:
     ~azure.bing.visualsearch.models.NormalizedQuadrilateral
...
class KnowledgeRequest(Model):
    ...
    :type filters: ~azure.bing.visualsearch.models.Filters
    """
...
class NormalizedQuadrilateral(StructuredValue):
    ...
    :type top_left: ~azure.bing.visualsearch.models.Point2D
    :param top_right: Required. The top right corner coordinate.
    :type top_right: ~azure.bing.visualsearch.models.Point2D
    :param bottom_right: Required. The bottom right corner coordinate.
    :type bottom_right: ~azure.bing.visualsearch.models.Point2D
    :param bottom_left: Required. The bottom left corner coordinate.
    :type bottom_left: ~azure.bing.visualsearch.models.Point2D
    """
...
class RecipesModule(Model):
    ...
    :vartype value: list[~azure.bing.visualsearch.models.Recipe]
    """
...
class RelatedSearchesModule(Model):
    ...
    :vartype value: list[~azure.bing.visualsearch.models.Query]
    """
...
class VisualSearchRequest(Model):
    ...
    :param image_info: A JSON object that identities the image to get insights
     of.
    :type image_info: ~azure.bing.visualsearch.models.ImageInfo
    :param knowledge_request: A JSON object containing information about the
     request, such as filters, or a description.
    :type knowledge_request: ~azure.bing.visualsearch.models.KnowledgeRequest
    """
