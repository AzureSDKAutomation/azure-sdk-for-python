...
class NewsOperations(object):
    ...
    def search(
        ...
        :param freshness: Filter news by the date and time that Bing
         ...
         'Month'
        :type freshness: str or ~azure.bing.search.newssearch.models.Freshness
        ...
        :type safe_search: str or
         ~azure.bing.search.newssearch.models.SafeSearch
        ...
        :type text_format: str or
         ~azure.bing.search.newssearch.models.TextFormat
        ...
        :rtype: ~azure.bing.search.newssearch.models.News or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.bing.search.newssearch.models.ErrorResponseException>`
        """
        # Construct URL
    ...
    def trending(
        ...
        :rtype: ~azure.bing.search.newssearch.models.TrendingTopics or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.bing.search.newssearch.models.ErrorResponseException>`
        """
