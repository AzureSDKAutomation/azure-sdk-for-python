...
class CustomInstanceOperations(object):
    ...
    def image_search(
        ...
        :param aspect: Filter images by the following aspect ratios. All: Do
         ...
         'Square', 'Wide', 'Tall'
        :type aspect: str or ~azure.bing.customimagesearch.models.ImageAspect
        :param color: Filter images by the following color options. ColorOnly:
         ...
         'Yellow'
        :type color: str or ~azure.bing.customimagesearch.models.ImageColor
        ...
        :type freshness: str or ~azure.bing.customimagesearch.models.Freshness
        ...
        :type image_content: str or
         ~azure.bing.customimagesearch.models.ImageContent
        ...
        :type image_type: str or
         ~azure.bing.customimagesearch.models.ImageType
        ...
        :type license: str or
         ~azure.bing.customimagesearch.models.ImageLicense
        ...
        :type safe_search: str or
         ~azure.bing.customimagesearch.models.SafeSearch
        :param size: Filter images by the following sizes. All: Do not filter
         ...
         'Wallpaper'
        :type size: str or ~azure.bing.customimagesearch.models.ImageSize
        ...
        :rtype: ~azure.bing.customimagesearch.models.Images or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.bing.customimagesearch.models.ErrorResponseException>`
        """
        # Construct URL
