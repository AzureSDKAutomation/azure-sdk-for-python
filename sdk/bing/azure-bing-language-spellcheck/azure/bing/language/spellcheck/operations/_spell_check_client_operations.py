...
class SpellCheckClientOperationsMixin(object):
    ...
    def spell_checker(
        ...
        :type action_type: str or
         ~azure.bing.language.spellcheck.models.ActionType
        ...
        :type mode: str or ~azure.bing.language.spellcheck.models.Mode
        ...
        :rtype: ~azure.bing.language.spellcheck.models.SpellCheck or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.bing.language.spellcheck.models.ErrorResponseException>`
        """
