...
class Error(Model):
    ...
    :param code: Required. The error code that identifies the category of
     ...
     Default value: "None" .
    :type code: str or ~azure.bing.language.spellcheck.models.ErrorCode
    ...
    :vartype sub_code: str or
     ~azure.bing.language.spellcheck.models.ErrorSubCode
...
class ErrorResponse(Response):
    ...
    :param errors: Required. A list of errors that describe the reasons why
     the request failed.
    :type errors: list[~azure.bing.language.spellcheck.models.Error]
    """
...
class SpellCheck(Answer):
    ...
    :type flagged_tokens:
     list[~azure.bing.language.spellcheck.models.SpellingFlaggedToken]
    """
...
class SpellingFlaggedToken(Model):
    ...
    :type type: str or ~azure.bing.language.spellcheck.models.ErrorType
    :ivar suggestions:
    :vartype suggestions:
     list[~azure.bing.language.spellcheck.models.SpellingTokenSuggestion]
