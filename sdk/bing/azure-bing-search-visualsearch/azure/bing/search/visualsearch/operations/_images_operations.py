...
class ImagesOperations(object):
    ...
    def visual_search(
        ...
        :type safe_search: str or
         ~azure.bing.search.visualsearch.models.SafeSearch
        ...
        :rtype: ~azure.bing.search.visualsearch.models.ImageKnowledge or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.bing.search.visualsearch.models.ErrorResponseException>`
        """
        # Construct URL
