...
class Thing(Response):
    ...
    :vartype image: ~azure.bing.search.customimagesearch.models.ImageObject
...
class CreativeWork(Thing):
    ...
    :vartype provider: list[~azure.bing.search.customimagesearch.models.Thing]
...
class Error(Model):
    ...
    :param code: Required. The error code that identifies the category of
     ...
     Default value: "None" .
    :type code: str or ~azure.bing.search.customimagesearch.models.ErrorCode
    ...
    :vartype sub_code: str or
     ~azure.bing.search.customimagesearch.models.ErrorSubCode
...
class ErrorResponse(Response):
    ...
    :param errors: Required. A list of errors that describe the reasons why
     the request failed.
    :type errors: list[~azure.bing.search.customimagesearch.models.Error]
    """
...
class ImageObject(MediaObject):
    ...
    :vartype thumbnail:
     ~azure.bing.search.customimagesearch.models.ImageObject
...
class Images(SearchResultsAnswer):
    ...
    :type value: list[~azure.bing.search.customimagesearch.models.ImageObject]
    """
