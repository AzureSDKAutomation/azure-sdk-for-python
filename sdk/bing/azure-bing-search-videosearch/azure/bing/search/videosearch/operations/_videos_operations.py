...
class VideosOperations(object):
    ...
    def search(
        ...
        :type freshness: str or
         ~azure.bing.search.videosearch.models.Freshness
        ...
        :type length: str or ~azure.bing.search.videosearch.models.VideoLength
        ...
        :type pricing: str or
         ~azure.bing.search.videosearch.models.VideoPricing
        ...
        :type resolution: str or
         ~azure.bing.search.videosearch.models.VideoResolution
        ...
        :type safe_search: str or
         ~azure.bing.search.videosearch.models.SafeSearch
        ...
        :type text_format: str or
         ~azure.bing.search.videosearch.models.TextFormat
        ...
        :rtype: ~azure.bing.search.videosearch.models.Videos or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.bing.search.videosearch.models.ErrorResponseException>`
        """
        # Construct URL
    ...
    def details(
        ...
        :type modules: list[str or
         ~azure.bing.search.videosearch.models.VideoInsightModule]
        :param market: The market where the results come from. Typically, mkt
         is the country where the user is making the request from. However, it
         could be a different country if the user is not located in a country
         where Bing delivers results. The market must be in the form <language
        ...
        :rtype: ~azure.bing.search.videosearch.models.VideoDetails or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.bing.search.videosearch.models.ErrorResponseException>`
        """
    ...
    def trending(
        ...
        :rtype: ~azure.bing.search.videosearch.models.TrendingVideos or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.bing.search.videosearch.models.ErrorResponseException>`
        """
