...
class ResponseBase(Model):
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
...
class Identifiable(ResponseBase):
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(Identifiable, self).__init__(_type=_type, **kwargs)
        self.id = None
...
class Response(Identifiable):
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(Response, self).__init__(_type=_type, **kwargs)
        self.read_link = None
...
class Thing(Response):
    ...
    :vartype image: ~azure.bing.imagesearch.models.ImageObject
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(Thing, self).__init__(_type=_type, **kwargs)
        self.name = None
        self.url = None
        self.image = None
...
class Offer(Thing):
    ...
    :vartype seller: ~azure.bing.imagesearch.models.Organization
    ...
    :ivar price_currency: The monetary currency. For example, USD. Possible
     ...
     'YER', 'ZAR', 'ZMW'
    :vartype price_currency: str or ~azure.bing.imagesearch.models.Currency
    ...
    :vartype availability: str or
     ~azure.bing.imagesearch.models.ItemAvailability
    :ivar aggregate_rating: An aggregated rating that indicates how well the
     product has been rated by others.
    :vartype aggregate_rating: ~azure.bing.imagesearch.models.AggregateRating
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(Offer, self).__init__(_type=_type, **kwargs)
        self.seller = None
        self.price = None
...
class AggregateOffer(Offer):
    ...
    :ivar offers: A list of offers from merchants that have offerings related
     to the image.
    :vartype offers: list[~azure.bing.imagesearch.models.Offer]
    """
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(AggregateOffer, self).__init__(_type=_type, **kwargs)
        self.offers = None
...
class Rating(PropertiesItem):
    ...
    def __init__(self, *, rating_value: float, _type: str=None, **kwargs) -> None:
        super(Rating, self).__init__(_type=_type, **kwargs)
...
class AggregateRating(Rating):
    ...
    def __init__(self, *, rating_value: float, _type: str=None, **kwargs) -> None:
        super(AggregateRating, self).__init__(_type=_type, rating_value=rating_value, **kwargs)
...
class Answer(Response):
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(Answer, self).__init__(_type=_type, **kwargs)
...
class CreativeWork(Thing):
    ...
    :vartype provider: list[~azure.bing.imagesearch.models.Thing]
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(CreativeWork, self).__init__(_type=_type, **kwargs)
...
class WebPage(CreativeWork):
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(WebPage, self).__init__(_type=_type, **kwargs)
...
class CollectionPage(WebPage):
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(CollectionPage, self).__init__(_type=_type, **kwargs)
...
class Error(Model):
    ...
    :param code: Required. The error code that identifies the category of
     ...
     Default value: "None" .
    :type code: str or ~azure.bing.imagesearch.models.ErrorCode
    ...
    :vartype sub_code: str or ~azure.bing.imagesearch.models.ErrorSubCode
...
class ErrorResponse(Response):
    ...
    :param errors: Required. A list of errors that describe the reasons why
     the request failed.
    :type errors: list[~azure.bing.imagesearch.models.Error]
    """
    ...
    def __init__(self, *, errors, _type: str=None, **kwargs) -> None:
        super(ErrorResponse, self).__init__(_type=_type, **kwargs)
        self.errors = errors
...
class ImageGallery(CollectionPage):
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(ImageGallery, self).__init__(_type=_type, **kwargs)
        self.source = None
...
class ImageInsights(Response):
    ...
    :vartype best_representative_query: ~azure.bing.imagesearch.models.Query
    :ivar image_caption: The caption to use for the image.
    :vartype image_caption:
     ~azure.bing.imagesearch.models.ImageInsightsImageCaption
    :ivar related_collections: A list of links to webpages that contain
     related images.
    :vartype related_collections:
     ~azure.bing.imagesearch.models.RelatedCollectionsModule
    ...
    :vartype pages_including: ~azure.bing.imagesearch.models.ImagesModule
    ...
    :vartype shopping_sources: ~azure.bing.imagesearch.models.AggregateOffer
    :ivar related_searches: A list of related queries made by others.
    :vartype related_searches:
     ~azure.bing.imagesearch.models.RelatedSearchesModule
    :ivar recipes: A list of recipes related to the image. For example, if the
     ...
     pie.
    :vartype recipes: ~azure.bing.imagesearch.models.RecipesModule
    ...
    :vartype visually_similar_images:
     ~azure.bing.imagesearch.models.ImagesModule
    ...
    :vartype recognized_entity_groups:
     ~azure.bing.imagesearch.models.RecognizedEntitiesModule
    ...
    :vartype image_tags: ~azure.bing.imagesearch.models.ImageTagsModule
    """
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(ImageInsights, self).__init__(_type=_type, **kwargs)
...
class ImageInsightsImageCaption(Model):
    ...
    :param related_searches: Required. A list of entities found in the
     ...
     entity.
    :type related_searches: list[~azure.bing.imagesearch.models.Query]
    """
...
class MediaObject(CreativeWork):
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(MediaObject, self).__init__(_type=_type, **kwargs)
...
class ImageObject(MediaObject):
    ...
    :vartype thumbnail: ~azure.bing.imagesearch.models.ImageObject
    ...
    :vartype insights_metadata:
     ~azure.bing.imagesearch.models.ImagesImageMetadata
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(ImageObject, self).__init__(_type=_type, **kwargs)
        self.thumbnail = None
        self.image_insights_token = None
...
class SearchResultsAnswer(Answer):
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(SearchResultsAnswer, self).__init__(_type=_type, **kwargs)
...
class Images(SearchResultsAnswer):
    ...
    :type value: list[~azure.bing.imagesearch.models.ImageObject]
    ...
    :vartype query_expansions: list[~azure.bing.imagesearch.models.Query]
    ...
    :vartype pivot_suggestions:
     list[~azure.bing.imagesearch.models.PivotSuggestions]
    :ivar similar_terms: A list of terms that are similar in meaning to the
     user's query term.
    :vartype similar_terms: list[~azure.bing.imagesearch.models.Query]
    """
    ...
    def __init__(self, *, value, _type: str=None, **kwargs) -> None:
        super(Images, self).__init__(_type=_type, **kwargs)
...
class ImagesImageMetadata(Model):
    ...
    :vartype aggregate_offer: ~azure.bing.imagesearch.models.AggregateOffer
    """
...
class ImagesModule(Model):
    ...
    :vartype value: list[~azure.bing.imagesearch.models.ImageObject]
    """
...
class ImageTagsModule(Model):
    ...
    :type value: list[~azure.bing.imagesearch.models.InsightsTag]
    """
...
class Intangible(Thing):
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(Intangible, self).__init__(_type=_type, **kwargs)
...
class StructuredValue(Intangible):
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(StructuredValue, self).__init__(_type=_type, **kwargs)
...
class NormalizedRectangle(StructuredValue):
    ...
    def __init__(self, *, left: float, top: float, right: float, bottom: float, _type: str=None, **kwargs) -> None:
        super(NormalizedRectangle, self).__init__(_type=_type, **kwargs)
        self.left = left
        self.top = top
        self.right = right
        self.bottom = bottom
...
class Organization(Thing):
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(Organization, self).__init__(_type=_type, **kwargs)
...
class Person(Thing):
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(Person, self).__init__(_type=_type, **kwargs)
        self.job_title = None
...
class PivotSuggestions(Model):
    ...
    :type suggestions: list[~azure.bing.imagesearch.models.Query]
    """
...
class Recipe(CreativeWork):
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(Recipe, self).__init__(_type=_type, **kwargs)
        self.cook_time = None
        self.prep_time = None
...
class RecipesModule(Model):
    ...
    :vartype value: list[~azure.bing.imagesearch.models.Recipe]
    """
...
class RecognizedEntitiesModule(Model):
    ...
    :vartype value: list[~azure.bing.imagesearch.models.RecognizedEntityGroup]
    """
...
class RecognizedEntity(Response):
    ...
    :vartype entity: ~azure.bing.imagesearch.models.Thing
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(RecognizedEntity, self).__init__(_type=_type, **kwargs)
        self.entity = None
...
class RecognizedEntityGroup(Model):
    ...
    :type recognized_entity_regions:
     list[~azure.bing.imagesearch.models.RecognizedEntityRegion]
...
class RecognizedEntityRegion(Response):
    ...
    :vartype region: ~azure.bing.imagesearch.models.NormalizedRectangle
    ...
    :vartype matching_entities:
     list[~azure.bing.imagesearch.models.RecognizedEntity]
    """
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(RecognizedEntityRegion, self).__init__(_type=_type, **kwargs)
        self.region = None
...
class RelatedCollectionsModule(Model):
    ...
    :vartype value: list[~azure.bing.imagesearch.models.ImageGallery]
    """
...
class RelatedSearchesModule(Model):
    ...
    :vartype value: list[~azure.bing.imagesearch.models.Query]
    """
...
class TrendingImages(Response):
    ...
    :type categories:
     list[~azure.bing.imagesearch.models.TrendingImagesCategory]
    """
    ...
    def __init__(self, *, categories, _type: str=None, **kwargs) -> None:
        super(TrendingImages, self).__init__(_type=_type, **kwargs)
...
class TrendingImagesCategory(Model):
    ...
    :param tiles: Required. A list of images that are trending in the
     ...
     that person.
    :type tiles: list[~azure.bing.imagesearch.models.TrendingImagesTile]
    """
...
class TrendingImagesTile(Model):
    ...
    :type query: ~azure.bing.imagesearch.models.Query
    :param image: Required. The image's thumbnail.
    :type image: ~azure.bing.imagesearch.models.ImageObject
    """
