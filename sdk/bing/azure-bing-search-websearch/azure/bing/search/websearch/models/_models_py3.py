...
class Answer(Response):
    ...
    :vartype follow_up_queries:
     list[~azure.bing.search.websearch.models.Query]
    """
...
class Thing(Response):
    ...
    :vartype url: str
    :ivar image:
    :vartype image: ~azure.bing.search.websearch.models.ImageObject
...
class CreativeWork(Thing):
    ...
    :vartype provider: list[~azure.bing.search.websearch.models.Thing]
    :ivar text:
    :vartype text: str
    """
...
class Article(CreativeWork):
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(Article, self).__init__(_type=_type, **kwargs)
...
class Computation(Answer):
    ...
    def __init__(self, *, expression: str, value: str, _type: str=None, **kwargs) -> None:
        super(Computation, self).__init__(_type=_type, **kwargs)
...
class Error(Model):
    ...
    :param code: Required. The error code that identifies the category of
     ...
     Default value: "None" .
    :type code: str or ~azure.bing.search.websearch.models.ErrorCode
    ...
    :vartype sub_code: str or ~azure.bing.search.websearch.models.ErrorSubCode
...
class ErrorResponse(Response):
    ...
    :param errors: Required. A list of errors that describe the reasons why
     the request failed.
    :type errors: list[~azure.bing.search.websearch.models.Error]
    """
...
class ImageObject(MediaObject):
    ...
    :vartype thumbnail: ~azure.bing.search.websearch.models.ImageObject
    """
...
class SearchResultsAnswer(Answer):
    ...
    :vartype follow_up_queries:
     list[~azure.bing.search.websearch.models.Query]
    :ivar query_context:
    :vartype query_context: ~azure.bing.search.websearch.models.QueryContext
...
class Images(SearchResultsAnswer):
    ...
    :type value: list[~azure.bing.search.websearch.models.ImageObject]
    :ivar query_expansions:
    :vartype query_expansions: list[~azure.bing.search.websearch.models.Query]
    :ivar similar_terms:
    :vartype similar_terms: list[~azure.bing.search.websearch.models.Query]
    :ivar related_searches:
    :vartype related_searches: list[~azure.bing.search.websearch.models.Query]
    """
...
class News(SearchResultsAnswer):
    ...
    :type value: list[~azure.bing.search.websearch.models.NewsArticle]
    :ivar location:
    ...
    def __init__(self, *, value, _type: str=None, **kwargs) -> None:
        super(News, self).__init__(_type=_type, **kwargs)
        self.value = value
        self.location = None
...
class NewsArticle(Article):
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(NewsArticle, self).__init__(_type=_type, **kwargs)
...
class Places(SearchResultsAnswer):
    ...
    :param value: Required. A list of local entities, such as restaurants or
     hotels.
    :type value: list[~azure.bing.search.websearch.models.Thing]
    """
    ...
    def __init__(self, *, value, _type: str=None, **kwargs) -> None:
        super(Places, self).__init__(_type=_type, **kwargs)
        self.value = value
...
class RankingRankingGroup(Model):
    ...
    :param items: Required. A list of search result items to display in the
     group.
    :type items: list[~azure.bing.search.websearch.models.RankingRankingItem]
    """
...
class RankingRankingItem(Model):
    ...
    :type answer_type: str or ~azure.bing.search.websearch.models.AnswerType
    ...
    :ivar value: The ID that identifies either an answer to display or an item
     ...
     of the answer.
    :vartype value: ~azure.bing.search.websearch.models.Identifiable
    :ivar html_index:
...
class RankingRankingResponse(Model):
    ...
    :vartype pole: ~azure.bing.search.websearch.models.RankingRankingGroup
    :ivar mainline: The search results to display in the mainline.
    :vartype mainline: ~azure.bing.search.websearch.models.RankingRankingGroup
    :ivar sidebar: The search results to display in the sidebar.
    :vartype sidebar: ~azure.bing.search.websearch.models.RankingRankingGroup
    """
...
class RelatedSearchesRelatedSearchAnswer(SearchResultsAnswer):
    ...
    :param value: Required. A list of related queries that were made by
     others.
    :type value: list[~azure.bing.search.websearch.models.Query]
    """
    ...
    def __init__(self, *, value, _type: str=None, **kwargs) -> None:
        super(RelatedSearchesRelatedSearchAnswer, self).__init__(_type=_type, **kwargs)
        self.value = value
...
class SearchResponse(Response):
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(SearchResponse, self).__init__(_type=_type, **kwargs)
        self.query_context = None
        self.web_pages = None
        self.images = None
        self.news = None
...
class SpellSuggestions(SearchResultsAnswer):
    ...
    def __init__(self, *, value, _type: str=None, **kwargs) -> None:
        super(SpellSuggestions, self).__init__(_type=_type, **kwargs)
        self.value = value
...
class TimeZone(SearchResultsAnswer):
    ...
    :type primary_city_time:
     ~azure.bing.search.websearch.models.TimeZoneTimeZoneInformation
    :ivar other_city_times: A list of dates and times of nearby time zones.
    :vartype other_city_times:
     list[~azure.bing.search.websearch.models.TimeZoneTimeZoneInformation]
    """
    ...
    def __init__(self, *, primary_city_time, _type: str=None, **kwargs) -> None:
        super(TimeZone, self).__init__(_type=_type, **kwargs)
...
class VideoObject(MediaObject):
    ...
    def __init__(self, *, _type: str=None, **kwargs) -> None:
        super(VideoObject, self).__init__(_type=_type, **kwargs)
...
class Videos(SearchResultsAnswer):
    ...
    :param value: Required. A list of video objects that are relevant to the
     query.
    :type value: list[~azure.bing.search.websearch.models.VideoObject]
    :ivar next_offset:
    :vartype next_offset: int
    :ivar query_expansions:
    :vartype query_expansions: list[~azure.bing.search.websearch.models.Query]
    ...
    def __init__(self, *, value, _type: str=None, **kwargs) -> None:
        super(Videos, self).__init__(_type=_type, **kwargs)
        self.value = value
        self.next_offset = None
        self.query_expansions = None
        self.related_searches = None
...
class WebPage(CreativeWork):
    ...
    :vartype deep_links: list[~azure.bing.search.websearch.models.WebPage]
    ...
    :ivar search_tags: A list of search tags that the webpage owner specified
     ...
     the tag's value.
    :vartype search_tags: list[~azure.bing.search.websearch.models.WebMetaTag]
    :ivar primary_image_of_page:
    :vartype primary_image_of_page:
     ~azure.bing.search.websearch.models.ImageObject
    """
...
class WebWebAnswer(SearchResultsAnswer):
    ...
    :type value: list[~azure.bing.search.websearch.models.WebPage]
    ...
    def __init__(self, *, value, _type: str=None, **kwargs) -> None:
        super(WebWebAnswer, self).__init__(_type=_type, **kwargs)
        self.value = value
...
class WebWebGrouping(Model):
    ...
    :type web_pages: list[~azure.bing.search.websearch.models.WebPage]
