...
class WebOperations(object):
    ...
    def search(
        ...
        :param freshness: Filter search results by the following age values:
         ...
         'Month'
        :type freshness: str or ~azure.bing.search.websearch.models.Freshness
        ...
        :type promote: list[str or
         ~azure.bing.search.websearch.models.AnswerType]
        ...
        :type safe_search: str or
         ~azure.bing.search.websearch.models.SafeSearch
        ...
        :type text_format: str or
         ~azure.bing.search.websearch.models.TextFormat
        ...
        :rtype: ~azure.bing.search.websearch.models.SearchResponse or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.bing.search.websearch.models.ErrorResponseException>`
        """
        # Construct URL
