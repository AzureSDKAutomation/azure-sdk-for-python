...
class VideosOperations(object):
    ...
    def search(
        ...
        :param freshness: Filter videos by the date and time that Bing
         ...
         'Week', 'Month'
        :type freshness: str or ~azure.bing.videosearch.models.Freshness
        ...
        :type length: str or ~azure.bing.videosearch.models.VideoLength
        ...
        :type pricing: str or ~azure.bing.videosearch.models.VideoPricing
        ...
        :type resolution: str or
         ~azure.bing.videosearch.models.VideoResolution
        ...
        :type safe_search: str or ~azure.bing.videosearch.models.SafeSearch
        ...
        :type text_format: str or ~azure.bing.videosearch.models.TextFormat
        ...
        :rtype: ~azure.bing.videosearch.models.Videos or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.bing.videosearch.models.ErrorResponseException>`
        """
        # Construct URL
    ...
    def details(
        ...
        :type modules: list[str or
         ~azure.bing.videosearch.models.VideoInsightModule]
        :param market: The market where the results come from. Typically, mkt
         is the country where the user is making the request from. However, it
         could be a different country if the user is not located in a country
         where Bing delivers results. The market must be in the form <language
        ...
        :rtype: ~azure.bing.videosearch.models.VideoDetails or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.bing.videosearch.models.ErrorResponseException>`
        """
    ...
    def trending(
        ...
        :rtype: ~azure.bing.videosearch.models.TrendingVideos or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.bing.videosearch.models.ErrorResponseException>`
        """
