...
class EntitiesOperations(object):
    ...
    def search(
        ...
        :type response_filter: list[str or
         ~azure.bing.search.entitysearch.models.AnswerType]
        ...
        :type response_format: list[str or
         ~azure.bing.search.entitysearch.models.ResponseFormat]
        ...
        :type safe_search: str or
         ~azure.bing.search.entitysearch.models.SafeSearch
        ...
        :rtype: ~azure.bing.search.entitysearch.models.SearchResponse or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.bing.search.entitysearch.models.ErrorResponseException>`
        """
        # Construct URL
