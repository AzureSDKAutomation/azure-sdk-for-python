...
class CustomInstanceOperations(object):
    ...
    def search(
        ...
        :type safe_search: str or
         ~azure.bing.search.customsearch.models.SafeSearch
        ...
        :type text_format: str or
         ~azure.bing.search.customsearch.models.TextFormat
        ...
        :rtype: ~azure.bing.search.customsearch.models.SearchResponse or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.bing.search.customsearch.models.ErrorResponseException>`
        """
        # Construct URL
