...
class Answer(Response):
    ...
    :vartype follow_up_queries:
     list[~azure.bing.search.customsearch.models.Query]
    """
...
class CreativeWork(Thing):
    ...
    :vartype provider: list[~azure.bing.search.customsearch.models.Thing]
    :ivar text:
    :vartype text: str
    """
...
class Error(Model):
    ...
    :param code: Required. The error code that identifies the category of
     ...
     Default value: "None" .
    :type code: str or ~azure.bing.search.customsearch.models.ErrorCode
    ...
    :vartype sub_code: str or
     ~azure.bing.search.customsearch.models.ErrorSubCode
...
class ErrorResponse(Response):
    ...
    :param errors: Required. A list of errors that describe the reasons why
     the request failed.
    :type errors: list[~azure.bing.search.customsearch.models.Error]
    """
...
class SearchResponse(Response):
    ...
    :vartype query_context:
     ~azure.bing.search.customsearch.models.QueryContext
    :ivar web_pages: A list of webpages that are relevant to the search query.
    :vartype web_pages: ~azure.bing.search.customsearch.models.WebWebAnswer
    """
...
class WebPage(CreativeWork):
    ...
    :vartype deep_links: list[~azure.bing.search.customsearch.models.WebPage]
    ...
    :ivar search_tags: A list of search tags that the webpage owner specified
     ...
     the tag's value.
    :vartype search_tags:
     list[~azure.bing.search.customsearch.models.WebMetaTag]
    """
...
class WebWebAnswer(SearchResultsAnswer):
    ...
    :type value: list[~azure.bing.search.customsearch.models.WebPage]
