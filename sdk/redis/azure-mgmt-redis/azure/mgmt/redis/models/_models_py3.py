...
class RedisCommonProperties(Model):
    ...
    :param public_network_access: Whether or not public endpoint access is
     ...
     exclusive access method. Default value is 'Disabled'. Possible values
    ...
    def __init__(self, *, redis_configuration=None, enable_non_ssl_port: bool=None, replicas_per_master: int=None, tenant_settings=None, shard_count: int=None, minimum_tls_version=None, public_network_access="Disabled", **kwargs) -> None:
...
class RedisCreateParameters(Model):
    ...
    def __init__(self, *, sku, location: str, redis_configuration=None, enable_non_ssl_port: bool=None, replicas_per_master: int=None, tenant_settings=None, shard_count: int=None, minimum_tls_version=None, public_network_access="Disabled", subnet_id: str=None, static_ip: str=None, zones=None, tags=None, **kwargs) -> None:
...
class RedisCreateProperties(RedisCommonProperties):
    ...
    def __init__(self, *, sku, redis_configuration=None, enable_non_ssl_port: bool=None, replicas_per_master: int=None, tenant_settings=None, shard_count: int=None, minimum_tls_version=None, public_network_access="Disabled", subnet_id: str=None, static_ip: str=None, **kwargs) -> None:
...
class RedisForceRebootResponseException(HttpOperationError):
    """Server responsed with exception of type: 'RedisForceRebootResponse'.
    ...
    def __init__(self, deserialize, response, *args):
        ...
        super(RedisForceRebootResponseException, self).__init__(deserialize, response, 'RedisForceRebootResponse', *args)
...
class RedisResource(TrackedResource):
    ...
    def __init__(self, *, location: str, sku, tags=None, redis_configuration=None, enable_non_ssl_port: bool=None, replicas_per_master: int=None, tenant_settings=None, shard_count: int=None, minimum_tls_version=None, public_network_access="Disabled", subnet_id: str=None, static_ip: str=None, zones=None, **kwargs) -> None:
...
class RedisUpdateParameters(Model):
    ...
    def __init__(self, *, redis_configuration=None, enable_non_ssl_port: bool=None, replicas_per_master: int=None, tenant_settings=None, shard_count: int=None, minimum_tls_version=None, public_network_access="Disabled", sku=None, tags=None, **kwargs) -> None:
