...
class RedisCreateParameters(Model):
    ...
    :param redis_version: Redis version. Valid values: (4, 6)
    ...
    def __init__(self, *, sku, location: str, redis_configuration=None, enable_non_ssl_port: bool=None, replicas_per_master: int=None, tenant_settings=None, shard_count: int=None, minimum_tls_version=None, public_network_access=None, redis_version: str=None, subnet_id: str=None, static_ip: str=None, zones=None, tags=None, **kwargs) -> None:
...
class RedisCreateProperties(RedisCommonProperties):
    ...
    def __init__(self, *, sku, redis_configuration=None, enable_non_ssl_port: bool=None, replicas_per_master: int=None, tenant_settings=None, shard_count: int=None, minimum_tls_version=None, public_network_access=None, redis_version: str=None, subnet_id: str=None, static_ip: str=None, **kwargs) -> None:
...
class RedisResource(TrackedResource):
    ...
    def __init__(self, *, location: str, sku, tags=None, redis_configuration=None, enable_non_ssl_port: bool=None, replicas_per_master: int=None, tenant_settings=None, shard_count: int=None, minimum_tls_version=None, public_network_access=None, redis_version: str=None, subnet_id: str=None, static_ip: str=None, zones=None, **kwargs) -> None:
