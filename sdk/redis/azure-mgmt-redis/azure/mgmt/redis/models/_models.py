...
class RedisCommonPropertiesRedisConfiguration(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.notify_keyspace_events = kwargs.get('notify_keyspace_events', None)
        self.hash_max_ziplist_entries = kwargs.get('hash_max_ziplist_entries', None)
        self.hash_max_ziplist_value = kwargs.get('hash_max_ziplist_value', None)
        self.set_max_intset_entries = kwargs.get('set_max_intset_entries', None)
        self.zset_max_ziplist_entries = kwargs.get('zset_max_ziplist_entries', None)
        self.zset_max_ziplist_value = kwargs.get('zset_max_ziplist_value', None)
