...
class RedisOperations(object):
    ...
    def force_reboot(
        ...
        :rtype: ~azure.mgmt.redis.models.RedisForceRebootResponse or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`RedisForceRebootResponseException<azure.mgmt.redis.models.RedisForceRebootResponseException>`
        """
        # Construct URL
        ...
        if response.status_code not in [200]:
            raise models.RedisForceRebootResponseException(self._deserialize, response)
