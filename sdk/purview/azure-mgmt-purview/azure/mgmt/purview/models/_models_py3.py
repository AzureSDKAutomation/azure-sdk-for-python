...
class Account(TrackedResource):
    ...
    :param public_network_access: Gets or sets the public network access.
    ...
    def __init__(self, *, identity=None, location: str=None, tags=None, cloud_connectors=None, public_network_access=None, sku=None, **kwargs) -> None:
...
class AccountUpdateParameters(Model):
    ...
    def __init__(self, *, cloud_connectors=None, public_network_access=None, tags=None, **kwargs) -> None:
