...
class Baseline(Model):
    ...
    def __init__(self, *, sensitivity, low_thresholds, high_thresholds, timestamps=None, prediction_result_type: int=None, error_type: int=None, **kwargs) -> None:
...
class BaselineResponse(Model):
    ...
    def __init__(self, *, timestamps=None, baseline=None, metdata=None, prediction_result_type: int=None, error_type: int=None, timespan: str=None, interval=None, aggregation: str=None, **kwargs) -> None:
...
class CalculateBaselineResponse(Model):
    ...
    def __init__(self, *, type: str, baseline, timestamps=None, statistics=None, **kwargs) -> None:
...
class CalculateBaselineResponseStatistics(Model):
    ...
    def __init__(self, *, is_eligible: bool=None, status=None, seasonality_period: int=None, **kwargs) -> None:
