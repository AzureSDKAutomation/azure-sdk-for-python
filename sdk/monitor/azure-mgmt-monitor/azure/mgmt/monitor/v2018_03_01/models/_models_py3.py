...
class MetricAlertAction(Model):
    ...
    :param web_hook_properties: This field allows specifying custom
     properties, which would be appended to the alert payload sent as input to
     the webhook.
...
class MetricAlertResource(Resource):
    ...
    :param enabled: Required. the flag that indicates whether the metric alert
     is enabled.
    :type enabled: bool
    :param scopes: Required. the list of resource id's that this metric alert
     is scoped to.
    ...
    :param target_resource_type: the resource type of the target resource(s)
     on which the alert is created/updated. Mandatory if the scope contains a
    ...
    :param target_resource_region: the region of the target resource(s) on
     which the alert is created/updated. Mandatory if the scope contains a
     subscription, resource group, or more than one resource.
    ...
    :ivar is_migrated: the value indicating whether this alert rule is
     migrated.
    ...
    def __init__(self, *, location: str, severity: int, enabled: bool, scopes, evaluation_frequency, window_size, criteria, tags=None, description: str=None, target_resource_type: str=None, target_resource_region: str=None, auto_mitigate: bool=None, actions=None, **kwargs) -> None:
...
class MetricAlertResourcePatch(Model):
    ...
    def __init__(self, *, tags=None, description: str=None, severity: int=None, enabled: bool=None, scopes=None, evaluation_frequency=None, window_size=None, target_resource_type: str=None, target_resource_region: str=None, criteria=None, auto_mitigate: bool=None, actions=None, **kwargs) -> None:
