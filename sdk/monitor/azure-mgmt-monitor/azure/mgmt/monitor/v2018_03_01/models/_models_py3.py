...
class MetricAlertResource(Resource):
    ...
    def __init__(self, *, location: str, severity: int, enabled: bool, evaluation_frequency, window_size, criteria, tags=None, description: str=None, scopes=None, target_resource_type: str=None, target_resource_region: str=None, auto_mitigate: bool=None, actions=None, **kwargs) -> None:
