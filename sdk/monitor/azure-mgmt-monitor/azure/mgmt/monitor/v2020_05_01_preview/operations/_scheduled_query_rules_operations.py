...
class ScheduledQueryRulesOperations(object):
    ...
    :ivar api_version: The API version to use for this operation. Constant value: "2020-05-01-preview".
    """
    ...
    def list_by_subscription(
        ...
        if raw:
            header_dict = {}
        deserialized = models.ScheduledQueryRuleResourcePaged(internal_paging, self._deserialize.dependencies, header_dict)
