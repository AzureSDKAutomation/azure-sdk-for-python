...
class DatabaseAccountCreateUpdateParameters(ARMResourceProperties):
    ...
    :param identity1: The managed service identity for the Cosmos DB database
     account.
    :type identity1: ~azure.mgmt.cosmosdb.models.ManagedServiceIdentity
    ...
    _attribute_map = {
        ...
        'identity1': {'key': 'properties.identity', 'type': 'ManagedServiceIdentity'},
    ...
    def __init__(self, **kwargs):
        ...
        self.identity1 = kwargs.get('identity1', None)
