...
class AnalyticalStorageConfig(Model):
    """Analytical storage specific properties.

    :param schema_type: Possible values include: 'WellDefined', 'FullFidelity'
    :type schema_type: str or
     ~azure.mgmt.cosmosdb.models.AnalyticalStorageSchemaType
    """
    ...
    def __init__(self, *, schema_type=None, **kwargs) -> None:
        super(AnalyticalStorageConfig, self).__init__(**kwargs)
...
class DatabaseAccountCreateUpdateParameters(ARMResourceProperties):
    ...
    :param analytical_storage_config: Analytical storage specific properties.
    :type analytical_storage_config:
     ~azure.mgmt.cosmosdb.models.AnalyticalStorageConfig
    ...
    _attribute_map = {
        ...
        'analytical_storage_config': {'key': 'properties.analyticalStorageConfig', 'type': 'AnalyticalStorageConfig'},
    ...
    def __init__(self, *, locations, location: str=None, tags=None, kind="GlobalDocumentDB", consistency_policy=None, ip_rules=None, is_virtual_network_filter_enabled: bool=None, enable_automatic_failover: bool=None, capabilities=None, virtual_network_rules=None, enable_multiple_write_locations: bool=None, enable_cassandra_connector: bool=None, connector_offer=None, disable_key_based_metadata_write_access: bool=None, key_vault_key_uri: str=None, public_network_access=None, enable_free_tier: bool=None, api_properties=None, enable_analytical_storage: bool=None, analytical_storage_config=None, backup_policy=None, cors=None, **kwargs) -> None:
        ...
        self.analytical_storage_config = analytical_storage_config
...
class DatabaseAccountGetResults(ARMResourceProperties):
    ...
    def __init__(self, *, location: str=None, tags=None, kind="GlobalDocumentDB", provisioning_state: str=None, ip_rules=None, is_virtual_network_filter_enabled: bool=None, enable_automatic_failover: bool=None, consistency_policy=None, capabilities=None, virtual_network_rules=None, enable_multiple_write_locations: bool=None, enable_cassandra_connector: bool=None, connector_offer=None, disable_key_based_metadata_write_access: bool=None, key_vault_key_uri: str=None, public_network_access=None, enable_free_tier: bool=None, api_properties=None, enable_analytical_storage: bool=None, analytical_storage_config=None, backup_policy=None, cors=None, **kwargs) -> None:
...
class DatabaseAccountUpdateParameters(Model):
    ...
    def __init__(self, *, tags=None, location: str=None, consistency_policy=None, locations=None, ip_rules=None, is_virtual_network_filter_enabled: bool=None, enable_automatic_failover: bool=None, capabilities=None, virtual_network_rules=None, enable_multiple_write_locations: bool=None, enable_cassandra_connector: bool=None, connector_offer=None, disable_key_based_metadata_write_access: bool=None, key_vault_key_uri: str=None, public_network_access=None, enable_free_tier: bool=None, api_properties=None, enable_analytical_storage: bool=None, analytical_storage_config=None, backup_policy=None, cors=None, **kwargs) -> None:
