...
class RoleAssignmentPropertiesWithScope(Model):
    ...
    def __init__(self, *, scope: str=None, role_definition_id: str=None, principal_id: str=None, created_on=None, updated_on=None, created_by: str=None, updated_by: str=None, **kwargs) -> None:
