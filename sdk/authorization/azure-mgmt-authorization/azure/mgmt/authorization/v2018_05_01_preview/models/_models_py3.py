...
class AccessReviewInstanceDecisionCount(Model):
    """Access Review Instance Decision Count.

    :param count: The count of records with decision = {decision}.
    :type count: int
    :param decision: The reviewer's decision type. This can be one of
     NotReviewed, Approve and Deny. Possible values include: 'Approve', 'Deny',
     'NotReviewed', 'DontKnow', 'NotNotified'
    :type decision: str or
     ~azure.mgmt.authorization.v2018_05_01_preview.models.AccessReviewInstanceDecisionType
    """
    ...
    def __init__(self, *, count: int=None, decision=None, **kwargs) -> None:
        super(AccessReviewInstanceDecisionCount, self).__init__(**kwargs)
        self.count = count
        self.decision = decision


class AccessReviewInstanceRecommendationCount(Model):
    """Access Review Instance Decision Count.

    Variables are only populated by the server, and will be ignored when
    sending a request.

    :param count: The count of records with recommendation = {recommendation}.
    :type count: int
    :ivar recommendation: The feature-generated recommendation shown to the
     reviewer. Possible values include: 'Approve', 'Deny', 'NoInfoAvailable'
    :vartype recommendation: str or
     ~azure.mgmt.authorization.v2018_05_01_preview.models.AccessReviewInstanceRecommendationType
    """
    ...
    def __init__(self, *, count: int=None, **kwargs) -> None:
        super(AccessReviewInstanceRecommendationCount, self).__init__(**kwargs)
        self.count = count
        self.recommendation = None


class AccessReviewInstanceStatistics(Model):
    """Access Review Instance properties.

    :param total_count: The total count of instance statistics.
    :type total_count: int
    :param value: Access Review Instance Decision Summary list.
    :type value:
     list[~azure.mgmt.authorization.v2018_05_01_preview.models.AccessReviewInstanceDecisionCount]
    :param value1: Access Review Instance Recommendations Summary list.
    :type value1:
     list[~azure.mgmt.authorization.v2018_05_01_preview.models.AccessReviewInstanceRecommendationCount]
    """

    _attribute_map = {
        'total_count': {'key': 'totalCount', 'type': 'int'},
        'value': {'key': 'decisionsSummary.value', 'type': '[AccessReviewInstanceDecisionCount]'},
        'value1': {'key': 'recommendationsSummary.value', 'type': '[AccessReviewInstanceRecommendationCount]'},
    }

    def __init__(self, *, total_count: int=None, value=None, value1=None, **kwargs) -> None:
        super(AccessReviewInstanceStatistics, self).__init__(**kwargs)
