...
class AccessReviewScheduleDefinition(Model):
    ...
    :ivar user_principal_name: The user principal name(if valid)
    :vartype user_principal_name: str
    :param created_date_time: Time it was created
    :type created_date_time: datetime
    :param last_modified_date_time: Time it was last modified
    ...
    :param backup_reviewers: This is the collection of reviewers.
    ...
    def __init__(self, *, display_name: str=None, description_for_admins: str=None, description_for_reviewers: str=None, created_date_time=None, last_modified_date_time=None, mail_notifications_enabled: bool=None, reminder_notifications_enabled: bool=None, default_decision_enabled: bool=None, justification_required_on_approval: bool=None, default_decision=None, auto_apply_decisions_enabled: bool=None, recommendations_enabled: bool=None, instance_duration_in_days: int=None, type1=None, interval: int=None, type2=None, number_of_occurrences: int=None, start_date=None, end_date=None, reviewers=None, backup_reviewers=None, instances=None, **kwargs) -> None:
