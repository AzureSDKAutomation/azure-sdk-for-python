...
try:
    ...
    from ._models_py3 import AccessReviewInstanceDecisionCount
    from ._models_py3 import AccessReviewInstanceRecommendationCount
    from ._models_py3 import AccessReviewInstanceStatistics
    ...
    from ._models import AccessReviewInstanceDecisionCount
    from ._models import AccessReviewInstanceRecommendationCount
    from ._models import AccessReviewInstanceStatistics
...
from ._authorization_management_client_enums import (
    ...
    AccessReviewInstanceDecisionType,
    AccessReviewInstanceRecommendationType,
...
__all__ = [
    ...
    'AccessReviewInstanceDecisionCount',
    'AccessReviewInstanceRecommendationCount',
    'AccessReviewInstanceStatistics',
