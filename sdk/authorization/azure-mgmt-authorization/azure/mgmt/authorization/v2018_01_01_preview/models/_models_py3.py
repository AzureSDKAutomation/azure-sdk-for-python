...
class RoleAssignment(Model):
    ...
    :type principal_type: str or
     ~azure.mgmt.authorization.v2018_01_01_preview.models.PrincipalType
    """
    ...
    def __init__(self, *, scope: str=None, role_definition_id: str=None, principal_id: str=None, can_delegate: bool=None, created_on=None, updated_on=None, created_by: str=None, updated_by: str=None, principal_type=None, **kwargs) -> None:
...
class RoleDefinition(Model):
    ...
    def __init__(self, *, role_name: str=None, description: str=None, role_type: str=None, permissions=None, assignable_scopes=None, created_on=None, updated_on=None, created_by: str=None, updated_by: str=None, **kwargs) -> None:
