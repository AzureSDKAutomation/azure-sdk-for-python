...
class RoleAssignmentsOperations(object):
    ...
    def list_for_resource(
        ...
        :rtype:
         ~azure.mgmt.authorization.v2020_04_preview.models.RoleAssignmentPaged[~azure.mgmt.authorization.v2020_04_preview.models.RoleAssignment]
    ...
    def delete(
        ...
        :rtype:
         ~azure.mgmt.authorization.v2020_04_preview.models.RoleAssignment or
    ...
    def create(
        ...
        :type parameters:
         ~azure.mgmt.authorization.v2020_04_preview.models.RoleAssignmentCreateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
