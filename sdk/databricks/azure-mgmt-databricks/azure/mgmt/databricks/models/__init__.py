...
try:
    ...
    from ._models_py3 import ManagedServicesEncryptionEntities
    from ._models_py3 import ManagedServicesEncryptionEntitiesManagedServices
    from ._models_py3 import ManagedServicesEncryptionEntitiesManagedServicesIdentity
    from ._models_py3 import ManagedServicesEncryptionEntitiesManagedServicesKeyVaultProperties
    ...
    from ._models import ManagedServicesEncryptionEntities
    from ._models import ManagedServicesEncryptionEntitiesManagedServices
    from ._models import ManagedServicesEncryptionEntitiesManagedServicesIdentity
    from ._models import ManagedServicesEncryptionEntitiesManagedServicesKeyVaultProperties
