...
class Identity(Model):
    ...
    :param type: The type of identity for workspace. The type 'None' will
     remove any identities assigned to workspace. Possible values include:
     'UserAssigned', 'None'
    :type type: str or ~azure.mgmt.databricks.models.ResourceIdentityType
    :param user_assigned_identities: The list of user identities associated
     with the resource. The user identity dictionary key references will be
     resource ids in the form:
     '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
    :type user_assigned_identities: dict[str,
     ~azure.mgmt.databricks.models.IdentityUserAssignedIdentitiesValue]
    """
...
class ManagedIdentityConfiguration(Model):
    ...
    :param identity: User assigned identity that will be used for Customer
     Managed Key Encryption while accessing Key Vault.
    :type identity: str
    :param type: The type of Identity created. It can be either SystemAssigned
     or UserAssigned. Possible values include: 'SystemAssigned', 'UserAssigned'
    ...
    def __init__(self, *, identity: str=None, type=None, **kwargs) -> None:
...
class Workspace(TrackedResource):
    ...
    :type identity: ~azure.mgmt.databricks.models.Identity
    """
    ...
    def __init__(self, *, location: str, managed_resource_group_id: str, tags=None, parameters=None, ui_definition_uri: str=None, authorizations=None, created_by=None, updated_by=None, created_date_time=None, storage_account_identity=None, sku=None, identity=None, **kwargs) -> None:
