...
class GroupIdInformation(Resource):
    ...
    :type properties:
     ~azure.mgmt.databricks.models.GroupIdInformationProperties
    """
...
class PrivateEndpointConnection(Model):
    ...
    :type properties:
     ~azure.mgmt.databricks.models.PrivateEndpointConnectionProperties
    """
...
class PrivateEndpointConnectionProperties(Model):
    ...
    :param private_endpoint: Private endpoint. Private endpoint
    :type private_endpoint: ~azure.mgmt.databricks.models.PrivateEndpoint
    :param private_link_service_connection_state: Required. Private link
     service service connection state. Private endpoint connection state
...
class PrivateLinkServiceConnectionState(Model):
    ...
    :type status: str or
     ~azure.mgmt.databricks.models.PrivateLinkServiceConnectionStatus
    :param description: The description for the current state of a private
     endpoint connection
    ...
    def __init__(self, *, status, description: str=None, action_required: str=None, **kwargs) -> None:
...
class Workspace(TrackedResource):
    ...
    :ivar private_endpoint_connections: Private endpoint connections created
     on the workspace
    ...
    :type public_network_access: str or
     ~azure.mgmt.databricks.models.PublicNetworkAccess
    :param required_nsg_rules: Gets or sets a value indicating data plane to
     control plane communication. Possible values are 'AllRules' and
     'NoAzureDatabricksRules'. Possible values include: 'AllRules',
     'NoAzureDatabricksRules'
    :type required_nsg_rules: str or
     ~azure.mgmt.databricks.models.RequiredNsgRules
    ...
    def __init__(self, *, location: str, managed_resource_group_id: str, tags=None, parameters=None, ui_definition_uri: str=None, authorizations=None, created_by=None, updated_by=None, created_date_time=None, storage_account_identity=None, public_network_access=None, required_nsg_rules=None, sku=None, **kwargs) -> None:
