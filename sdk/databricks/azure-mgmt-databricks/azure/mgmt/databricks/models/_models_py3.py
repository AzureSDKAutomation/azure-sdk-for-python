...
class ManagedServicesEncryptionEntities(Model):
    """Provides the details for the encryption of the entities owned by the
    service. E.g: notebooks.

    :param managed_services: Encryption details for managed services
    :type managed_services:
     ~azure.mgmt.databricks.models.ManagedServicesEncryptionEntitiesManagedServices
    """

    _attribute_map = {
        'managed_services': {'key': 'managedServices', 'type': 'ManagedServicesEncryptionEntitiesManagedServices'},
    }

    def __init__(self, *, managed_services=None, **kwargs) -> None:
        super(ManagedServicesEncryptionEntities, self).__init__(**kwargs)
        self.managed_services = managed_services


class ManagedServicesEncryptionEntitiesManagedServices(Model):
    """Encryption details for managed services.

    All required parameters must be populated in order to send to Azure.

    :param key_source: Required. The encryption keySource (provider). Possible
     values (case-insensitive):  Default, Microsoft.Keyvault. Possible values
     include: 'Default', 'Microsoft.Keyvault'. Default value: "Default" .
    :type key_source: str or ~azure.mgmt.databricks.models.KeySource
    :param key_vault_properties: Details of the keyvault from which to fetch
     the encryption keys
    :type key_vault_properties:
     ~azure.mgmt.databricks.models.ManagedServicesEncryptionEntitiesManagedServicesKeyVaultProperties
    :param identity: Identity used to access the secret from the keyvault for
     encryption.
    :type identity:
     ~azure.mgmt.databricks.models.ManagedServicesEncryptionEntitiesManagedServicesIdentity
    """
    ...
    _attribute_map = {
        'key_source': {'key': 'keySource', 'type': 'str'},
        'key_vault_properties': {'key': 'keyVaultProperties', 'type': 'ManagedServicesEncryptionEntitiesManagedServicesKeyVaultProperties'},
        'identity': {'key': 'identity', 'type': 'ManagedServicesEncryptionEntitiesManagedServicesIdentity'},
    }

    def __init__(self, *, key_source="Default", key_vault_properties=None, identity=None, **kwargs) -> None:
        super(ManagedServicesEncryptionEntitiesManagedServices, self).__init__(**kwargs)
        self.key_source = key_source
        self.key_vault_properties = key_vault_properties
        self.identity = identity


class ManagedServicesEncryptionEntitiesManagedServicesIdentity(Model):
    """Identity used to access the secret from the keyvault for encryption.

    All required parameters must be populated in order to send to Azure.

    :param type: Required. The type of identity to be used. Possible values
     include: 'None', 'UserAssigned'
    :type type: str or ~azure.mgmt.databricks.models.Type
    :param identity: The resource id of the identity to be used.
    :type identity: str
    """
    ...
    def __init__(self, *, type, identity: str=None, **kwargs) -> None:
        super(ManagedServicesEncryptionEntitiesManagedServicesIdentity, self).__init__(**kwargs)
        self.type = type
        self.identity = identity


class ManagedServicesEncryptionEntitiesManagedServicesKeyVaultProperties(Model):
    ...
    def __init__(self, *, key_vault_uri: str, key_name: str, key_version: str=None, **kwargs) -> None:
        super(ManagedServicesEncryptionEntitiesManagedServicesKeyVaultProperties, self).__init__(**kwargs)
        self.key_vault_uri = key_vault_uri
        self.key_name = key_name
        self.key_version = key_version
...
class WorkspaceEncryptionParameter(Model):
    ...
    :param type: The type of variable that this is. Possible values include:
     'Bool', 'Object', 'String'
    :type type: str or ~azure.mgmt.databricks.models.CustomParameterType
    :param entities: The value which should be used for this field
    :type entities:
     ~azure.mgmt.databricks.models.ManagedServicesEncryptionEntities
    ...
    _attribute_map = {
        'type': {'key': 'type', 'type': 'str'},
        'entities': {'key': 'entities', 'type': 'ManagedServicesEncryptionEntities'},
        'value': {'key': 'value', 'type': 'Encryption'},
    }

    def __init__(self, *, type=None, entities=None, value=None, **kwargs) -> None:
