...
class WorkspacesOperations(object):
    ...
    def _update_initial(
            self, resource_group_name, workspace_name, tags=None, identity=None, custom_headers=None, raw=False, **operation_config):
        parameters = models.WorkspaceUpdate(tags=tags, identity=identity)
    ...
    def update(
            self, resource_group_name, workspace_name, tags=None, identity=None, custom_headers=None, raw=False, polling=True, **operation_config):
        """Updates a workspace.
