...
class PrivateEndpointConnectionsOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.databricks.models.PrivateEndpointConnectionPaged[~azure.mgmt.databricks.models.PrivateEndpointConnection]
        :raises:
        ...
        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Databricks/workspaces/{workspaceName}/privateEndpointConnections'}
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.databricks.models.PrivateEndpointConnection or
    ...
    def create(
            self, resource_group_name, workspace_name, private_endpoint_connection_name, properties, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.databricks.models.PrivateEndpointConnection]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.databricks.models.PrivateEndpointConnection]]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.databricks.models.ErrorResponseException>`
        """
    ...
    create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Databricks/workspaces/{workspaceName}/privateEndpointConnections/{privateEndpointConnectionName}'}
    ...
    def delete(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Databricks/workspaces/{workspaceName}/privateEndpointConnections/{privateEndpointConnectionName}'}
